...
<body>
        ...
        <div class="row content">
            ...
            <div class="col-sm-7 text-left" style="margin-left: -16px;margin-top: -22px; ">
                ...
                <div class="client-form contenedorForma" style="margin-top: -5px">
                    <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="json/registrar_TERCERO_CLIENTE_JURIDICAJson.php">
                ...
                <table class="tablaC table-condensed" style="margin-left: -30px">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="GF_TELEFONO.php"><button disabled="true" class="btn btn-primary btnInfo" <?php if (!isset($_SESSION['id_tercero'])) {
                                    echo ' disabled title="Debe primero ingresar un cliente jurídica."';
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="GF_CONDICION_TERCERO.php"><button disabled="true"class="btn btn-primary btnInfo" <?php if (!isset($_SESSION['id_tercero'])) {
                                    echo ' disabled title="Debe primero ingresar un cliente jurídica."';
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                } ?> class="btn btnInfo btn-primary" disabled="true">CONTACTO</a><br/>
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>
                                <button class="btn btn-primary btnInfo" disabled="true" style="margin-top:15px">PERFIL CONDICIÓN</button>
                            </td>
                        </tr>
                    </tbody>
                </table>
    ...
    <script type="text/javascript">
        $('#ver1').click(function () {
            ...
            document.location = 'modificar_TERCERO_CLIENTE_JURIDICA.php?id_ter_clie_jur=' + id;
        });
    </script>
