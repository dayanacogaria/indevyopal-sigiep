...
//Query o sql de consulta            
    $queryTipoc = "SELECT Id_Unico, Nombre FROM gf_tipo_contrato  WHERE md5(Id_Unico) ='$id_tipoc'";
  }
...
<!-- Inicio del formulario -->
          <form name="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="json/modificarTipoContratoJson.php">
