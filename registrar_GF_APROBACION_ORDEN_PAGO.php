                ...
                <div class="client-form contenedorForma" style="margin-top:-7px;">
                    ...
                    <form name="form"  class="form-horizontal" method="POST"  enctype="multipart/form-data" action="json/registrarComprobanteContable.php" style="margin-bottom:-20px">
                        ...
                        <div class="form-group form-inline" style="margin-top: 5px; margin-left: 5px;">
                            ...
                            <select class="col-sm-2 input-sm" onchange="loadAjax('registrar_GF_APROBACION_ORDEN_PAGO.php?v='+this.value);return false;" name="sltTercero" id="sltTercero" class="form-control" style="width:100px;height:30%" title="Seleccione tercero" required>
                                <?php
                                if (!empty($_GET['num'])) {
                                    if ($cn[10] != '""') {
                                    ...
                                    while ($resT = mysqli_fetch_row($query)) {
                                        if ($resT[5] != '""') {
                                            if (empty($resT[1]) || empty($resT[2]) || empty($resT[3]) || empty($resT[4])) {
                                                echo '<option value="' . $resT[0] . '">' . $resT[5] . ' ' . '(' . $resT[6] . ' - ' . $resT[7] . ')' . '</option>';
                                            } else {
                                                echo '<option value="' . $resT[0] . '">' . $resT[1] . ' ' . $resT[2] . ' ' . $resT[3] . ' ' . $resT[4] . ' ' . '(' . $resT[6] . ' - ' . $resT[7] . ')' . '</option>';
                                            }
                                        } else {
                                            echo '<option value="' . $resT[0] . '">' . $resT[1] . ' ' . $resT[2] . ' ' . $resT[3] . ' ' . $resT[4] . ' ' . '(' . $resT[6] . ' - ' . $resT[7] . ')' . '</option>';
                                        }
                                ...
                                while ($rowT = mysqli_fetch_row($result)) {
                                    ...
                                    <?php
                                    if ($rowT[5] != '""') {
                                        if (empty($rowT[1]) && empty($rowT[2]) && empty($rowT[3]) && empty($rowT[4])) {
                                            echo '<option value="' . $rowT[0] . '">' . $rowT[5] . ' ' . '(' . $rowT[6] . ' - ' . $rowT[7] . ')' . '</option>';
                                        } else {
                                            if (($rowT[1] == 'NULL')) {
                                                echo '<option value="' . $rowT[0] . '">' . $rowT[5] . ' ' . '(' . $rowT[6] . ' - ' . $rowT[7] . ')' . '</option>';
                                                if ($rowT[2] == 'NULL') {
                                                ...
                                                echo '<option value="' . $rowT[0] . '">' . $rowT[1] . ' ' . $rowT[2] . ' ' . $rowT[3] . ' ' . $rowT[4] . ' ' . '(' . $rowT[6] . ' - ' . $rowT[7] . ')' . '</option>';
                                            }
                                        }
                                    } else {
                                        echo '<option value="' . $rowT[0] . '">' . $rowT[1] . ' ' . $rowT[2] . ' ' . $rowT[3] . ' ' . $rowT[4] . ' ' . '(' . $rowT[6] . ' - ' . $rowT[7] . ')' . '</option>';
                            ...
                            <script type="text/javaScript">
                                function getValue(){
                                   var val = $( "#sltTercero option:selected" ).val();
                            ...
                            ?>
                            <input class="col-sm-2 input-sm" value="<?php if (!empty($_GET['num'])) {
                                echo $fechaS[2] . '/' . $fechaS[1] . '/' . $fechaS[0];
                            } else {
                                echo date('d/m/Y');
                            } ?>" type="text" name="fecha" id="fecha" class="form-control" style="width:100px;height:26px" title="Ingrese la fecha" placeholder="Fecha" required>    
