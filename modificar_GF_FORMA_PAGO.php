...
//Query o sql de consulta
  $queryForma = "SELECT Id_Unico, Nombre, dispersion FROM gf_forma_pago  WHERE md5(Id_Unico) ='$id_forma'";
...
<!-- Llamado al menú del formulario -->   
    ...
    <div class="col-sm-10 text-left">
      ...
      <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">
          ...
          <form name="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="json/modificarFormaPagoJson.php">
