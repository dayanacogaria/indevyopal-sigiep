...
if(empty($_GET['id'])) {
    ...
    $titulo = "Modificar ";
    $id     = $_GET['id'];
    $row    = $con->Listar("SELECT * FROM gy_pregunta
            WHERE md5(id_unico)='$id'");
    $titulo2= $row[0][1];
    
    $clase = "SELECT p.id_unico, cp.id_unico, cp.nombre, tp.id_unico,tp.nombre
            FROM gy_pregunta p LEFT JOIN gy_clase_pregunta cp ON p.id_clase_pregunta = cp.id_unico
...
<style>
    label  #nombre-error, #clase_pregunta-error, #sltTipoP-error {
    display: block;
    color: #155180;
    font-weight: normal;
    font-style: italic;
    ...
    <div class="container-fluid text-center">
        <div class="row content">
            ...
            <div class="col-sm-10 text-left">
                <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;"><?php echo $titulo.' Pregunta'?></h2>
                ...
                <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">
                    ...
                    <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="javascript:registrar()">
                        ...
                        <div class="form-group" style="margin-top: 0px; ">
                            <label for="sltTipoP" class="col-sm-5 control-label"><strong style="color:#03C1FB;">*</strong>Tipo Pregunta:</label>
                            <select required id="sltTipoP" name="sltTipoP" class="form-control"  style="height: 35px;"  title="Seleccione una Clase de Pregunta">
                                <option value="">Tipo Pregunta</option>
                            </select>
                                <script type="text/javascript">
                                    $(document).ready(function(){
                                        $("#clase_pregunta").change(function(){
                                            var form_data = {
                                                is_ajax: 1,
                                                id_TipoP: +$("#clase_pregunta").val()
                                            };
                                            $.ajax({
                                                type: "POST",
                                                url: "buscar_GY_CLASE_PREGUNTA.php",
                                                data: form_data,
                                                success: function(response){
                                                    $('#sltTipoP').html(response).fadeIn();
                                                    $('#sltTipoP').select2();
                                                }
                                            });
                                        });
                    ...
                    <script>
                        function registrar(){
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "jsonProyecto/gy_preguntaJson.php?action=2",
                                data:formData,
                                contentType: false,
                                processData: false,
                                success: function(response)
                                    ...
                                    if(response==1){
                                        ...
                                        $("#Aceptar").click(function(){
                                            if(MR == 1){
                                                ...
                                                document.location='listar_GY_PREGUNTA.php';
                                            }
                                        })
                                    } else {
                    ...
                    <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="javascript:modificar()">
                        ...
                        <div class="form-group" style="margin-top: 0px; ">
                            <label for="sltTipoP" class="col-sm-5 control-label"><strong style="color:#03C1FB;">*</strong>Tipo Pregunta:</label>
                            <select required id="sltTipoP" name="sltTipoP" class="form-control"  style="height: 35px;"  title="Seleccione una Clase de Pregunta" onmouseover="javascript:cargar();">
                                <option value="<?php echo $cp[3] ?>"><?php echo $cp[4]  ?></option>
                            </select>
                                <script type="text/javascript">
                                    $(document).ready(function(){
                                        $("#clase_pregunta").change(function(){
                    ...
                    <script>
                        function modificar(){
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "jsonProyecto/gy_preguntaJson.php?action=3",
                                data:formData,
                                contentType: false,
                                processData: false,
                                success: function(response)
