...
if (isset($_GET["id_cond"])){ 
  ...
  $queryCond = "SELECT C.Id_Unico, C.Nombre, C.TipoDato, TD.Nombre
    FROM gf_condicion C, gf_tipo_dato TD
    WHERE C.TipoDato = TD.Id_Unico
    AND md5(C.Id_Unico) = '$id'"; 
...
$tipo_da = "SELECT Id_Unico, Nombre FROM gf_tipo_dato WHERE Id_Unico != $row[2] ORDER BY Nombre ASC";
  ...
  <div class="row content">
    ...
    <div class="col-sm-10 text-left">
      ...
      <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">
          ...
          <form name="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="json/modificarCondicion.php">
          ...
          <p align="center" style="margin-bottom: 25px; margin-top: 25px; margin-left: 30px; font-size: 80%">Los campos marcados con <strong style="color:#03C1FB;">*</strong> son obligatorios.</p>
            ...
            <div class="form-group">
              <label for="tipo_dato" class="col-sm-5 control-label"><strong style="color:#03C1FB;">*</strong>Tipo Dato:</label>
              <select name="tipo_dato" id="tipo_dato" class="select2_single form-control " title="Seleccione el tipo dato"   required>
                <option value="<?php echo $row[2] ?>"><?php echo ucwords(mb_strtolower( $row[3] ));?></option>
                <?php while($rowC = mysqli_fetch_assoc($tipo_d)){?>
