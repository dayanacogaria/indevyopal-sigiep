                    ...
                    <div class="table-responsive contabla">
                        <table id="tabla" class="table table-stripe table-condensed display" cellpadding="0" width="100%">
                            ...
                            <tbody>
                                ...
                                $query = "	SELECT * FROM 	gs_parametros_basicos  WHERE compania = $compania";
                                ...
                                while ($row = mysqli_fetch_row($result)) {?>
                                    <tr>
                                        ...
                                        <td class="campos">
                                            <a id="a_delete" class="campos" href="#" onclick="eliminarParametrosBasicos(<?php echo $row[0]; ?>)">
                                                <i title="Eliminar" class="glyphicon glyphicon-trash"></i>
                                            </a>
                                            <a id="a_update" class="campos" href="modificar_GS_PARAMETROS_BASICOS.php?id=<?php echo md5($row[0]); ?>">
