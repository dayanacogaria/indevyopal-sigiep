...
<style>
    label #documento-error, #numero1-error, #archivos-error  {
    display: block;
    color: #155180;
    font-weight: normal;
    font-style: italic;
...
<title>Documento Proceso</title>
</head>
<div class="container-fluid text-center">
    <div class="row content">
    <?php require_once 'menu.php'; ?>
        <div class="col-sm-10 text-left" >
            <h2 align="center" class="tituloform" style="margin-top:-3px">Documento Proceso</h2>
            ...
            <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px; margin-top: -5px;" class="client-form">
                <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="jsonProcesos/registrar_GG_DOCUMENTO_PROCESOJson.php">
                        ...
                        <div class="form-group form-inline"style="margin-left:20px; margin-top: 10px" >
                         ...
                         <input type="hidden" name="obligatorio" id="obligatorio">
                            <div id="numeroR" style="display:inline; display: none; margin-left:0px;" >
                                <label for="numero1" style="width:100px; margin-bottom: 10px;" class="control-label"><strong style="color:#03C1FB;">*</strong>Número:</label>
                    ...
                    <div class="form-group form-inline" style="margin-left:0px; margin-right: 0px; margin-top: -25px">
                        ...
                        <div class="form-group form-inline text-right" style="margin-left:450px; margin-top:-2px; margin-right: 0px" >
...
function eliminar(id, ruta) {
    ...
    $("#ver").click(function(){
        ...
        $.ajax({
            type:"GET",
            url:"jsonProcesos/eliminar_GG_DOCUMENTO_PROCESOJson.php?id="+id+"&ruta="+ruta,
            success: function (data) {
...
function guardarCambios(){
    ...
    var formData = new FormData($("#formModificar")[0]);  
        $.ajax({
            type: 'POST',
            url: "jsonProcesos/modificar_GG_DOCUMENTO_PROCESOJson.php",
            data:formData,
            contentType: false,
             processData: false,
            success: function (data) { 
