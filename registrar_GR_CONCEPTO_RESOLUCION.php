...
################ MODIFICACIONES ####################
#04/06/2017    | Anderson Alarcon |  Modifique selects de formulario
####################################################
...
#session_start();
?>
   <title>Registrar Concepto Resolución</title>
    </head>
    <body>
        <div class="container-fluid text-center">
              <div class="row content">
                  ...
                  <div class="col-sm-10 text-left">
                      <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;">Registrar Concepto Resolución</h2>
                      <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">
                          <form name="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="json/registrarConceptoResolucionPJson.php">
                        ...
                        <div class="form-group" style="margin-top: 0px">
                            ...
                            <input type="text" name="txtValant" id="txtValant" class="form-control" maxlength="25" title="Ingrese el Valor Anterior" onkeypress="return txtValida(event,'num')" placeholder="Valor Anterior">
                        </div>
                        <!----------Fin Valor Anterior-->
                        ...
                        <div class="form-group" style="margin-top: -10px">
                            ...
                            <input type="text" name="txtValact" id="txtValact" class="form-control" maxlength="25" title="Ingrese el Valor Actual" onkeypress="return txtValida(event,'num')" placeholder="Valor Actual">
                        </div>
                        <!----------Fin Valor Actual-->
                        ...
                        <!------------------------- Consulta para llenar campo Tipo Modificación-->
                            ...
                            $tm = "SELECT id_unico, nombre 
                                FROM gr_tipo_modificacion ORDER BY id_unico ASC";
                        ...
                        <div class="form-group" style="margin-top: -5px">
                            ...
                            <option value="">Tipo Modificación</option>
                                <?php 
