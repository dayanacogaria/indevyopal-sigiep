...
<script src="js/jquery-ui.js"></script>
<style>
    label #predioI-error, #predioF-error, #annoI-error,#annoF-error,#monto-error {
        display: block;
        color: #bd081c;
        font-weight: bold;
        font-style: italic;
    ...
    <div class="container-fluid text-center">
        <div class="row content">
            ...
            <div class="col-sm-10 text-left">
                ...
                <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;">Resolución Cobro</h2>
                <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">
                    <form name="form" id="form" accept-charset=""class="form-horizontal" method="POST"  enctype="multipart/form-data" action="javaScript:generar()">
                        ...
                        <div class="form-group" style="margin-top: -10px;">
                            <label for="annoI" class="col-sm-5 control-label"><strong style="color:#03C1FB;">*</strong>Año Inicial:</label>
                            <input type="text" name="annoI" id="annoI" class="form-control"  title="Ingrese Año Inicial"  placeholder="Año Inicial" required style="display: inline; width: 250px">
                        </div>
                        <div class="form-group" style="margin-top: -10px;">
                            <label for="annoF" class="col-sm-5 control-label"><strong style="color:#03C1FB;">*</strong>Año Final:</label>
                            <input type="text" name="annoF" id="annoF" class="form-control"  title="Ingrese Año Final"  placeholder="Año Final" required style="display: inline; width: 250px">
                        </div>
                        <div class="form-group" style="margin-top: -10px;">
                            <label for="monto" class="col-sm-5 control-label"><strong style="color:#03C1FB;">*</strong>Monto Superior a:</label>
                            <input type="text" name="monto" id="monto" class="form-control"  title="Ingrese Monto"  placeholder="Monto" required style="display: inline; width: 250px">
                        </div>
                        <div class="form-group" style="margin-top: 10px;">
    ...
    <script>
        function generar(){
            ...
            $.ajax({
                ...
                {
                    jsRemoveWindowLoad();
                    var predio1 = $("#predioI").val().trim();
                    var predio2 = $("#predioF").val().trim();
                    var anno1   = $("#annoI").val().trim();
                    var anno2   = $("#annoF").val().trim();
                    var monto   = $("#monto").val().trim();
                    console.log('informes/Inf_Word/Inf_Resolucion_Cobro.php?predioI='+predio1+'&predioF='+predio2);
                    if(response>0){
                        window.location='informes/Inf_Word/Inf_Resolucion_Cobro.php?predioI='+predio1+'&predioF='+predio2+'&a1='+anno1+'&a2='+anno2+'&m='+monto;
                    } else {
