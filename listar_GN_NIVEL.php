        ...
        <div class="container-fluid text-center">
            <div class="row content">
                ...
                <div class="col-sm-10 text-left">
                    <h2 id="forma-titulo3" align="center" style="margin-top: 0px; margin-bottom: 20px; margin-right: 4px; margin-left: 4px;">Nivel</h2>
                    <div class="table-responsive" style="margin-left: 5px; margin-right: 5px;margin-top:-10px;">
                        <div class="table-responsive" style="margin-left: 5px; margin-right: 5px;">
                            <table id="tabla" class="table table-striped table-condensed" class="display" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <td class="cabeza"><strong>Equivalente SIA</strong></td>
                                    ...
                                    <tr>
                                        ...
                                        <th class="cabeza">Equivalente SIA</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="modificar_GN_NIVEL.php?id=<?php echo md5($row[0]);?>">
                                                <i title="Modificar" class="glyphicon glyphicon-edit" ></i>
                                            </a>
                                        </td>                                                        
                                        <td class="campos"><?php echo $nnom?></td>                
                                        <td class="campos"><?php echo $eqnom?></td>                
                                        <td class="campos"><?php echo $codcgrid.'-'.$codcgr?></td>                
                                        <td class="campos"><?php echo $enom?></td>    
                                        <td class="campos"><?php echo $eqsui?></td>                     
                                    </tr>
                                    <?php }
                                    ?>
                                </tbody>
                            ...
                            <div align="right">
                                <a href="registrar_GN_NIVEL.php" class="btn btn-primary " style=" box-shadow: 0px 2px 5px 1px gray;color: #fff; border-color: #1075C1; margin-top: 20px; margin-bottom: 20px; margin-left:-20px; margin-right:4px">Registrar Nuevo</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body" style="margin-top: 8px">
          <p>¿Desea eliminar el registro seleccionado de Nivel?</p>
        </div>
...
<script type="text/javascript">
      function eliminar(id)
      {
         ...
         $("#ver").click(function(){
              ...
              $.ajax({
                  type:"GET",
                  url:"json/eliminarNivelJson.php?id="+id,
  ...
  <script type="text/javascript">
      ...
      $('#ver1').click(function(){
        document.location = 'listar_GN_NIVEL.php';
      });
