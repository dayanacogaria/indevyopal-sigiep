...
$sql = "SELECT 
        ...
        LEFT JOIN gf_ciudad cdd             ON r.ciudadidentificacion = cdd.id_unico
        WHERE pt.perfil = 13";
$resultado = $mysqli->query($sql);
?>
        <title>Listar Tercero Contribuyente</title>
    </head>
    <body>
        <div class="container-fluid text-center">
            <div class="row content">
                ...
                <div class="col-sm-10 text-left">
                    <h2 id="forma-titulo3" align="center" style="margin-top: 0px; margin-bottom: 20px; margin-right: 4px; margin-left: -10px;">Tercero Contribuyente</h2>
                    <div class="table-responsive" style="margin-left: -10px; margin-right: 5px;margin-top:-10px;">
                        <div class="table-responsive" style="margin-left: 5px; margin-right: 5px;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="modificar_GF_TERCERO_CONTRIBUYENTE.php?id=<?php echo md5($row[0]);?>">
                                        ...
                                        <td class="campos"><?php echo $row[28]?></td>                
                            ...
                            <div align="right">
                                <a href="registrar_GF_TERCERO_CONTRIBUYENTE.php" class="btn btn-primary " style=" box-shadow: 0px 2px 5px 1px gray;color: #fff; border-color: #1075C1; margin-top: 20px; margin-bottom: 20px; margin-left:-20px; margin-right:4px">Registrar Nuevo</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body" style="margin-top: 8px">
          <p>¿Desea eliminar el registro seleccionado de Tercero Contribuyente?</p>
        </div>
...
<script type="text/javascript">
      function eliminar(id)
      {
         ...
         $("#ver").click(function(){
              ...
              $.ajax({
                  type:"GET",
                  url:"json/eliminarTerceroContribuyenteJson.php?id="+id,
  ...
  <script type="text/javascript">
      ...
      $('#ver1').click(function(){
        document.location = 'listar_GF_TERCERO_CONTRIBUYENTE.php';
      });
