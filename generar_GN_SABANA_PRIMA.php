   ...
   <title>Sábana de Prima</title>
    ...
    <body>
        ...
        <div class="col-sm-8 text-left">
                <h2 id="forma-titulo3" align="center" style="margin-top:0px; margin-right: 4px; margin-left: -10px;">Sábana de Prima de Servicios</h2>
...
<!--------------------------------------------------------------------------------------------------------------------- -->
                          ...
                          <!--------------------------------------------------------------------- -->
                                ...
                                <?php
                                    $per = "SELECT  id_unico, codigointerno FROM gn_periodo WHERE id_unico !=1 AND tipoprocesonomina = 2 AND parametrizacionanno = '$vig'";
                                ...
                                <div class="form-group" style="margin-top: -5px">   
                                    ...
                                    <select  name="sltPeriodo" id="sltPeriodo" title="Seleccione Periodo" style="height: 30px;" class="select2_single form-control" required>
                                ...
                                <div class="form-group" style="margin-top: 22px">   
                                    ...
                                    <button id="btnpdf" class="btn sombra btn-primary" title="Generar reporte PDF" style="margin-left: 0px;"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></button>
                                    <button id="btnxls" class="btn sombra btn-primary" title="Generar reporte Excel" style="margin-left: 0px;"><i class="fa fa-file-excel-o" aria-hidden="true"></i></button>
                                </div>
...
<script type="text/javascript">
      ...
      $("#btnpdf").click(function (){
          $("#form").attr('action','informes/generar_INF_SABANA_PRIMA.php');
      });

      $("#btnxls").click(function (){
        $("#form").attr('action','informes/generar_INF_SABANA_PRIMA_XLS.php');
      });
