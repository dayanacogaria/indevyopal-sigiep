...
<script src="js/jquery-ui.js"></script>
   ...
   <title>Generación Volante de Pago HE</title>
    ...
    <body>
        <div class="container-fluid text-center">
            <div class="row content">
                ...
                <div class="col-sm-8 text-left">
                        <h2 id="forma-titulo3" align="center" style="margin-top:0px; margin-right: 4px; margin-left: -10px;">Generación de Volante de Pago Horas Extra</h2>
        ...
        <script>
        function reportePdf(){
            $('form').attr('action', 'informes_nomina/generar_INF_VOLANTE_HE.php?t=1');
        }
        function reporteExcel(){
            $('form').attr('action', 'informes_nomina/generar_INF_VOLANTE_HE.php?t=2');
        }
        </script>
