        ...
        <div class="container-fluid text-center">
            <div class="row content">
                ...
                <div class="col-sm-10 col-md-10 col-lg-10 text-left" style="margin-top: 0px">
                    <h2 id="forma-titulo3" align="center" style="margin-top:0px; margin-right: 4px; margin-left: -10px;">Concepto Base</h2>
                        ...
                        <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="" target=”_blank”>
                            <p align="center" style="margin-bottom: 25px; margin-top: 0px; margin-left: 30px; font-size: 80%">Los campos marcados con <strong class="obligado">*</strong> son obligatorios.</p>                                         
                                ...
                                <div class="form-group form-inline" style="margin-top:-25px">
                                    ...
                                    <!--Concepto Aplica-->
                                    <label for="concepto_a" class="col-sm-2 control-label">
                                        <strong class="obligado">*</strong>Cocepto Aplica:
                                    </label>
                                    <input name="concepto_a" id="concepto_a" title="Ingrese Concepto" 
                                    type="text" style="width: 350px;height: 30px" class="form-control col-sm-1"  
                                        value="<?php echo $res[5]; ?>" readonly>  
                                    ...
                                    ?>
                                    <label for="concepto" class="col-sm-2 control-label">
                                        <strong class="obligado">*</strong>Concepto:
                                    </label>
                                    <input name="concepto" id="concepto" title="Ingrese Concepto" 
                                    type="text" style="width: 290px;height: 30px" class="form-control col-sm-2"  
                                        value="<?php echo $n_concepto; ?>" readonly> 
                                    
                                    <!--tipo-->
                                    <label for="Tipo" class="col-sm-2 control-label">
                                        <strong class="obligado">*</strong>Tipo Base:
                                    </label>
                                    <input name="Tipo" id="Tipo" title="Ingrese Tipo Base" 
                                    type="text" style="width: 350px;height: 30px" class="form-control col-sm-1"  
