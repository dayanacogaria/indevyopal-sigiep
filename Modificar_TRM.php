...
if (!empty($_GET['id'])){
    $id = $_GET['id'];
    $sqltar = $con->Listar("
    SELECT a.*, DATE_FORMAT(a.fecha, '%d/%m/%Y'), b.nombre
    FROM gf_trm a
    LEFT JOIN  gf_tipo_cambio b ON a.tipo_cambio = b.id_unico
    ...
    <div class="container-fluid text-center">
        <div class="row content">
            ...
            <div class="col-sm-10 text-left" style="margin-top:-20px;">
                <h2 id="forma-titulo3" align="center" style="margin-right: 4px; margin-left: 4px;">Modificar TRM</h2>
                ...
                <h5 id="forma-titulo3a" align="center" style="width:96%; display:inline-block; margin-bottom: 10px; margin-right: -1px; margin-left: 4px; margin-top:-5px;  background-color: #0e315a; color: White; border-radius: 5px">.</h5>
                <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">
                    <form id="form" name="form" class="form-horizontal" method="POST" enctype="" action="jsonPptal/registrar_GF_Tipo_CambioJson.php">
                        ...
                        <input type="hidden" name="idx" id="idx" value="<?php echo $idt;?>">
                        <div class="form-group" style="margin-top: -2px;">
                            <label for="slttipo_cx" class="control-label col-sm-4 col-md-4 col-lg-4"><strong class='obligado'>*</strong>Tipo Cambio:</label>
                            <div class="col-sm-5 col-md-5 col-lg-5">
                                <select name="slttipo_cx" id="slttipo_cx" class="select2_single form-control" title="Seleccione Tipo Cambio" required>
                                    <option value="">Tipo Cambio</option>
                                    <?php                             
                                        $html = "";
                                        echo "<option value='$idtpc' selected>$nmtpc</option>";
                                        $sqper = "SELECT * FROM gf_tipo_cambio WHERE id_unico <> $idtpc";
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5 col-md-5 col-lg-5">
                                <input type="text" name="txtValorx" id="txtValorx" class="form-control" title="Ingrese el valor"  placeholder="Valor" onkeypress="return txtValida(event, 'decimales')" required style='width:100%;' autocomplete="off" value="<?php echo $valor;?>">
                            </div>
                        </div>                        
                        <div class="form-group" style="margin-top: 9px;">
                            <label for="txtFecha" class="control-label col-sm-4 col-md-4 col-lg-4"><strong class="obligado">*</strong>Fecha:</label>
                            <div class="col-sm-5 col-md-5 col-lg-5">
                                <input  required="required" type="textx" name="txtFechax" id="txtFecha" class="form-control fecha" placeholder="Fecha" title="Ingrese la fecha" style="width: 100%;" required autocomplete="off"  value="<?php echo $fecha;?>">
                            </div>
                        </div>
                        <br>                        
                        <div class="form-group">
