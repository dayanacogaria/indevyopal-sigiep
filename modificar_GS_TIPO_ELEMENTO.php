...
{ 
  ...
  $queryTipoElem = "SELECT Id_Unico, Nombre  
    ...
    WHERE md5(Id_Unico) = '$id_tipo_elem'"; 
  ...
  <?php require_once 'menu.php'; ?>
    ...
    <div class="col-sm-10 text-left">
      ...
      <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">
          ...
          <form name="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="json/modificar_GS_TIPO_ELEMENTOJson.php">
