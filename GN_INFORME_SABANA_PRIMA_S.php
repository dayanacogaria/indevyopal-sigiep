...
?>
    ...
    <title>Sábana de Prima De Servicios</title>
    ...
    <script>
        ...
        $("#enviar").click(function(){
            if($("#optPdf").is(':checked')){
                $("#form").attr("action", "informes_nomina/generar_INF_SABANA_PRIMA_S.php?t=1");
            } else {
                if($("#optExcel").is(":checked")){
                    $("#form").attr("action", "informes_nomina/generar_INF_SABANA_PRIMA_S.php?t=2");
                }
            }
        });
    </script>
