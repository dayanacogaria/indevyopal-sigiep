...
$pdf->SetX(45);
$pdf->MultiCell(155, 5,utf8_decode('El suscrito Tesorero certifica que se realizo el reintegro al Presupuesto de Gastos e Inversión los siguientes rubros presupuestales :'),0,'C'); 
$pdf->SetFont('Arial','',9);
