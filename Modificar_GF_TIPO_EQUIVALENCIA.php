...
<title>Modificar Tipo Equivalencia</title>
...
<div class="container-fluid text-center">
    ...
    <?php require_once 'menu.php'; ?>
         <div class="col-sm-10 text-left" style="margin-left: -16px;margin-top: -20px"> 
            <h2 align="center" class="tituloform">Modificar Tipo Equivalencia PUC</h2>
            <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">
                <form name="form" id="form"  class="form-horizontal" method="POST"  enctype="multipart/form-data" action="json/modificar_GF_TIPO_EQUIVALENCIAJson.php">
                    ...
                    <div class="form-group" style="margin-top: -15px;">
                      ...
                      <input type="text" name="nombre" id="nombre" class="form-control"  maxlength="30" title="Ingrese el nombre "  placeholder="Nombre" required onkeypress="return txtValida(event, 'num_car')" maxlenght="500" value="<?php echo ucwords(strtolower($mod[1]))?>">
                    </div>
                    <div class="form-group" style="margin-top: -15px;">
                      <label for="descripcion" class="col-sm-5 control-label"><strong style="color:#03C1FB;">*</strong>Descripción:</label>
                      <textarea type="text" name="descripcion" id="descripcion" onkeypress="return txtValida(event,'num_car')" maxlength="500" class="form-control col-sm-1"  title="Ingrese Descripción"  placeholder="Descripción" required="required" ><?php echo ucwords(strtolower($mod[2]))?></textArea>
                    </div>
                    <div class="form-group" style="margin-top: -15px;">
                      ...
                      <select name="parametrizacion" id="parametrizacion" class="select2_single form-control col-sm-1" title="Seleccione " required  >
                          <option value="<?php echo $mod[3]?>"><?php echo $mod[4].' - '. ucwords(strtolower($mod[5]))?></option>
