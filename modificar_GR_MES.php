...
# session_start();
 $id = $_GET["id"];
 $queryCond = "SELECT id_unico, nombre FROM gr_mes
              ...
              <div class="row content">
                  ...
                  <div class="col-sm-10 text-left">
                      ...
                      <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">
                          <form name="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="json/modificarMesPJson.php">
