...
<body>
    <div class="container-fluid text-center">
        <div class="row content">
            ...
            <div class="col-sm-10 text-left" style="margin-top: -15px">
                <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;">Otros Conceptos</h2>
                <?php if(empty($_GET['t'])) { ?>                
                <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px; margin-top: -3px;" class="client-form">         
                    <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="" >  
                        ...
                        <div class="form-group form-inline " style="margin-top: -5px;margin-left: 300px">
                            ...
                            <div class="form-group form-inline  col-md-5 col-lg-5" style="margin-left:  50px;">
                                <select name="tipo" id="tipo" class="form-control select2" title="Seleccione Tipo" style="height: auto " required>
                                    <?php 
                                        ...
                                        echo '<option value="1">Saldo</option>';
                                        echo '<option value="2">Cancelados</option>';
                                    ?>
                                </select>
                            </div>
                        </div>
                    ...
                    <script>
                        $("#tipo").change(function(){
                            if($("#tipo").val()!=""){
                                document.location ='GF_OTROS_CONCEPTOS.php?t='+$("#tipo").val();                            
                            }
                        })
                    </script>
                </div>
                        ...
                        <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="javaScript:guardar()">
                            <p align="center" style="margin-bottom: 25px; margin-top:0px; margin-left: 40px; font-size: 80%">Los campos marcados con <strong style="color:#03C1FB;">*</strong> son obligatorios.</p>
                             <div class="form-group form-inline " style="margin-top: -5px;margin-left: 0px">
                                ...
                                <div class="form-group form-inline  col-md-1 col-lg-1" style="margin-left:  0px;">
                                    <label for="unidad_vivienda" class="col-sm-12 control-label"><strong class="obligado">*</strong>Unidad Vivienda:</label>
                                </div>
                                <div class="form-group form-inline  col-md-2 col-lg-2" style="margin-left:  20px;">
                                    <select name="unidad_vivienda" id="unidad_vivienda" class="form-control select2" title="Seleccione Unidad Vivienda" style="height: auto " required>
                                        <option value="">Unidad Vivienda</option>
                                    </select>
                                </div>
                                 <div class="form-group form-inline  col-md-1 col-lg-1" style="margin-left:  0px;">
                                    <label for="concepto" class="col-sm-12 control-label"><strong class="obligado">*</strong>Concepto:</label>
                                </div>
                                <div class="form-group form-inline  col-md-2 col-lg-2"  style="margin-left:  0px;">
                                    <select name="concepto" id="concepto" class="form-control select2" title="Seleccione Concepto" style="height: auto " required>
                                        <?php 
                                            ...
                                            $tr = $con->Listar("SELECT * FROM gp_concepto c WHERE c.tipo_concepto = 5 and tipo_operacion = 2");
                                            for ($i = 0; $i < count($tr); $i++) {
                                               echo '<option value="'.$tr[$i][0].'">'.ucwords(mb_strtolower($tr[$i][2])).'</option>'; 
                                            }
                                        ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group form-inline  col-md-2 col-lg-2"  style="margin-left:  20px;">
                                    <input type="text"  name="fecha" id="fecha"  class="form-control col-md-1 col-sm-1 col-lg-2" maxlength="100" title="Ingrese Fecha"  placeholder="Fecha" style="width:100%">
                                </div>
                                <a href="GF_OTROS_CONCEPTOS.php" style="margin-left:20px;margin-top: 0px" type="button"  class="btn sombra btn-primary" title="Nuevo"><i class="glyphicon glyphicon-plus" aria-hidden="true"></i></a>
                            </div>
                            <div class="form-group form-inline " style="margin-top: -5px;margin-left: 0px">
    ...
    <script>
        $("#sector").change(function(){
            ...
            var opcion = '<option val="">Unidad Vivienda</option>';
            $.ajax({
              type: "POST",
              ...
              { 
                opcion += response;
                $('#unidad_vivienda').html(opcion).fadeIn();
                $("#unidad_vivienda").select2();
              }
            });
        })
    </script>
