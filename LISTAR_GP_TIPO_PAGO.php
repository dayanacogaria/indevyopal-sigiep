                                ...
                                <?php while($row = mysqli_fetch_row($resultado)){?>
                                    <tr>
                                        ...
                                        <td class="campos">
                                            ...
                                            <a class="campos" href="Modificar_GP_TIPO_PAGO.php?id=<?php echo md5($row[0]);?>"><i title="Modificar" class="glyphicon glyphicon-edit" ></i></a>
                                        </td>
                                        <td><?php echo ucwords(mb_strtolower(($row[1])));?></td>
                                        <td><?php echo ucwords(mb_strtolower(($row[3])));?></td>
                                        <td><?php echo $row[4].' - '.ucwords(mb_strtolower(($row[5])));?></td>
                                        <td><?php echo $row[6];?></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
                        <div align="right"><a href="Registrar_GP_TIPO_PAGO.php" class="btn btn-primary" style="box-shadow: 0px 2px 5px 1px gray;color: #fff; border-color: #1075C1; margin-top: 20px; margin-bottom: 20px; margin-left:-20px; margin-right:4px">Registrar Nuevo</a> </div>       
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        function eliminar(id)
        {
            ...
            $("#ver").click(function(){
                ...
                $.ajax({
                    type:"GET",
                    url:"json/eliminar_GP_TIPO_PAGOJson.php?id="+id,
