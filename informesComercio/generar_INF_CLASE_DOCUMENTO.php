...
{ 
    ...
    $this->SetX(23);
    $this->Cell(190,5,utf8_decode('LISTADO CLASE DOCUMENTO'),0,0,'C');
    $this->Ln(10);
...
$sql = "SELECT id_unico,nombre FROM gc_clase_documento";
...
//ob_end_clean();
$pdf->Output(0,'Listado Clase Documento('.date('d/m/Y').').pdf',0);
