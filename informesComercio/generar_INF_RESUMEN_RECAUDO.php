<?php
    ...
    echo "<br/>";
     echo "Fecha Inicial: ".$fecI;
    echo "<br/>";
    echo "Fecha Final: ".$fecF;
    echo "<br/>";
 ...
 echo  $cuentaBI = "SELECT CONCAT_WS(' ',
                            numerocuenta,
                            descripcion) FROM gf_cuenta_bancaria WHERE id_unico = '$BancoI'";
 ...
 echo   $cuentaBF = "SELECT CONCAT_WS(' ',
                            numerocuenta,
                            descripcion)  FROM gf_cuenta_bancaria WHERE id_unico = '$BancoF'";
    ...
    class PDF extends FPDF
    {
        ...
        { 
            ...
            $this->SetFont('Arial','',10);
            $this->Cell(330,10,utf8_decode('RESUMEN DE RECAUDOS DE INDUSTRIA Y COMERCIO'),0,0,'C');
            $this->Ln(10);
            $this->SetFont('Arial','B',10);
            $this->Cell(30,10,utf8_decode('Fecha Inicial:'),0,0,'L');
            $this->SetFont('Arial','',10);
            ...
            $this->SetFont('Arial','B',10);
            $this->Cell(30,10,utf8_decode('Cuenta Inicial:'),0,0,'L');
            
            $this->SetFont('Arial','',10);
            $this->Cell(100,10,utf8_decode($BI),0,0,'L');
            $this->Ln(5);
            $this->SetFont('Arial','B',10);
            $this->Cell(30,10,utf8_decode('Cuenta Final:'),0,0,'L');
            
            $this->SetFont('Arial','',10);
            $this->Cell(100,10,utf8_decode($BF),0,0,'L');
    ...
    if(empty($fecF) && empty($BancoF)){
     ...
     $sql10 = "SELECT id_unico, numerocuenta, banco FROM  gf_cuenta_bancaria WHERE id_unico >= '$BancoI'  ORDER BY id_unico ASC";
        ...
        $sql2 = "SELECT DISTINCT dd.concepto,  cc.descripcion, cc.nom_inf FROM gc_detalle_declaracion dd
                ...
                WHERE rc.fecha >='$fechaI' AND rc.cuenta_ban = '$CBan[0]' ORDER BY cc.codigo ASC";
        ...
        $sql3 = "SELECT COUNT(DISTINCT dd.concepto) FROM gc_detalle_recaudo dr
                ...
                LEFT JOIN gc_recaudo_comercial rc ON dr.recaudo = rc.id_unico
                LEFT JOIN gc_concepto_comercial cc ON dd.concepto =cc.id_unico
                WHERE rc.fecha >= '$fechaI' AND rc.cuenta_ban = '$CBan[0]'";
        ...
        $sql12 = "SELECT * FROM gc_recaudo_comercial rc
         INNER JOIN gc_detalle_recaudo dr ON  dr.recaudo = rc.id_unico
         WHERE cuenta_ban = '$CBan[0]'";
                ...
                while($Tcon3 = mysqli_fetch_row($con3)){
                    if(empty($fecF) && empty($BancoF)){
                        $sql5 = "SELECT SUM(dr.valor)
                            ...
                            LEFT JOIN gc_detalle_declaracion dd ON dr.det_dec = dd.id_unico
                            LEFT JOIN gc_recaudo_comercial rc ON dr.recaudo =  rc.id_unico
                            WHERE dd.concepto = '$Tcon3[0]' AND  rc.fecha >= '$fechaI' AND rc.cuenta_ban =  '$CBan[0]'";
                    }elseif(!empty($fecF) && empty($BancoF)){
                        $sql5 = "SELECT SUM(dr.valor)
                                FROM gc_detalle_recaudo dr
                                LEFT JOIN gc_detalle_declaracion dd ON dr.det_dec = dd.id_unico
                                LEFT JOIN gc_recaudo_comercial rc ON dr.recaudo =  rc.id_unico
                                WHERE dd.concepto = '$Tcon3[0]' AND rc.fecha BETWEEN '$fechaI' AND '$fechaF' AND rc.cuenta_ban = '$CBan[0]'";
                    }elseif(empty($fecF) && !empty($BancoF)){
                        $sql5 = "SELECT SUM(dr.valor)
                            FROM gc_detalle_recaudo dr
                            LEFT JOIN gc_detalle_declaracion dd ON dr.det_dec = dd.id_unico
        ...
        while($CBan = mysqli_fetch_row($res)){
            ...
            $sql2 = "SELECT DISTINCT dd.concepto,  cc.descripcion, cc.nom_inf FROM gc_detalle_declaracion dd
                    ...
                    LEFT JOIN gc_recaudo_comercial rc ON dr.recaudo = rc.id_unico
                    LEFT JOIN gc_concepto_comercial cc ON dd.concepto = cc.id_unico
                    WHERE rc.fecha BETWEEN '$fechaI' AND '$fechaF' AND rc.cuenta_ban = '$CBan[0]' ORDER BY cc.codigo ASC";
            
            $sql3 = "SELECT COUNT(DISTINCT dd.concepto) FROM gc_detalle_recaudo dr
                    LEFT JOIN gc_detalle_declaracion dd ON dr.det_dec = dd.id_unico
                    LEFT JOIN gc_recaudo_comercial rc ON dr.recaudo = rc.id_unico
                    LEFT JOIN gc_concepto_comercial cc ON dd.concepto =cc.id_unico
                    WHERE rc.fecha BETWEEN '$fechaI' AND '$fechaF' AND rc.cuenta_ban = '$CBan[0]'";
                ...
                while($Tcon3 = mysqli_fetch_row($con3)){
                    if(empty($fecF) && empty($BancoF)){
                        $sql5 = "SELECT SUM(dr.valor)
                            ...
                            LEFT JOIN gc_detalle_declaracion dd ON dr.det_dec = dd.id_unico
                            LEFT JOIN gc_recaudo_comercial rc ON dr.recaudo =  rc.id_unico
                            WHERE dd.concepto = '$Tcon3[0]' rc.fecha >= '$fechaI' rc.cuenta_ban = '$BancoI'";
                    }elseif(!empty($fecF) && empty($BancoF)){
                        $sql5 = "SELECT SUM(dr.valor)
                                FROM gc_detalle_recaudo dr
                                LEFT JOIN gc_detalle_declaracion dd ON dr.det_dec = dd.id_unico
                ...
                while($Tcon3 = mysqli_fetch_row($con3)){
                    if(empty($fecF) && empty($BancoF)){
                        ...
                        $sql5 = "SELECT SUM(dr.valor)
                                ...
                                LEFT JOIN gc_detalle_declaracion dd ON dr.det_dec = dd.id_unico
                                LEFT JOIN gc_recaudo_comercial rc ON dr.recaudo =  rc.id_unico
                                WHERE dd.concepto = '$Tcon3[0]' AND rc.fecha BETWEEN '$fechaI' AND '$fechaF'";
                    }elseif(empty($fecF) && !empty($BancoF)){
                        $sql5 = "SELECT SUM(dr.valor)
                            FROM gc_detalle_recaudo dr
                            LEFT JOIN gc_detalle_declaracion dd ON dr.det_dec = dd.id_unico
      ...
      $sql10 = "SELECT id_unico, numerocuenta, banco FROM  gf_cuenta_bancaria WHERE id_unico BETWEEN '$BancoI' AND '$BancoF' ORDER BY id_unico ASC";
                ...
                while($Tcon3 = mysqli_fetch_row($con3)){
                    if(empty($fecF) && empty($BancoF)){
                        ...
                        $sql5 = "SELECT SUM(dr.valor)
                            ...
                            LEFT JOIN gc_detalle_declaracion dd ON dr.det_dec = dd.id_unico
                            LEFT JOIN gc_recaudo_comercial rc ON dr.recaudo =  rc.id_unico
                            WHERE dd.concepto = '$Tcon3[0]' AND  rc.fecha >= '$fechaI' rc.cuenta_ban BETWEEN '$BancoI' AND '$BancoF'";
                    }else{
                        $sql5 = "SELECT SUM(dr.valor)
                            FROM gc_detalle_recaudo dr
                            LEFT JOIN gc_detalle_declaracion dd ON dr.det_dec = dd.id_unico
       ...
       $VigenciaAC = "SELECT SUM(rc.valor) FROM gc_recaudo_comercial rc 
                       ...
                       LEFT JOIN gc_declaracion d ON rc.declaracion = d.id_unico 
                       LEFT JOIN gc_anno_comercial ac ON d.periodo = ac.id_unico
                       WHERE ac.vigencia = '$vigeAct' AND rc.fecha BETWEEN '$fechaI' AND '$fechaF'
        ...
        if(empty($fecF) && empty($BancoF)){
            ...
            $ConceptosVAN = "SELECT DISTINCT (dd.concepto), cc.* FROM gc_detalle_recaudo dr 
                    ...
                    LEFT JOIN gc_anno_comercial ac ON d.periodo = ac.id_unico
                    LEFT JOIN gc_recaudo_comercial rc ON dr.recaudo = rc.id_unico
                    WHERE ac.vigencia < '$vigeAct' AND dd.tipo_det = 1 AND cc.tipo != 1 AND cc.tipo != 4 AND rc.parametrizacionanno = '$id_anno' AND rc.fecha >= '$fechaI' AND  rc.cuenta_ban = $BancoI'
            ...
            $ConceptosVAC = "SELECT DISTINCT (dd.concepto), cc.* FROM gc_detalle_recaudo dr 
                    ...
                    LEFT JOIN gc_anno_comercial ac ON d.periodo = ac.id_unico
                    LEFT JOIN gc_recaudo_comercial rc ON dr.recaudo = rc.id_unico 
                    WHERE ac.vigencia = '$vigeAct' AND dd.tipo_det = 1 AND cc.tipo != 1 AND cc.tipo != 4 AND rc.fecha >= '$fechaI' AND  rc.cuenta_ban = '$BancoI'
                    order by cc.codigo ASC ";
            ...
            $ConceptosVAN = "SELECT DISTINCT (dd.concepto), cc.* FROM gc_detalle_recaudo dr 
                    ...
                    LEFT JOIN gc_anno_comercial ac ON d.periodo = ac.id_unico
                    LEFT JOIN gc_recaudo_comercial rc ON dr.recaudo = rc.id_unico
                    WHERE ac.vigencia < '$vigeAct' AND dd.tipo_det = 1 AND cc.tipo != 1 AND cc.tipo != 4 AND rc.parametrizacionanno = '$id_anno' AND rc.fecha BETWEEN'$fechaI' AND '$fechaF' AND  rc.cuenta_ban = '$BancoI'
                    order by cc.codigo ASC ";
            ...
            $ConceptosVAC = "SELECT DISTINCT (dd.concepto), cc.* FROM gc_detalle_recaudo dr 
                    ...
                    LEFT JOIN gc_anno_comercial ac ON d.periodo = ac.id_unico
                    LEFT JOIN gc_recaudo_comercial rc ON dr.recaudo = rc.id_unico 
                    WHERE ac.vigencia = '$vigeAct' AND dd.tipo_det = 1 AND cc.tipo != 1 AND cc.tipo != 4 AND rc.fecha BETWEEN '$fechaI' AND '$fechaF' AND  rc.cuenta_ban = '$BancoI'
                    order by cc.codigo ASC ";
            ...
            $ConceptosVAN = "SELECT DISTINCT (dd.concepto), cc.* FROM gc_detalle_recaudo dr 
                    ...
                    LEFT JOIN gc_anno_comercial ac ON d.periodo = ac.id_unico
                    LEFT JOIN gc_recaudo_comercial rc ON dr.recaudo = rc.id_unico
                    WHERE ac.vigencia < '$vigeAct' AND dd.tipo_det = 1 AND cc.tipo != 1 AND cc.tipo != 4 AND rc.parametrizacionanno = '$id_anno' AND rc.fecha >= '$fechaI' AND  rc.cuenta_ban BETWEEN '$BancoI' AND '$BancoF'
                    order by cc.codigo ASC ";
            ...
            $ConceptosVAC = "SELECT DISTINCT (dd.concepto), cc.* FROM gc_detalle_recaudo dr 
                    ...
                    LEFT JOIN gc_anno_comercial ac ON d.periodo = ac.id_unico
                    LEFT JOIN gc_recaudo_comercial rc ON dr.recaudo = rc.id_unico 
                    WHERE ac.vigencia = '$vigeAct' AND dd.tipo_det = 1 AND cc.tipo != 1 AND cc.tipo != 4 AND rc.fecha >= '$fechaI' AND  rc.cuenta_ban BETWEEN '$BancoI' AND '$BacnoF'
                    order by cc.codigo ASC ";
        }else{
        $ConceptosVAN = "SELECT DISTINCT (dd.concepto), cc.* FROM gc_detalle_recaudo dr 
                    LEFT JOIN gc_detalle_declaracion dd ON dr.det_dec = dd.id_unico
                    ...
                    LEFT JOIN gc_anno_comercial ac ON d.periodo = ac.id_unico
                    LEFT JOIN gc_recaudo_comercial rc ON dr.recaudo = rc.id_unico
                    WHERE ac.vigencia < '$vigeAct' AND dd.tipo_det = 1 AND cc.tipo != 1 AND cc.tipo != 4 AND rc.parametrizacionanno = '$id_anno' AND rc.fecha BETWEEN '$fechaI' AND '$fechaF' AND  rc.cuenta_ban BETWEEN '$BancoI' AND '$BancoF'
                    order by cc.codigo ASC ";
         ...
         $ConceptosVAC = "SELECT DISTINCT (dd.concepto), cc.* FROM gc_detalle_recaudo dr 
                    ...
                    LEFT JOIN gc_anno_comercial ac ON d.periodo = ac.id_unico
                    LEFT JOIN gc_recaudo_comercial rc ON dr.recaudo = rc.id_unico 
                    WHERE ac.vigencia = '$vigeAct' AND dd.tipo_det = 1 AND cc.tipo != 1 AND cc.tipo != 4 AND rc.fecha BETWEEN '$fechaI' AND '$fechaF' AND  rc.cuenta_ban BETWEEN '$BancoI' AND '$BancoF'
                    order by cc.codigo ASC ";
        }
            $PosY = $pdf->GetY();
            if($PosY >= 180){
        ...
        $pdf->Cellfitscale(50,5, number_format($VAC[0],0,'.',','),0,0,'R');
        $pdf->Ln(5);
        ...
        while($TconR2 = mysqli_fetch_row($conR2)){
            ...
            if(empty($fecF) && empty($BancoF)){
                $sql10 = "SELECT SUM(dr.valor)
                    ...
                    LEFT JOIN gc_anno_comercial ac ON d.periodo = ac.id_unico
                    LEFT JOIN gc_recaudo_comercial rc ON dr.recaudo = rc.id_unico
                    WHERE  cc.id_unico = '$TconR2[0]' AND ac.vigencia = '$vigeAct' AND  rc.cuenta_ban = '$BancoI' AND rc.fecha >= '$fechaI'";
            }elseif(!empty($fecF) && empty($BancoF)){
                $sql10 = "SELECT SUM(dr.valor)
                    FROM gc_detalle_recaudo dr
                    LEFT JOIN gc_detalle_declaracion dd ON dr.det_dec = dd.id_unico
                    ...
                    LEFT JOIN gc_anno_comercial ac ON d.periodo = ac.id_unico
                    LEFT JOIN gc_recaudo_comercial rc ON dr.recaudo = rc.id_unico
                    WHERE  cc.id_unico = '$TconR2[0]' AND ac.vigencia = '$vigeAct' AND  rc.cuenta_ban = '$BancoI' AND rc.fecha BETWEEN '$fechaI' AND '$fechaF'";
                ...
                $sql10 = "SELECT SUM(dr.valor)
                    ...
                    LEFT JOIN gc_anno_comercial ac ON d.periodo = ac.id_unico
                    LEFT JOIN gc_recaudo_comercial rc ON dr.recaudo = rc.id_unico
                    WHERE  cc.id_unico = '$TconR2[0]' AND ac.vigencia = '$vigeAct' AND  rc.cuenta_ban BETWEEN '$BancoI' AND '$BancoF' AND rc.fecha >= '$fechaI'";
            }else{
                echo $sql10 = "SELECT SUM(dr.valor)
                    ...
                    LEFT JOIN gc_anno_comercial ac ON d.periodo = ac.id_unico
                    LEFT JOIN gc_recaudo_comercial rc ON dr.recaudo = rc.id_unico
                    WHERE  cc.id_unico = '$TconR2[0]' AND ac.vigencia = '$vigeAct' AND  rc.cuenta_ban BETWEEN '$BancoI' AND '$BancoF' AND rc.fecha BETWEEN '$fechaI' AND '$fechaF'";
            }
      ...
      echo  $VigenciaAN = "SELECT SUM(rc.valor) FROM gc_recaudo_comercial rc 
                        INNER JOIN gc_detalle_recaudo dr ON  dr.recaudo = rc.id_unico
                        LEFT JOIN gc_declaracion d ON rc.declaracion = d.id_unico 
                        LEFT JOIN gc_anno_comercial ac ON d.periodo = ac.id_unico
                        WHERE ac.vigencia < '$vigeAct' AND rc.fecha BETWEEN '$fechaI' AND '$fechaF'
        ...
        while($TconR2 = mysqli_fetch_row($conR2)){
            ...
            echo $sql10 = "SELECT SUM(dr.valor)
                    ...
                    LEFT JOIN gc_anno_comercial ac ON d.periodo = ac.id_unico
                    LEFT JOIN gc_recaudo_comercial rc ON dr.recaudo = rc.id_unico
                    WHERE  cc.id_unico = '$TconR2[0]' AND ac.vigencia < '$vigeAct' AND rc.parametrizacionanno = '$id_anno'";
             echo "<br/>";           
            $conc_comercio = $mysqli->query($sql10);
            $nconC = mysqli_num_rows($conc_comercio);
