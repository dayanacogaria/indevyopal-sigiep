...
{ 
    ...
    $this->SetX(23);
    $this->Cell(190,5,utf8_decode('LISTADO ESTADO AÑO COMERCIAL'),0,0,'C');
    $this->Ln(10);
...
$sql = "SELECT id_unico,nombre FROM gc_estado_anno_comercial";
...
//ob_end_clean();
$pdf->Output(0,'Listado Estado Año Comercial('.date('d/m/Y').').pdf',0);
