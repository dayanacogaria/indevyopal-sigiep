...
{ 
    ...
    $this->SetX(23);
    $this->Cell(190,5,utf8_decode('LISTADO AÑO COMERCIAL'),0,0,'C');
    $this->Ln(10);
    ...
    $this->Cell(85,9,utf8_decode('VIGENCIA'),1,0,'C');
    $this->Cell(85,9,utf8_decode('ESTADO'),1,0,'C');
...
//ob_end_clean();
$pdf->Output(0,'Listado Anno Comercial('.date('d/m/Y').').pdf',0);
