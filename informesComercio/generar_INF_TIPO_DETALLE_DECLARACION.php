...
{ 
    ...
    $this->SetX(23);
    $this->Cell(190,5,utf8_decode('LISTADO TIPO DETALLE DECLARACIÓN'),0,0,'C');
    $this->Ln(10);
    ...
    $this->Cell(170,9,utf8_decode('NOMBRE'),1,0,'C');
...
$resultado=$mysqli->query($sql);
 ...
 while($row=mysqli_fetch_array($resultado)){
            ...
            $pdf->Cell(170,4,utf8_decode(ucwords(mb_strtolower($row['nombre'] ))),0,0,'L');
...
//ob_end_clean();
$pdf->Output(0,'Listado Tipo Detalle Declaracion('.date('d/m/Y').').pdf',0);
