...
{ 
    ...
    $this->SetX(23);
    $this->Cell(190,5,utf8_decode('LISTADO TIPO DOCUMENTO ADJUNTO'),0,0,'C');
    $this->Ln(10);
    ...
    $this->Cell(105,9,utf8_decode('DESCRIPCIÓN'),1,0,'C');
    $this->Cell(65,9,utf8_decode('NOMBRE'),1,0,'C');
...
LEFT JOIN gc_clase_documento cd ON cd.id_unico=td.clase_doc";
 ...
 while($row=mysqli_fetch_row($resultado)){
            ...
            $pdf->Cell(65,4,utf8_decode(  $row[2]),0,0,'C');
...
//ob_end_clean();
$pdf->Output(0,'Listado Tipo Documento Adjunto('.date('d/m/Y').').pdf',0);
