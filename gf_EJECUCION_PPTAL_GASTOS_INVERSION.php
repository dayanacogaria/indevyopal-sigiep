                    ...
                    <div class="form-group">
                       ...
                       <div class="form-group" style="margin-top: -0px">
                        ...
                        <div class="col-sm-10" style="margin-top:0px;margin-left:700px" >
                            ...
                            <button style="margin-left:10px;" onclick="reporteExcelPru()" class="btn sombra btn-primary" title="Generar reporte Excel"><i class="fa fa-file-excel-o" aria-hidden="true"></i></button>
                        </div>
                    </div>
                </form>
            </div>     
