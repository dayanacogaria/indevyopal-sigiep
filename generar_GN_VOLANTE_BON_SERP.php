   ...
   <title>Generación Volante de Pago</title>
    ...
    <body>
        ...
        <div class="col-sm-8 text-left">
                <h2 id="forma-titulo3" align="center" style="margin-top:0px; margin-right: 4px; margin-left: -10px;">Generación de Volante de Pago Bonificación por Servicios P</h2>
                ...
                <div class="client-form contenedorForma" style="margin-top: -7px;font-size: 13px">        
                    <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="informes/generar_INF_VOLANTE_BON_SERP.php" target="_blank">
...
<!--------------------------------------------------------------------------------------------------------------------- -->
                       ...
                       if(empty($idT))
                        ...
                        ?>
                          ...
                          <!--------------------------------------------------------------------- -->
                            <?php
                                $per = "SELECT  p.id_unico, p.codigointerno, tp.nombre FROM gn_periodo p 
                                LEFT JOIN gn_tipo_proceso_nomina tp ON p.tipoprocesonomina = tp.id_unico
                                WHERE tp.id_unico =4 AND p.parametrizacionanno = '$vig'";
                          ...
                          <select  name="sltPeriodo" id="sltPeriodo" title="Seleccione Periodo" style="width: 140px;height: 30px; margin-top: 15px; margin-left: 35px;" class="select2_single form-control col-sm-1" required>
                                ...
                                <?php 
                                    ...
                                    {
                                        echo "<option value=".md5($rowE[0]).">".$rowE[1]." - ".$rowE[2]."</option>";
                                    }
                                ?>       
                            </select>
