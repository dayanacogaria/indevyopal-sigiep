<?php
    ...
    $sql = "SELECT DISTINCT d.id_unico,
            ...
            WHERE d.id_unico NOT IN(SELECT declaracion FROM gc_recaudo_comercial rc INNER JOIN gc_detalle_recaudo dc ON dc.recaudo = rc.id_unico) AND d.parametrizacionanno = '$anno' ";
    ...
    <body>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td class="campos">
                                                    ...
                                                    <a type="button" class="btn-g campos" onclick="javascript:abrirRec(<?php echo $row[0] ?>);">
        ...
        <script>
            function abrirRec(id_dec){
                ...
                //Envio ajax
                $.ajax({
                    url:'modalRecaudo_Declracion_No_Paga.php#modalRecaudo',
                    type:'POST',
                    data:form_data,
