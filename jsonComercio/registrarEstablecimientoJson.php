...
$sql="INSERT INTO gc_establecimiento(contribuyente,nombre,fechainicioAct,estrato,direccion,cod_catastral,ciudad,barrio,localizacion,tipo_entidad,tamanno_entidad) VALUES($contribuyente,$nombre,'$fechaI',$estrato,$direccion,$codigo,$ciudad,$barrio,$localizacion,$tipoEntidad,$tamannoEntidad)";
...
$resultado=$mysqli->query($sql); ?>
 <html>
  ...
  <script type="text/javascript">
    	...
    	$("#ver1").click(function(){
      	$("#myModal1").modal('hide');
      	window.location='../listar_GC_ESTABLECIMIENTO.php';
    	});
  </script>
  <?php }else{ ?>
  <script type="text/javascript">
