...
session_start();
  ...
  $update = "UPDATE gc_novedades_comercio  SET contribuyente=$contribuyente,tipo_novedad=$tipo,fecha='$fechaI',num_acto=$numeroActo,observaciones=$observaciones WHERE id_unico=$id";
