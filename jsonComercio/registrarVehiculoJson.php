...
echo $sql="
  INSERT INTO gc_vehiculo(contribuyente,tipo_vehiculo,tercero,cod_inter,tipo_serv,placa,porc_propiedad) 
  VALUES($contribuyente,$tipo,$tercero,$codigo,$tipoServicio,'$placa',$porcentajePropiedad)";
...
$resultado=$mysqli->query($sql); ?>
 <html>
  ...
  <script type="text/javascript">
    	...
    	$("#ver1").click(function(){
      	$("#myModal1").modal('hide');
      	window.location='../listar_GC_VEHICULO.php';
    	});
  </script>
  <?php }else{ ?>
  <script type="text/javascript">
