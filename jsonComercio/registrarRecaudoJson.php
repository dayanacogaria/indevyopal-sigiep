<?php
   ...
   require_once '../jsonPptal/funcionesPptal.php';
    ...
    $DDC1 = "SELECT valor, id_unico FROM gc_detalle_declaracion WHERE declaracion = '$decla' AND concepto = '27'";
    ...
    $CDecla = "SELECT MAX(consecutivo) FROM  gc_recaudo_comercial WHERE consecutivo LIKE '$V[0]%' AND parametrizacionanno = '$pa' AND clase = 1 ";
   ...
   $sql = "INSERT INTO gc_recaudo_comercial (consecutivo, declaracion, fecha, num_pag,  cuenta_ban, valor,observaciones, tipo_rec, rec_afect, acuerdo_pago, parametrizacionanno, clase )
             VALUES ($code, $decla, $fecha, $consig, $banco,$valor,NULL,NULL, NULL,NULL,$pa,1)";
    ...
    if($resultado==true){
       ...
       $DDC = "SELECT dd.valor, dd.id_unico FROM gc_detalle_declaracion dd 
                ...
                WHERE dd.declaracion = '$decla' AND dd.tipo_det = '1' AND  cc.tipo != 1";
...
<html>
    ...
    <body>
        <input type="hidden" id="valor" name="valor" value="<?php echo $numeral  ?>">
    ...
    function guardar(id){
        ...
        $.ajax({
            ...
            success: function(response){
                //jsRemoveWindowLoad();
                console.log(response+'Verificar');
