...
<style>
    label #razoSoci-error, #tipoEnt-error, #repreLegal-error, #depto-error, #ciudad-error {
        display: block;
        color: #155180;
        font-weight: normal;
        font-style: italic;
        ...
        <div class="content row">
                        ...
                        <div class="form-group form-inline" style="margin-top:-20px">
                            ...
                            <select name="tipoIdent" id="tipoIdent" class="form-control col-sm-5" style="height: 33px;width:113px" title="Tipo Identificación" required>
                                ...
                                <?php while ($ma = mysqli_fetch_assoc($tipoIden)) { ?>
                                    <option value="<?php echo $ma["Id_Unico"]; ?>"><?php echo ucwords( (mb_strtolower($ma["Nombre"]))); ?>
                                    </option>
                                <?php } ?>
                            </select>
            ...
            <!--Modificación de Razón Social-->                    
                        <div class="form-group" style="margin-top: -10px; ">
                            ...
                            <input type="text" name="razoSoci" id="razoSoci" class="form-control" maxlength="500" title="Ingrese la razón social" value="<?php echo  ($row[1]);?>" onkeypress="return txtValida(event,'num_car')"  onkeyup="javascript:this.value=this.value.toUpperCase();" placeholder="Razón Social" required style="width: 34%">
                        </div>
            ...
            <!--Modificación de Tipo Empresa-->
                        ...
                        <div class="form-group" style="margin-top: -10px; ">
                            ...
                            <?php
                                    ...
                                    <option value="<?php echo $row[15]; ?>"><?php echo ucwords(mb_strtolower($row[17]));?></option>
                            ...
                            <?php
                                ...
                                <?php
                                    ...
                                    <option value="<?php echo $rowElReprLeg[0] ?>">
                                      <?php echo ucwords( (mb_strtolower($rowElReprLeg[1]." ".$rowElReprLeg[2]." ".$rowElReprLeg[3]." ".$rowElReprLeg[4]." (".$rowElReprLeg[6].", ".$rowElReprLeg[5].")"))); ?>
                                    </option>
...
<!--  Fin combos dinámicos  -->
            ...
            <div class="form-group" style="margin-top: -10px;">
                            ...
                            <input type="text" name="codigo_afp" id="codigo_afp" class="form-control" maxlength="500" title="Ingrese la Código AFP" onkeypress="return txtValida(event)" onkeyup="javascript:this.value=this.value.toUpperCase();" placeholder="Código AFP" required  style="width: 34%" value="<?php echo  ($row[29]);?>">
