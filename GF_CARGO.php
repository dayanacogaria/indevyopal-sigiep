              ...
              <?php
               ...
               <tr>
                ...
                <td><!-- Hipervínculos para eliminación y modificación de los registros. -->
                  <a class href="#" onclick="javascript:eliminarCargo(<?php echo $row[0];?>);"><i title="Eliminar" class="glyphicon glyphicon-trash"></i></a>
                  <a href="modificar_GF_CARGO.php?id_cargo=<?php echo md5($row[0]);?>"><i title="Modificar" class="glyphicon glyphicon-edit" ></i></a>
                </td>
...
<script type="text/javascript">
      function eliminarCargo(id)
      {
         ...
         $("#ver").click(function(){
              ...
              $.ajax({
                  type:"GET",
                  url:"json/eliminar_GF_CARGOJson.php?id="+id,
