...
<body>
        ...
        <div class="row content">
            ...
            <div class="col-sm-7 text-left" style="margin-left: -16px;margin-top:-20px" >
                ...
                <div class="client-form contenedorForma" style="margin-top:-5px">
                    <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="json/registrar_TERCERO_CLIENTE_NATURALJson.php">
                ...
                <table class="tablaC table-condensed" style="margin-left: -10px">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-primary btnInfo" disabled="true" style="margin-bottom:10px">DIRECCIÓN</button><br/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="GF_TELEFONO.php"><button class="btn btn-primary btnInfo" <?php if (!isset($_SESSION['id_tercero'])) {
                                    echo ' disabled title="Debe primero ingresar un cliente natural."';
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <a href="#"><button class="btn btn-primary btnInfo" disabled="true">PERFIL CONDICIÓN</button></a><br/>
                            </td>
                        </tr>
                    </tbody>
                </table>
    ...
    <script type="text/javascript">
        $('#ver1').click(function () {
            ...
            document.location = 'modificar_TERCERO_CLIENTE_NATURAL.php?id_ter_clie_nat=' + id;
        });
