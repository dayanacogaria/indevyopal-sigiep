...
$sql = "SELECT 
        ehs.id_unico, 
        ehs.id_espacio_habitable as id_ap,
        ...
        ehs.id_servicio as id_serv,
        ts.nombre
        FROM gph_espacio_habitable_servicio ehs
        left join gh_espacios_habitables ehap on ehap.id_unico=ehs.id_espacio_habitable
        ...
        left join gp_tipo_servicio ts on ts.id_unico=ehs.id_servicio
        where md5(ehs.id_unico) = '$id' ";
...
function estado(value){
   ...
   <title>Espacio Habitable Servicio</title>
        ...
        <div class="container-fluid text-center">
            <div class="row content">
                ...
                <div class="col-sm-8 col-md-8 col-lg-8 text-left" style="margin-top: 0px">
                    <h2 id="forma-titulo3" align="center" style="margin-top:0px; margin-right: 4px; margin-left: -10px;">Espacio Habitable Servicio</h2>
                    <a href="<?php echo 'listar_GPH_ESPACIO_HABITABLE_SERVICIO.php';?>" class="glyphicon glyphicon-circle-arrow-left" style="display:inline-block;margin-left:10px; font-size:150%; vertical-align:middle;text-decoration:none" title="Volver"></a>
                        ...
                        <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="" target=”_blank”>
                            <p align="center" style="margin-bottom: 25px; margin-top: 0px; margin-left: 30px; font-size: 80%">Los campos marcados con <strong class="obligado">*</strong> son obligatorios.</p>                                         
                                ...
                                <div class="form-group form-inline" style="margin-top:-25px">
                                    ...
                                    <label for="Servicio" class="col-sm-1 control-label">
                                        <strong class="obligado">*</strong>Servicio:
                                    </label>
                                    <input name="Servicio" id="Servicio" title="Ingrese Piso" 
                                    type="text" style="width: 270px;height: 30px" class="form-control col-sm-1"  
