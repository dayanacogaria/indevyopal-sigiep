...
?>
    ...
    <title>Sábana de Auxilio Educativo</title>
    ...
    <div class="container-fluid text-center">
        <div class="row content">
            ...
            <div class="col-sm-8 text-left">
                <h2 id="forma-titulo3" align="center" style="margin-top:0px; margin-right: 4px; margin-left: -10px;">Sábana de Auxilio Educativo</h2>
                    ...
                    <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="" target="_blank">
                        ...
                        <div class="form-group" style="margin-top: -5px">
                            ...
                            <div class="col-sm-5 col-md-5 col-lg-5">
                                <select  name="p" id="p" title="Seleccione Periodo" style="height: 30px;" class="select2_single form-control" required="required" >
    ...
    <script>
        ...
        $("#enviar").click(function(){
            if($("#optPdf").is(':checked')){
                $("#form").attr("action", "informes_nomina/generar_INF_SABANA_LIQUIDACIONAE.php?t=1");
            } else {
                if($("#optExcel").is(":checked")){
                    $("#form").attr("action", "informes_nomina/generar_INF_SABANA_LIQUIDACIONAE.php?t=2");
                }
            }
        });
    </script>
