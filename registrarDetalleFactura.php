...
$sql = "INSERT INTO gf_detalle_factura(factura, concepto_tarifa, valor, cantidad, iva, impoconsumo, ajuste_peso) VALUES ($factura,$concepto,$valor,$cantidad,$iva,$impoconsumo,$ajustePeso)";
