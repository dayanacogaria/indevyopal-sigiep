...
$queryCiudad = "SELECT c.id_unico, c.nombre,d.nombre,c.rss
FROM gf_ciudad c
INNER JOIN gf_departamento d ON d.id_unico=c.departamento";
              ...
              <?php
               ...
               <tr>
                ...
                <td><!-- Hipervínculos para eliminación y modificación de los registros. -->
                  <a class href="#" onclick="javascript:eliminarCiudad(<?php echo $row[0];?>);"><i title="Eliminar" class="glyphicon glyphicon-trash"></i></a>
                  <a href="modificar_GF_Ciudad.php?id_ciudad=<?php echo md5($row[0]);?>"><i title="Modificar" class="glyphicon glyphicon-edit" ></i></a>
                </td>
...
<script type="text/javascript">
      function eliminarCiudad(id)
      {
         ...
         $("#ver").click(function(){
              ...
              $.ajax({
                  type:"GET",
                  url:"json/eliminar_GF_CiudadJson.php?id="+id,
