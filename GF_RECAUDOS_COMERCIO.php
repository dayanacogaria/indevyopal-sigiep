...
$rowfecha = $con->Listar("SELECT DISTINCT MONTH(fecha), 
                ...
                WHERE pr.parametrizacionanno= $anno AND pr.clase = 1 
    ...
    <div class="container-fluid text-center">
        <div class="row content">
            ...
            <div class="col-sm-10 text-left">
                <h2 id="forma-titulo3" align="center" style="margin-bottom:20px; margin-right:4px; margin-left:4px;">Recaudos Comercio</h2>
                ...
                <script>
                    ...
                    $("#fecha").change(function(){
                        var fecha = $("#fecha").val();
                        if(fecha !=""){
                            document.location ='GF_RECAUDOS_COMERCIO.php?fecha='+fecha;
                        }
                    })
                </script>
                </div>
                <?php } else { ?>
                <a href="GF_RECAUDOS_COMERCIO.php" class="btn sombra btn-primary" style="margin-left:10px; margin-top: -90px" title="Nuevo"><i class="glyphicon glyphicon-plus"></i></a>
                <div class="table-responsive" style="margin-left: 5px; margin-right: 5px;">
                    ...
                    <a href="GF_RECAUDOS_COMERCIO.php" class="btn sombra btn-primary" style="margin-left:10px; margin-top: 10px" title="Nuevo"><i class="glyphicon glyphicon-plus"></i></a>
                </div>
                <?php } ?>
            </div>
        </div>
