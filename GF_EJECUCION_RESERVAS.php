...
# ***************************************** Modificaciones ***************************************** #
######################################################################################################
#08/02/2018 | ERICA G. |ARCHIVO CREADO 
######################################################################################################
...
?>
<title>Ejecución Presupuestal Reservas</title>
...
<div class="container-fluid text-center">
    <div class="row content">
        ...
        <div class="col-sm-10 text-left" style="margin-top: -20px"> 
            <h2 align="center" class="tituloform">Ejecución Presupuestal De Reservas</h2>
...
<script>    
    $("#sltAnnio").change(function(){
       ...
       var form_data={action: 16, annio :$("#sltAnnio").val()};
       ...
       var form_data={action: 17, annio :$("#sltAnnio").val()};
...
function reporteExcel(){
    $('form').attr('action', 'informes/INFORMES_PPTAL/GF_INF_EJECUCION_RESERVAS.php?tipo=2');
}

</script>
<script>
function reportePdf(){
    $('form').attr('action', 'informes/INFORMES_PPTAL/GF_INF_EJECUCION_RESERVAS.php?tipo=1');    
}
</script>
</body>
</html>