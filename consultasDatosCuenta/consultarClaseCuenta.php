...
if ($id==0) {
    ...
    $sqli = "SELECT DISTINCT CT.id_unico,CT.nombre FROM gf_clase_cuenta CT LEFT JOIN gf_cuenta C ON CT.id_unico = C.clasecuenta WHERE CT.id_unico != $row[0] ORDER BY CT.nombre ASC";
