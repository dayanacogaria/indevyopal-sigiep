...
if(empty($_GET['id'])) {
    ...
    $titulo = "Modificar ";
    $id     = $_GET['id'];
    $row    = $con->Listar("SELECT * FROM gy_tipo_proyecto
            WHERE md5(id_unico)='$id'");
    $titulo2= $row[0][1];
}
?>
<title>Tipo Proyecto</title>
<link href="css/select/select2.min.css" rel="stylesheet">
<script src="dist/jquery.validate.js"></script>
<link rel="stylesheet" href="//code.jquery.com/ui/1.12.0/themes/base/jquery-ui.css">
<script src="js/jquery-ui.js"></script>
<style>
    label  #nombre-error, #clase_proyecto-error {
    display: block;
    color: #bd081c;
    font-weight: bold;
    font-style: italic;
    ...
    <div class="container-fluid text-center">
        <div class="row content">
            ...
            <div class="col-sm-10 text-left">
                <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;"><?php echo $titulo.' Tipo Proyecto'?></h2>
                <a href="listar_GY_TIPO_PROYECTO.php" class="glyphicon glyphicon-circle-arrow-left" style="display:inline-block;margin-left:10px; font-size:150%; vertical-align:middle;text-decoration:none" title="Volver"></a>
                ...
                <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">
                    ...
                    <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="javascript:registrar()">
                        ...
                        <div class="form-group" style="margin-top: 0px; ">
                            <label for="clase_proyecto" class="col-sm-5 control-label"><strong style="color:#03C1FB;">*</strong>Clase de Proyecto:</label>
                            <select required id="clase_proyecto" name="clase_proyecto" class="select2_single form-control"  style="height: 35px;"  title="Seleccione una Clase de Proyecto">
                                <option value="">Clase de Proyecto</option>
                               <?php
                               $row = $con->Listar("SELECT  id_unico, nombre
                                FROM gy_clase_proyecto WHERE compania = '$compania'
                                ORDER BY nombre ASC ");
                        ...
                        <input type="hidden" name="txtP" id="txtP" value="<?php echo $proyec; ?>" >
                    </form>
                    <script>
                        function registrar(){
                            var P = $("#txtP").val();
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "jsonProyecto/gy_tipo_proyectoJson.php?action=2",
                                data:formData,
                                contentType: false,
                                processData: false,
                                    ...
                                    if(response==1){
                                        ...
                                        $("#Aceptar").click(function(){
                                            if(P == 1){
                                                ...
                                                document.location='listar_GY_TIPO_PROYECTO.php';
                                            }
                                        })
                                    } else {
                    ...
                    <script>
                        function modificar(){
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "jsonProyecto/gy_tipo_proyectoJson.php?action=3",
                                data:formData,
                                contentType: false,
                                processData: false,
                                success: function(response)
