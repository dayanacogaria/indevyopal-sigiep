...
<html>
    <head>
        ...
        <title>Subir Archivo Recaudos </title>
    </head>
    <body>
        <div class="container-fluid text-center">
            <div class="row content">
                ...
                <div class="col-sm-10 text-left">
                    ...
                    <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;">Subir Archivo Recaudos</h2>
                    <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">
                        <form name="form" id="form" accept-charset=""class="form-horizontal" method="POST"  enctype="multipart/form-data" action="javaScript:guardar()">
                            <p align="center" style="margin-bottom: 25px; margin-top: 25px; margin-left: 30px; font-size: 80%">Archivo .xsl - .xlsx <a href="documentos/formatos/Formato_Recaudos.xlsx" target="_blank"><i class="fa fa-file-excel-o"></i></a></p>
            ...
            function guardar() {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        var registros = data;
                        if(registros != 0){
                            $("#mensaje").html(data+" Registros Guardados Correctamente");
