        ...
        <div class="container-fluid text-left">
            <div class="row content">
                ...
                <div class="col-sm-8 text-center" style="margin-top:-22px;">
                    <h2 class="tituloform" align="center" >Movimiento Niif</h2>
                    <div class="client-form contenedorForma " style="margin-top:-7px;">
                        <form name="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="json/registrarComprobanteContable.php" style="margin-bottom:-20px">
                            ...
                            <input type="hidden" id="formulario" name="formulario" value="GF_MOVIMIENTO_NIIF.php">
                            <?php   
                            #***Trae Id***#
                            if(!empty($_GET['id'])){
                            ...
                            <div class="form-group form-inline col-sm-12" style="margin-top: 5px; margin-left: 5px;">
                                ...
                                <input class="col-sm-2 input-sm" value="<?php if(!empty($fecha)){$fechaS = explode("-",$fecha); echo $fechaS[2].'/'.$fechaS[1].'/'.$fechaS[0];}else{echo date('d/m/Y');} ?>" type="text" name="fecha" id="fecha" class="form-control" style="width:100px;height:26px" title="Ingrese la fecha" placeholder="Fecha" required>                                                                                                
                                <!-- Tipo Comprobante -->
                                ...
                                <select class="col-sm-2 input-sm"  name="sltTipoC" id="sltTipoC" class="form-control" style="width:100px;height:26px;cursor: pointer;" title="Seleccione tipo de comprobante" required>
                                    ...
                                    if(!empty($tipoComprobante)){                                       
                                        ...
                                        $sqlX = "SELECT DISTINCT id_unico,sigla, nombre FROM gf_tipo_comprobante WHERE id_unico != $cn[13] AND clasecontable=15 and niif=1";
                                        ...
                                        <?php 
                                        $sqlTC = "SELECT id_unico,sigla,nombre FROM gf_tipo_comprobante WHERE clasecontable=15 and niif=1";
                                        $m = $mysqli->query($sqlTC);
                                        while($resc = mysqli_fetch_row($m)){
                                            echo '<option value="'.$resc[0].'">'.mb_strtoupper($resc[1]).' - '.ucwords(mb_strtolower($resc[2])).'</option>';
                                        }
                            ...
                            <div class="form-group form-inline col-sm-12" style="margin-top:-10px" >                                  
                                ...
                                <?php if(!empty($_GET['id']) && !empty($cn[19])){ ?>
                                 
                                <textarea class="col-sm-1" style="margin-top:-1px;height:26px;width:345px;" class="area" 
                                name="txtDescripcion" id="txtDescripcion"  maxlength="1000" 
                                onkeypress="return txtValida(event,'num_car')" ><?php echo  $descripcion;?>
                                </textarea>   
                                <?php  } else{ ?> 
                                    <textarea class="col-sm-1" style="margin-top:-1px;height:26px;width:345px;" class="area" 
                                              name="txtDescripcion" id="txtDescripcion"  maxlength="1000"  placeholder="Descripción"
                            ...
                            <div class="form-group form-inline col-sm-12" style="margin-top:-10px" >                                  
                                ...
                                ?>
                                <input class="col-sm-2" type="text" name="txtEstado" id="txtEstado" class="form-control" style="width:100px;height:26px;" value="<?php  echo ucwords(mb_strtolower($row[1])); ?>" title="Estado" placeholder="Estado" readonly/>
                            </div>
                            <div class="form-group form-inline col-sm-6" style="margin-top:-10px" >                                  
                                ...
                                <div class="form-group form-inline col-sm-4" >                                  
                                    <select name="sltTipoBuscar" id="sltTipoBuscar" title="Tipo Comprobante" class="select2_single form-control" style="width: 130px;">
                                        ...
                                        <?php $sqlTC = "SELECT id_unico,sigla,nombre FROM gf_tipo_comprobante WHERE clasecontable=15 and niif=1";
                                        $m = $mysqli->query($sqlTC);
                                        while($resc = mysqli_fetch_row($m)){
                                            echo '<option value="'.$resc[0].'">'.mb_strtoupper($resc[1]).' - '.ucwords(mb_strtolower($resc[2])).'</option>';
                                        } ?>
                                    ...
                                    <script type="text/javascript">
                                        $("#sltBuscar").change(function(){
                                            ...
                                            $.ajax({
                                                ...
                                                data:form_data,
                                                success: function(data){
                                                    document.location ='GF_MOVIMIENTO_NIIF.php?id='+md5($("#sltBuscar").val());                                                   
                                                }
                                            });
                                        }); 
                                    </script>
                                    ...
                                    <script>
                                        ...
                                        function nuevo(){
                                            ...
                                            $.ajax({
                                                ...
                                                data: form_data,
                                                success: function (data) {                                                                                
                                                    document.location='GF_MOVIMIENTO_NIIF.php';                                                   
                                                }
                                            });                                                                                      
                                        }   
                                    </script>
                                ...
                                <div class="form-group" style="margin-top: 5px;"  align="left">
                                    ...
                                    <select name="sltcentroc" id="sltcentroc" class="form-control" style="width:100px;height:26px;padding:2px" title="Seleccione centro costo" required="">
                                        ...
                                        ?>
                                            ...
                                            $a = $mysqli->query($sqlCC);
                                            $filaC = mysqli_fetch_row($a);
                                            echo '<option value="'.$filaC[0].'">'.$filaC[1].'</option>';
                                            $sqlCT = "SELECT DISTINCT id_unico,nombre FROM gf_centro_costo WHERE parametrizacionanno = $anno ORDER BY nombre ASC";
                                            $r = $mysqli->query($sqlCT);
                        ...
                        <table class="tablaC table-condensed text-center" align="center">
                            ...
                            <tbody>
                                ...
                                IF($count>10){ ?> ?>
                                    <tr>                                    
                                    <td>
                                        <a class="btn btn-primary btnInfo" href="GF_DETALLES_COMPROBANTE_CNT.php?id=<?php echo md5($idComprobante)?>">VER DETALLES</a>
                                    </td>
                                    </tr>
                                <?php }  ?>  
                            </tbody>
