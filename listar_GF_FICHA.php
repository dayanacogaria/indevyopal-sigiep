<?php
    ...
    $queryCC = "SELECT id_unico,descripcion FROM gf_ficha";
            ...
            <div class="col-sm-10 text-left">
                ...
                <div class="table-responsive" style="margin-left: 5px; margin-right: 5px;">
                    <div class="table-responsive" style="margin-left: 5px; margin-right: 5px;margin-top:-5px">
                        <table id="tabla" class="table table-striped table-condensed" class="display" cellspacing="0" width="100%">
                            ...
                            <?php while($row = mysqli_fetch_row($resultado)){?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" onclick="javascript:eliminarFicha(<?php echo $row[0];?>);"><i title="Eliminar" class="glyphicon glyphicon-trash"></i>
                                        </a><a href="modificar_GF_FICHA.php?id=<?php echo md5($row[0]);?>"><i title="Modificar" class="glyphicon glyphicon-edit" ></i></a>
                                    </td>
                        ...
                        <div align="right">
                            <a href="registrar_GF_FICHA.php" class="btn btn-primary " style=" box-shadow: 0px 2px 5px 1px gray;
