        ...
        <div class="container-fluid text-center">
            <div class="row content">
                ...
                <div class="col-sm-10 text-left">
                    <h2 align="center" class="tituloform" style="margin-top:-3px">Consulta Abonos</h2>
                            ...
                            <table id="tabla" class="table table-striped table-condensed" class="display" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <td class="cabeza"><strong>Fecha Elaboración</strong></td>
                                        <td class="cabeza"><strong>Valor</strong></td>
                                        <td class="cabeza"><strong>Fecha Pago</strong></td>
                                        <td class="cabeza"><strong>Banco Pago</strong></td>
                                    ...
                                    <tr>
                                        ...
                                        <th class="cabeza">Fecha Elaboración</th>
                                        <th class="cabeza">Valor</th>
                                        <th class="cabeza">Fecha Pago</th>  
                                        <th class="cabeza">Banco Pago</th>  
