...
//Query o sql de consulta
  $queryTipoR = "SELECT Id_Unico, Nombre FROM gf_tipo_responsable  WHERE md5(Id_Unico) ='$id_tipoR'";
...
<!-- Inicio del formulario -->
          <form name="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="json/modificarTiporesponsableJson.php">
