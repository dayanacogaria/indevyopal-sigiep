...
<div class="container-fluid text-center">
    ...
    <?php require_once 'menu.php'; ?>
        <div class="col-sm-10 text-left" style="margin-left: -16px;margin-top: -20px"> 
            <h2 align="center" class="tituloform">Informe Subsidios</h2>
            <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">
                <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="informes_servicios/INF_FACTURAS_SUBSIDIOS.php" target=”_blank”>  
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group" style="margin-top: -5px">
                            ...
                            <select name="tipo" id="tipo" class="form-control select2" title="Seleccione Tipo Informe" style="height: auto " required>
                                ...
                                <option value="1">Informe Subsidios</option>
                                <option value="2">Informe Alcaldía</option>
                                <option value="3">Informe Final</option>
                                <option value="4">Informe Final Acueducto</option>
                                <option value="5">Informe Final Alcantarillado</option>
                                <option value="6">Informe Final Aseo</option>
                            </select>
                        </div>
