...
<script src="js/jquery-ui.js"></script>
   ...
   <title>Generación Volante de Prma de Navidad</title>
    ...
    <body>
        ...
        <div class="col-sm-8 text-left">
                <h2 id="forma-titulo3" align="center" style="margin-top:0px; margin-right: 4px; margin-left: -10px;">Generación de Volante de Pago de Prima de Navidad</h2>
                ...
                <div class="client-form contenedorForma" style="margin-top: -7px;font-size: 13px">        
                    <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="informes/generar_INF_VOLANTE_PRIMANAV.php" target="_blank">
                       ...
                       if(empty($idT))
                        {
                         $emp = "SELECT                         
                            ...
                            FROM gn_empleado e
                            LEFT JOIN gf_tercero t ON e.tercero = t.id_unico  ORDER BY e.id_unico";
                            $idTer = "";
                        }
                        else
                        {
                        ...
                        ?>
                          ...
                          <!--------------------------------------------------------------------- -->
                            <?php
                                $per = "SELECT  id_unico, codigointerno FROM gn_periodo WHERE tipoprocesonomina = 8 AND parametrizacionanno = '$vig'";
