...
$id = (($_GET["id"]));
  $sql = "SELECT        fc.id_unico,
                ...
                FROM gn_formula_concepto fc  
                LEFT JOIN gn_tipo_proceso_nomina tpn on fc.tipoproceso = tpn.id_unico
                LEFT JOIN gn_concepto c ON fc.concepto = c.id_unico
...
?>  
    ...
    <title>Modificar Fórmula Concepto</title>
    ...
    <div class="container-fluid text-center">
        ...
        <div class="row content">
            ...
            <div class="col-sm-10 text-left">
                <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;margin-top: 0px">Modificar Fórmula Concepto</h2>
                <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">
                    <form name="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="json/modificarFormulaConceptoJson.php">
                        ...
                        <div class="form-group" style="margin-top: -10px;">
                            ...
                            <textarea type="text" name="formulaF" id="formulaF" class="form-control col-sm-1" maxlength="100" title="Ingrese la ecuación" placeholder="Ecuación" required style="margin-top: 0px" readonly=""><?php echo trim($fcec) ?></textarea>
                        ...
                        <div class="form-group" style="margin-top: -10px;">
                            ...
                            <textarea type="text" name="txtDescripcion" id="txtDescripcion" class="form-control" maxlength="100" title="Ingrese la descripción" placeholder="Descripción" style="margin-top: 0px"><?php echo $fcdes?></textarea>
                        </div>
                        <!--Fin Campo para llenar Descripción-->                              
                        <!--Consulta para llenar campo Tipo Proceso Nómina-->
                        <?php $tpn = "SELECT id_unico, nombre FROM gn_tipo_proceso_nomina WHERE id_unico!= $fctp";$tipopr = $mysqli->query($tpn); ?>
                        <div class="form-group" style="margin-top: -10px">
                            ...
                            <select name="sltProceso" class="form-control" id="sltProceso" title="Seleccione proceso" required="">
                                <?php 
                                echo "<option value=\"".$tpid."\">".ucwords(mb_strtolower($tpnom))."</option>";
                        ...
                        <?php $con = "SELECT id_unico, CONCAT(codigo,' - ',descripcion) FROM gn_concepto WHERE id_unico != $fccon";$concept = $mysqli->query($con);?>
                        <div class="form-group" style="margin-top: -10px;margin-bottom: 30px">
                            ...
                            <select name="sltConcepto" class="form-control col-sm-1" id="sltConcepto" title="Seleccione concepto" style="width: 35%" required="">
                                <?php 
                                echo "<option value=\"".$conid."\">".ucwords(mb_strtolower($condes))."</option>";
