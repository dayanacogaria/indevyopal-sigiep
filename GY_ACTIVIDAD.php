...
if(empty($_GET['id'])) {
    ...
    $titulo = "Modificar ";
    $id     = $_GET['id'];
    $row    = $con->Listar("SELECT * FROM gy_actividad
...
<style>
    label  #nombre-error, #descripcion-error {
    display: block;
    color: #bd081c;
    font-weight: bold;
    font-style: italic;
    ...
    <div class="container-fluid text-center">
        <div class="row content">
            ...
            <div class="col-sm-10 text-left">
                <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;"><?php echo $titulo.' Actividad'?></h2>
                <a href="listar_GY_ACTIVIDAD.php" class="glyphicon glyphicon-circle-arrow-left" style="display:inline-block;margin-left:10px; font-size:150%; vertical-align:middle;text-decoration:none" title="Volver"></a>
                ...
                <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">
                    ...
                    <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="javascript:registrar()">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="descripcion" id="descripcion" class="form-control" required="required" placeholder="Descripción" title="Ingrese Descripción">
                        </div>
                    ...
                    <script>
                        function registrar(){
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "jsonProyecto/gy_actividadJson.php?action=2",
                                data:formData,
                                contentType: false,
                                processData: false,
                    ...
                    <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="javascript:modificar()">
                        ...
                        <div class="form-group">
                            <label for="descripcion" class="col-sm-5 control-label"><strong style="color:#03C1FB;">*</strong>Descripción:</label>
                            <input type="text" name="descripcion" id="descripcion" class="form-control" required="required" placeholder="Descripción" title="Ingrese Descripción" value="<?php echo $row[0][2]?>">
                        </div>
                        <div class="form-group" style="margin-top: 20px;">
                            <label for="no" class="col-sm-5 control-label"></label>
                            <button type="submit" class="btn btn-primary sombra" style=" margin-top: -10px; margin-bottom: 10px; margin-left:0px">Guardar</button>
                    ...
                    <script>
                        function modificar(){
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "jsonProyecto/gy_actividadJson.php?action=3",
                                data:formData,
                                contentType: false,
                                processData: false,
                                success: function(response)
