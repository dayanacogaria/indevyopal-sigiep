...
$queryEstadom = "SELECT Id_Unico, Nombre FROM gf_estado_movimiento  WHERE md5(Id_Unico) ='$id_estadom'";

}

/*Variable y proceso en el que se llama de manera embebida con la conexión el cual pérmite realizar el proceso de consulta*/
$resultado = $mysqli->query($queryEstadom);
...
<!-- Inicio del formulario -->
          <form name="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="json/modificarEstadoMovJson.php">
