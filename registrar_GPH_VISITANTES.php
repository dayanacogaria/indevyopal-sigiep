            ...
            $('#enviar').click(function () {
                ...
                if(vist===''){
                    if(ndoc==='' || tp_doc===''||nom_C===''){
                        ...
                        window.location = 'json/registrarVisitanteJSON.php?vist='+vist+'&n_doc=' + ndoc + '&tipo_doc=' + tp_doc +
                                    '&nom_c=' + nom_C + '&placa=' + plac + '&tipoV=' + tp_V + '&apto=' + apto + '&fe=' + fe +
                                    '&he=' + he+'&fs='+fs+'&hs='+hs+'&observa='+obsr+'&parq='+parq;
                        }
                    }
                }else{
                    if(apto==='' || fe===''||he===''){
...
<?php require_once 'menu.php'; ?>
        <div class="col-sm-8 col-md-8 col-lg-8 text-left" style="margin-top: 0px">
            <h2 id="forma-titulo3" align="center" style="margin-top:0px; margin-right: 4px; margin-left: -10px;">Registrar Visitante</h2>
                ...
                <form id="formid" name="formid" class="form-horizontal" method="POST"  enctype="multipart/form-data" >
                    ...
                    <div class="form-group form-inline" >                                     
                        ...
                        <input  name="txtNumeroD" id="txtNumeroD" title="Ingrese Número Documento" 
                                ...
                                placeholder="Número Documento" value=""  required>
                        ...
                        <input  name="txtNombreC" id="txtNombreC" title="Ingrese Nombre Completo" 
                                ...
                                placeholder="Nombre Completo" value="" onkeyup="javascript:this.value=this.value.toUpperCase();"  required>   
                    ...
                    <div class="form-group form-inline" >   
                        ...
                        <input  name="txtPlaca" id="txtPlaca" title="Ingrese Placa" 
                                ...
                                placeholder="Placa" value="" onkeyup="javascript:this.value=this.value.toUpperCase();"  required>  
                        ...
                        <input style="width: 290px;height: 30px" type="text" id="sltApartamento" value="" name="sltApartamento" title="Ingrese Espacio Habitable" 
                               class="form-control col-sm-1" placeholder="Apartamento" /> 
                        <input style="width: 140px;height: 30px" type="hidden" id="sltApartamento2" value="" name="sltApartamento2" /> 
                        ...
                        <input name="sltFechaE" id="sltFechaE" title="Ingrese Fecha Entrada" 
                               ...
                               value="<?php echo $fecha_ac; ?>"  required>  
                        ...
                        <input  name="txtHoraE" id="txtHoraE" title="Ingrese Hora Entrada" 
                                ...
                                placeholder="Hora Entrada" value="08:00:00" required>  
                        ...
                        <input  name="txtHoraS" id="txtHoraS" title="Ingrese Hora Salida" 
                                ...
                                placeholder="Hora Entrada" value="08:00:00"  >  
                    ...
                    <div class="form-group form-inline" style="margin-left:25px;">
                        ...
                        <input style="width: 465px;height: 30px" type="text" id="sltParqueadero" value="" name="sltParqueadero" title="Ingrese parqueadero" 
                               class="form-control col-sm-1" placeholder="Parqueadero" /> 
                        <input style="width: 200px;height: 30px" type="hidden" id="sltParqueadero2" value="" name="sltParqueadero2" /> 
