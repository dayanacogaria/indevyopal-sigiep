...
$titulo2 ="";
if(empty($_GET['id'])){
    $titulo = "Registrar Vigencias Interfaz Predial";
    $titulo2 =".";
} else {
    $titulo = "Modificar Vigencias Interfaz Predial";
    $sql = "SELECT id_unico, nombre, valor, vigencias_anteriores "
            . "FROM gf_vigencias_interfaz_predial "
...
<script>
    $("#aceptar").click(function(){
       window.location="LISTAR_GF_VIGENCIAS.php";
    });
</script>
