...
<!--Lllamado al menu    --> 				
			...
			<div class="col-sm-10 text-left">
				 <h2 id="forma-titulo3" align="center" style="margin-bottom: 5px; margin-right: 4px; margin-left: 4px; margin-top:5px">Registrar Tercero Ingresos</h2>
<!-- Bot�n volver -->          
...
<!-- Caja para REGISTRAR la informacion -->
       <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form contenedorForma col-sm-12"> 
          ...
          <form name="form" id="form" method="POST" class="form-inline" enctype="multipart/form-data" action="json/registrarTerceroIngresosJson.php">
          ...
          <div class="table-responsive" style="margin-left: 5px; margin-right: 5px;">
            <table id="tabla" class="table table-striped table-condensed" class="display" cellspacing="0" width="100%">
              ...
              //consulta para traer los datos a listar
                $tipoA2 = "SELECT ti.id_unico, ti.valor_ingresos
                          FROM gf_tercero_ingresos ti 
                          WHERE ti.tercero = $id";
...
$("#ver1").click(function(){
   ...
   document.location = "GF_TERCERO_INGRESOS.php";
 });
...
<script type="text/javascript">
  function eliminarItem(id)
  {
   ...
   $("#ver").click(function(){
    ...
    $.ajax({
      type:"GET",
      url:"json/eliminarTerceroIngresos.php?id="+id,
      success: function (data) {
        result = JSON.parse(data);
        if(result==true)
          $("#myModal1").modal('show');
