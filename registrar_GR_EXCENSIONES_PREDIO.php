...
#session_start();
?>
   <title>Registrar Excensiones Predio</title>
    </head>
    <body>
        ...
        <div class="container-fluid text-center">
              <div class="row content">
                  ...
                  <div class="col-sm-10 text-left">
                      <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;">Registrar Excensiones Predio</h2>
                      <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">
                          <form name="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="json/registrarExcensionesPredioPJson.php">
                        ...
                        <div class="form-group" style="margin-top: 0px">
                            ...
                            <input required="required" type="text" name="txtResolucion" id="txtResolucion" class="form-control" maxlength="50" title="Ingrese la resolución" onkeypress="return txtValida(event,'num_car')" placeholder="Resolución" >
                        </div>
                        <!----------Fin Resolución-->
                        ...
                        <!--Campo para captura de Fecha Inicial-->
                                                <div class="form-group" style="margin-top: 0px;">
                                                    ...
                                                    <input style="width:auto" class="col-sm-2 input-sm" type="text" name="sltFechaI" id="sltFechaI"value="<?php echo date("Y-m-d");?>" title="Ingrese Fecha Inicial">
                                                </div>
                        ...
                        <!--Campo para captura de Fecha Final-->
                                                <div class="form-group" style="margin-top: 0px;">
                                                    ...
                                                    <input style="width:auto" class="col-sm-2 input-sm" type="text" name="sltFechaF" id="sltFechaF" value="<?php echo date("Y-m-d");?>" title="Ingrese Fecha Final">
                                                </div>
                        ...
                        <div class="form-group" style="margin-top: 0px">
                            ...
                            <input required="required" type="text" name="txtPorex" id="txtPorex" class="form-control" maxlength="5" title="Ingrese el porcentaje excensión" onkeypress="return txtValida(event,'decimales')" placeholder="Porcentaje Ex.">
                        </div>
                        ...
                        <!------------------------- Consulta para llenar campo Tipo-->
                            ...
                            $tip = "SELECT id_unico, nombre 
                                FROM gr_tipo_excension ORDER BY id_unico ASC";
                        ...
                        <!------------------------- Consulta para llenar campo Predio-->
                            ...
                            $pr = "SELECT id_unico, nombre 
                                FROM gp_predio1 WHERE nombre IS NOT NULL ORDER BY id_unico ASC";
