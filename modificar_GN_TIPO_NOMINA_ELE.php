...
//Query o sql de consulta
  $queryForma = "SELECT Id_Unico, Nombre FROM gn_tipo_novedad_nomina  WHERE md5(Id_Unico) ='$id_forma'";

}
$resultado = $mysqli->query($queryForma);
$row = mysqli_fetch_row($resultado);
?>
  <title>Modificar Tipo Novedad Nómina Elctrónica</title>
</head>
...
<!-- Llamado al menú del formulario -->   
    ...
    <div class="col-sm-10 text-left">
      ...
      <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;">Modificar Tipo Novedad Nómina Electrónica</h2>

      <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">

          <form name="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="json/modificarTipoNovedadNominaEJson.php">
