<?php
#14/03/2017 --- Nestor B --- se modificó el método que cambia el formato de fecha para que no genere error cuando la fecha sea vacía
        ...
        <div class="container-fluid text-center">
            <div class="row content">
                ...
                <div class="col-sm-10 text-left">
                    <h2 id="forma-titulo3" align="center" style="margin-top: 0px; margin-bottom: 20px; margin-right: 4px; margin-left: 4px;">Pensionado</h2>
                    <div class="table-responsive" style="margin-left: 5px; margin-right: 5px;margin-top:-10px;">
                        <div class="table-responsive" style="margin-left: 5px; margin-right: 5px;">
                            ...
                            <div align="right">
                                <a href="registrar_GN_PENSIONADO.php" class="btn btn-primary " style=" box-shadow: 0px 2px 5px 1px gray;color: #fff; border-color: #1075C1; margin-top: 20px; margin-bottom: 20px; margin-left:-20px; margin-right:4px">Registrar Nuevo</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
  ...
  <script type="text/javascript">
      ...
      $('#ver1').click(function(){
        document.location = 'listar_GN_PENSIONADO.php';
      });
