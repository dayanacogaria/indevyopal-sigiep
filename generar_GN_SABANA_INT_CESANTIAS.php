...
<script src="js/jquery-ui.js"></script>
   ...
   <title>Sábana de Intereses de Cesantías</title>
    ...
    <body>
        ...
        <div class="col-sm-8 text-left">
                <h2 id="forma-titulo3" align="center" style="margin-top:0px; margin-right: 4px; margin-left: -10px;">Sábana de Intereses de Cesantías</h2>
                ...
                <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">        
                    <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="informes/generar_INF_SABANA_CESANTIAS.php" target="_blank">
...
<!--------------------------------------------------------------------------------------------------------------------- -->
                          ...
                          <!--------------------------------------------------------------------- -->
                                ...
                                <?php
                                    $per = "SELECT  id_unico, codigointerno FROM gn_periodo WHERE id_unico !=1 AND tipoprocesonomina = 10 AND parametrizacionanno = '$vig'";
