...
<html>
    <head>    
        ...
        <title>Listar Comparendos</title>
    </head>
    <body>
        <div class="container-fluid text-center">
            <div class="row content">
                ...
                <div class="col-sm-10 text-left">
                    <h2 id="forma-titulo3" align="center" style="margin-top: 0px; margin-bottom: 20px; margin-right: 4px; margin-left: 4px;">Listar Comparendos <?php echo $t;?></h2>
                        <?php if(empty($_GET['s'])){ ?>
                        ...
                        <script>
                            $("#buscar").click(function(){
                                if($("#sucursal").val()!=""){
                                    ...
                                    var fi = $("#fechaini").val();
                                    var ff = $("#fechafin").val();
                                    document.location ='LISTAR_GU_COMPARENDOS.php?s='+s+'&fi='+fi+'&ff='+ff;
                                }
                            })
                        </script>
                        <?php }  else { 
                            if(!empty($_GET['fi'])){
                                ...
                                $row = $con->Listar("SELECT id_unico, 
                                        numero, 
                                        comparendo, 
                                        DATE_FORMAT(fecha_comparendo, '%d/%m/%Y') as fecha_comparendo, 
                                        placa, 
                                        infraccion, 
                                        cedula, 
                                        nombres, 
                                    ...
                                    AND fecha_comparendo BETWEEN '$fi' AND '$ff'");
                            }else{
                                $row = $con->Listar("SELECT id_unico, 
                                        numero, 
                                        comparendo, 
                        ...
                        <div class="table-responsive" style="margin-left: 5px; margin-right: 5px;margin-top:-10px;">
                            <div class="table-responsive" style="margin-left: 5px; margin-right: 5px;">
                                <table id="tabla" class="table table-striped table-condensed" class="display" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <td class="cabeza"><strong>N°</strong></td>
                                            <td class="cabeza"><strong>Comparendo</strong></td>
                                            <td class="cabeza"><strong>Fecha Comparendo</strong></td>
                                            <td class="cabeza"><strong>Placa</strong></td>
                                            <td class="cabeza"><strong>Infracción</strong></td>
                                            <td class="cabeza"><strong>Cédula</strong></td>
                                            <td class="cabeza"><strong>Nombres</strong></td>
                                            <td class="cabeza"><strong>Apellidos</strong></td>
                                            <td class="cabeza"><strong>Dirección</strong></td>
                                            <td class="cabeza"><strong>Ciudad</strong></td>
                                            <td class="cabeza"><strong>Fecha Notificación</strong></td>

                                        </tr>
                                        <tr>
                                            <th class="cabeza" style="display: none;">Identificador</th>
                                            <th width="7%"></th>                                        
                                            <th class="cabeza">N°</th>
                                            <th class="cabeza">Comparendo</th>
                                            <th class="cabeza">Fecha Comparendo</th>
                                            <th class="cabeza">Placa</th>
                                            <th class="cabeza">Infracción</th>
                                            ...
                                            <th class="cabeza">Fecha Notificación</th>
                                        </tr>
                                    </thead>    
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="campos"><?php echo $row[$i]['numero']?></td>                
                                            <td class="campos"><?php echo $row[$i]['comparendo']?></td>                
                                            <td class="campos"><?php echo $row[$i]['fecha_comparendo']?></td>                
                                            <td class="campos"><?php echo $row[$i]['placa']?></td>                
                                            <td class="campos"><?php echo $row[$i]['infraccion']?></td>     
                                            <td class="campos"><?php echo $row[$i]['cedula']?></td>                
                                            <td class="campos"><?php echo $row[$i]['nombres']?></td>
                                            <td class="campos"><?php echo $row[$i]['apellidos']?></td>
                                            <td class="campos"><?php echo $row[$i]['direccion']?></td>
                                            <td class="campos"><?php echo $row[$i]['ciudad']?></td>
                                            <td class="campos"><?php echo $row[$i]['fecha_notificacion']?></td>
                                ...
                                <div align="right">
                                    <br/>
                                    <button onclick="location.href='LISTAR_GU_COMPARENDOS.php'" style="margin-left:0px;" type="button"  class="btn sombra btn-primary" title="Nuevo"><i class="glyphicon glyphicon-plus" aria-hidden="true"></i></button>
                                </div>
                            </div>
                        </div>
                        <?php } ?>
