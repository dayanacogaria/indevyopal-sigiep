...
//Query o sql de consulta    
    $queryTipo = "SELECT Id_Unico, Nombre FROM gf_tipo_operacion  WHERE md5(Id_Unico) ='$id_tipo'";
  }
...
<!-- Inicio del formulario -->
          <form name="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="json/modificarTipoOperJson.php">
