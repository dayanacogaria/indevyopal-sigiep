...
$(document).ready(function() {
    $('#enviar').click(function(){
        ...
        if(ano === '' || valor === '' || selected_ap === ''){
             $("#myModalcomp").modal('show');
        }else{
           
            window.location='json/registrarEspacioHabitableTarifaJSON.php?id_ap='+selected_ap+'&ano='+ano+'&valor='+valor;
...
function estado(value){
   ...
   <title>Registrar Espacio Habitable Tarifa</title>
        ...
        <div class="container-fluid text-center">
              <div class="row content">
                  ...
                  <div class="col-sm-8 col-md-8 col-lg-8 text-left" style="margin-top: 0px">
                      <h2 id="forma-titulo3" align="center" style="margin-top:0px; margin-right: 4px; margin-left: -10px;">Registrar Espacio Habitable Tarifa</h2>
...
<!-------------------------------------------------------------------------------------------------------------------- -->
                          ...
                          <div class="form-group form-inline" style="margin-top:5px; ">
                            ...
                            ?>
                             ...
                             <!--Año-->
                                <?php
                                $tip = "SELECT * FROM gf_parametrizacion_anno order by anno desc";
                                            $t[0]="";
                                            $t[1]="Año";
                                             $tipon = $mysqli->query($tip);
                                ?>
                                    <label for="sltAno" class="col-sm-2 control-label">
                                          <strong class="obligado">*</strong>Año:
                                    </label>
                                    <select   name="sltAno" id="sltAno" title="Seleccione Ano" 
                              ...
                              <!--valor-->
                                    ...
                                    <label for="valor" class="col-sm-2 control-label">
                                        ...
                                        <input style="width: 300px;height: 30px" type="text" id="valor" value="" name="valor" title="Ingrese Valor" 
                                        class="form-control col-sm-1" placeholder="Valor"/> 
                          </div>
                          <div class="form-group form-inline" >
                    <!-- <div class="col-sm-12 text-left" style="display:<?php echo $a?>">-->
                          <strong style=" font-size: 12px; margin-left: 52px; margin-right: 5px;margin-top:10px; margin-bottom: 10px;">ESPACIOS HABITABLES - CONCEPTOS</strong><input style="margin-left: 350px; margin-right: 15px;margin-top:10px; margin-bottom: 10px;" type="checkbox" 
                                        ...
                                        <table id="tableO" class="table table-striped table-condensed display" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                <?php 
                                                 ...
                                                 $sql1="SELECT 
                                                        ehcp.id_unico as id_eh_concepto,
                                                        ...
                                                        from gph_espacio_habitable_concepto ehcp
                                                        left join gh_espacios_habitables ehap on ehap.id_unico=ehcp.id_espacio_habitable
                                                        ...
                                                        left join gp_concepto cn on cn.id_unico=ehcp.id_concepto
                                                        where ehap.tipo='3' OR ehap.tipo='5' OR ehap.tipo='7' order by ehcp.id_espacio_habitable asc";
                                                ...
                                                while ($rowC = mysqli_fetch_row($re)) {  
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td class="campos text-center"><?php echo $n_concepto;?></td>  
