...
$queryCondicion = "SELECT Id_Unico, Nombre FROM gf_clase_servicio  ORDER BY Nombre ASC" ; 
            ...
            <tbody>
              ...
              <?php
               ...
               <tr>
                ...
                <td><a class"" href="#" onclick="javascript:eliminar(<?php echo $row[0];?>);"><i title="Eliminar" class="glyphicon glyphicon-trash"></i></a><a href="Modificar_GF_CLASE_SERVICIO.php?id=<?php echo md5($row[0]);?>"><i title="Modificar" class="glyphicon glyphicon-edit" ></i></a></td>
...
<script type="text/javascript">
      function eliminar(id)
      {
         ...
         $("#ver").click(function(){
              ...
              $.ajax({
                  type:"GET",
                  url:"json/eliminarClase_Servicio.php?id="+id,
