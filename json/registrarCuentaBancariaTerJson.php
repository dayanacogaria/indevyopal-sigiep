<?php
 ...
 $num = 0;
  $query="SELECT cuentabancaria, tercero FROM gf_cuenta_bancaria_tercero WHERE  cuentabancaria= $cuenta AND tercero=$tercero";
  $sql = $mysqli->query($query);
  $num=mysqli_num_rows($sql);

  if($num == 0)//Si no existe el tipo actividad, se realizará la inserción de datos en la tabla.
  {
  $insertSQL = "INSERT INTO gf_cuenta_bancaria_tercero (cuentabancaria, tercero) VALUES($cuenta, $tercero)";
      ...
      <div class="modal-content">
        ...
        <p><?php
              if($num != 0) //Si se encuentra el año, informará al usuario.
                echo "La cuenta bancaria ingresada ya existe.";
              else
