<?php
  ...
  $insert = "INSERT INTO gp_ciclo (nombre, unidad_vivienda_inicial, "
          . "unidad_vivienda_final, estado_facturacion, formato_factura) "
          . "VALUES( $nombre,$viviendaI, $viviendaF, $estadoF, $formato )";
