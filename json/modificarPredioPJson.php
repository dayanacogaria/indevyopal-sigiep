...
if($predio=="")
 ...
 $insertSQL = "UPDATE gp_predio1 SET nombre=$nombre,aniocreacion=$aniocreacion,codigoigac=$codigo,participacion=$participacion,principal=$principal,estado=$estado,estrato=$estrato,predioaso=$predio,tercero=$tercero WHERE id_unico = $id";
