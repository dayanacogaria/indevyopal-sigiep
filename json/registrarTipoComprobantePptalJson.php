...
$sql = "INSERT INTO gf_tipo_comprobante_pptal 
    (codigo, nombre, obligacionafectacion, 
    terceroigual, compania, clasepptal, 
    vigencia_actual,automatico, 
    tipooperacion, tipodocumento,afectado) 
    VALUES ($codigo, 
    $nombre,  $obli, $ter, $compania, 
    $claseP, $vigenciaA,$automatico, 
    $tipoO,$tipDocumento,$afectado)";
