...
################ MODIFICACIONES ####################
#03/06/2017 | Anderson Alarcon | Cambie update  
############################################
...
$formula = '"'.$mysqli->real_escape_string(''.$_POST['txtFormula'].'').'"';
...
if($_POST['sltSector']==2)
{
 ...
 $insertSQL = "UPDATE gr_concepto_predial SET nombre=$nombre, formula=$for, rural=$rural, urbano=$sector, tipo=$tipo where id_unico =$id";
...
<script type="text/javascript">
  ...
  $("#ver1").click(function(){
    $("#myModal1").modal('hide');
    window.location='../listar_GR_CONCEPTO_PREDIAL.php';
  });
</script>
<?php }else{ ?>
<script type="text/javascript">
