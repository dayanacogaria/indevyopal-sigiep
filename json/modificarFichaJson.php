...
//obtiene los datos que se van a modificar
      $nombre  = '"'.$mysqli->real_escape_string(''.$_POST['txtDescripcion'].'').'"';
      $id  = '"'.$mysqli->real_escape_string(''.$_POST['id'].'').'"';
   
//modificar ne la base de datos
  $insertSQL = "UPDATE gf_ficha SET descripcion=$nombre WHERE id_unico = $id";
...
<script type="text/javascript">
  ...
  $("#ver1").click(function(){
    $("#myModal1").modal('hide');
    window.location='../listar_GF_FICHA.php';
  });
</script>
<?php }else{ ?>
<script type="text/javascript">
