<?php
  ...
  $idAnteriorComprobante  = '"'.$mysqli->real_escape_string(''.$_POST['idCompPtal'].'').'"'; 
  ...
  if($resultado == true)
  {
    ...
    $_SESSION['id_comp_pptal_EO'] = $idNuevoComprobante;
    $_SESSION['nuevo_EO'] = 1;
...
<script type="text/javascript">
  ...
  $("#ver1").click(function(){
    $("#myModal1").modal('hide');
    window.location='../EXPEDIR_OBLIGACION_PPTAL.php';
  });
</script>
<?php }else{ ?>
<script type="text/javascript">
