...
//modificar ne la base de datos
  $insertSQL = "UPDATE gn_grupo_gestion SET nombre=$nombre, grupo_sui=$grupoSui,servicio_sui=$servicioSui WHERE id_unico = $id";
...
<script type="text/javascript">
  ...
  $("#ver1").click(function(){
    $("#myModal1").modal('hide');
    window.location='../listar_GN_GRUPO_GESTION.php';
  });
</script>
<?php }else{ ?>
<script type="text/javascript">
