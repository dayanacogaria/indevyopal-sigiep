...
$nombreguia  = $mysqli->real_escape_string(''.$_POST['nombre'].'');
$nombre =$nombre;
...
$queryU="SELECT * FROM gs_guias "
 ...
 $num=mysqli_num_rows($car);
  ...
  if($num == 0)
  {
  $insert = "INSERT INTO gs_guias (id_unico, nombre, modulo, ruta) "
          . "VALUES('$id', '$nombreguia', '$modulo', '$ruta')";
...
<?php if($resultado==true){ ?>
    <script type="text/javascript">
      ...
      $("#ver1").click(function(){
        $("#myModal1").modal('hide');
        window.location='../SUBIR_GS_GUIAS.php';
      });
    </script>
<?php }else{ ?>
    <script type="text/javascript">
