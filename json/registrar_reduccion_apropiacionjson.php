 ...
 // $fuente = '"'.$mysqli->real_escape_string(''.$_POST['fuente'].'').'"';
  ...
  $id_rubro_fuente = '"'.$mysqli->real_escape_string(''.$_POST['id_rubro_fuente'].'').'"';

  $valor = str_replace(',', '', $valor);

  $id_comprobante_pptal = $_SESSION['idComPtalReduc'];
  
  $descripcion = '"REDUCCIÓN APROPIACIÓN"';
...
<script type="text/javascript">
  ...
  $("#ver1").click(function(){
    $("#myModal1").modal('hide');
    window.location='../REDUCCION_APROPIACION.php';
  });
</script>
<?php }else{ ?>
<script type="text/javascript">
