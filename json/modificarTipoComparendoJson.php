...
$sancion        = '"'.$mysqli->real_escape_string(''.$_POST['txtSancion'].'').'"';
...
//modificar ne la base de datos
 $insertSQL = "UPDATE gu_tipo_comparendo SET  codigo=$codigo, nombre=$nombre, sigla_sancion=$sigla,
         sancion=$sancion, valor_sancion=$valor, anno = $anno  WHERE id_unico = $id";
...
<script type="text/javascript">
  ...
  $("#ver1").click(function(){
    $("#myModal1").modal('hide');
    window.location='../listar_GU_TIPO_COMPARENDO.php';
  });
</script>
<?php }else{ ?>
<script type="text/javascript">
