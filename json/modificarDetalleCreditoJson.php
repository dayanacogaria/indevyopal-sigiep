...
$credito    = '"'.$mysqli->real_escape_string(''.$_POST['sltCredito'].'').'"';
$id         = '"'.$mysqli->real_escape_string(''.$_POST['id'].'').'"';
   
//modificar ne la base de datos
  $insertSQL = "UPDATE gn_detalle_credito SET concepto=$concepto, credito=$credito WHERE id_unico = $id";
...
<script type="text/javascript">
  ...
  $("#ver1").click(function(){
    $("#myModal1").modal('hide');
    window.location='../listar_GN_DETALLE_CREDITO.php';
  });
</script>
<?php }else{ ?>
<script type="text/javascript">
