...
$ecuacion       = '"'.$mysqli->real_escape_string(''.$_POST['formulaF'].'').'"';
$tipoproceso    = '"'.$mysqli->real_escape_string(''.$_POST['sltProceso'].'').'"';
...
//modificar ne la base de datos
  $insertSQL = "UPDATE gn_formula_concepto SET ecuacion = $ecuacion, descripcion = $descripcion, tipoproceso = $tipoproceso, concepto = $concepto WHERE id_unico = $id";
...
<script type="text/javascript">
  ...
  $("#ver1").click(function(){
    $("#myModal1").modal('hide');
    window.location='../listar_GN_FORMULA_CONCEPTO.php';
  });
</script>
<?php }else{ ?>
<script type="text/javascript">
