...
$sql = "INSERT INTO gf_movimiento(numero, fecha, descripcion, observaciones, tipomovimiento, parametrizacionanno, tercero, dependencia, centrocosto, proyecto, estado) VALUES ('$numeroC',$fechaC,$descripcion,$observaciones,$tipoM,$paramA,$responsable,$dependencia,$centrocosto,$proyecto,$estadoM)";
...
<?php if($resultado==true){
    ...
    for ($index = 0; $index < count($data); $index++) {
        ...
        $idDetalle = $data[$index]['idDetalle'];
        $sqlFila = "INSERT INTO gf_detalle_movimiento(planmovimiento,cantidad,valor,iva,movimiento,detalleasociado) VALUES('$planI','$cantidad','$valor','$valorIva','$fila[0]','$idDetalle');";                
...
<script type="text/javascript">
  ...
  $("#ver1").click(function(){
    $("#myModal1").modal('hide');
    window.location = '../registrar_GR_SALIDA_ALMACEN.php?salida=<?php echo md5($fila[0])?>';    
  });
</script>
<?php }else{ ?>
<script type="text/javascript">
