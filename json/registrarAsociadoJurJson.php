...
$insertSQL = "INSERT INTO gf_tercero (RazonSocial, NumeroIdentificacion, 
    ...
    CiudadIdentificacion, TipoRegimen, Contacto, TipoEmpresa,  Zona, email)
    VALUES($razoSoci, $noIdent, 
    $digitVerif, $compania, $tipoIden, $sucursal, $repreLegal, 
    $ciudad, $tipoReg, $contacto, $tipoEmp, $zona, $correo)";
...
$insertSQL = "INSERT INTO gf_perfil_tercero (Perfil, Tercero) VALUES(8, $row[0])";
$resultado = $mysqli->query($insertSQL);
?>
<html>
    <head>
