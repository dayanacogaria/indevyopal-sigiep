...
# ************************************   Modificaciones   ******************************************* #
#######################################################################################################
#26/07/2018 |Erica G. | Correo Electrónico - Arreglar Código
#######################################################################################################
...
$sql = "select perfil from gf_perfil_tercero where perfil=7 and tercero=$id";
$result = $mysqli->query($sql);
$perfil = mysqli_fetch_row($result);
if (empty($perfil[0])) {
    $insertSQL = "INSERT INTO gf_perfil_tercero (Perfil, Tercero) VALUES(7, $id)";
