...
//modificar ne la base de datos
  $insertSQL = "UPDATE gn_tipo_vinculacion SET nombre=$nombre, tipo_vinculacion=$tipo_vinculacion WHERE id_unico = $id";
...
<script type="text/javascript">
  ...
  $("#ver1").click(function(){
    $("#myModal1").modal('hide');
    window.location='../listar_GN_TIPO_VINCULACION.php';
  });
</script>
<?php }else{ ?>
<script type="text/javascript">
