...
$insertSQL = "INSERT INTO gf_tercero (TipoIdentificacion, 
    ...
    ApellidoDos, TipoRegimen, Compania,email, nombre_comercial) 
    VALUES( $tipoI, $numId,  $primerN, $segundoN, 
    $primerA, $segundoA, $tipoR, $compania,$email, $nombreC)";
...
if($resultado == true)
{
    ...
    $insertSQL = "INSERT INTO gf_perfil_tercero (Perfil, Tercero) VALUES(3, $row[0])";
    $resultado = $mysqli->query($insertSQL);
}
