<?php
  ...
  //Captura de datos e instrucción SQL para su inserción en la tabla gs_tipo_elemento.
  $nombre  = '"'.$mysqli->real_escape_string(''.$_POST['nombre'].'').'"';
  
  $insertSQL = "INSERT INTO gs_tipo_elemento (Nombre) VALUES($nombre)";
...
<script type="text/javascript">
  ...
  $("#ver1").click(function(){
    $("#myModal1").modal('hide');
    window.location='../GS_TIPO_ELEMENTO.php';
  });
</script>
<?php }else{ ?>
<script type="text/javascript">
