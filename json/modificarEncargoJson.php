...
$insertSQL = "UPDATE gn_encargo SET empleado=$empleado, categoria=$categoria, cargo=$cargo, dependencia=$dependencia, numeroacto=$numeroacto, fechaacto=$fechaacto, fechainicio=$fechainicio, fechafin=$fechafin, tiponovedad=$tiponovedad WHERE id_unico = $id";
...
<script type="text/javascript">
  ...
  $("#ver1").click(function(){
    $("#myModal1").modal('hide');
    window.location='../listar_GN_ENCARGO.php';
  });
</script>
<?php }else{ ?>
<script type="text/javascript">
