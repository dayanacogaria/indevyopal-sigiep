...
//modificar ne la base de datos
  $insertSQL = "UPDATE gn_tipo_proceso_nomina SET nombre=$nombre, tipo_periodo_nomina = $periodoE  WHERE id_unico = $id";
...
<?php if($resultado==true){ ?>
  ...
  $("#ver1").click(function(){
    $("#myModal1").modal('hide');
    window.location='../listar_GN_TIPO_PROCESO_NOMINA.php';
  });
</script>
<?php }else{ ?>
<script type="text/javascript">
