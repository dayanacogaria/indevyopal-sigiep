...
#$fechaterminacion       = '"'.$mysqli->real_escape_string(''.$_POST['sltFechaT'].'').'"';
...
//modificar ne la base de datos
 $insertSQL = "UPDATE gn_estudio SET titulo=$titulo, fechaterminacion=$fechaterminacion, numerosemestres=$numerosemestres, graduado=$graduado, tarjetaprofesional=$tarjetaprofesional, empleado=$empleado, tipo=$tipo, institucioneducativa=$institucioneducativa WHERE id_unico = $id";
...
<script type="text/javascript">
  ...
  $("#ver1").click(function(){
    $("#myModal1").modal('hide');
    window.location='../listar_GN_ESTUDIO.php';
  });
</script>
<?php }else{ ?>
<script type="text/javascript">
