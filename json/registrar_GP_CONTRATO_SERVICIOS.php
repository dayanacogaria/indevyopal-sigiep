...
<!--Campo para captura de Fecha-->
           <div class="form-group" style="margin-top: -10px;">
                ...
                <input type="date" name="FechaC" id="FechaC" class="form-control" maxlength="10" title="Fecha contrato" onkeypress="return txtValida(event,'num_car')" placeholder="Número de familias" required>
