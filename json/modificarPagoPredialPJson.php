...
################ MODIFICACIONES ####################
#11/06/2017       | Anderson Alarcon | cambie update en  pago predial 
############################################
...
//obtiene los datos que se van a modificar
    $fechaP      = '"'.$mysqli->real_escape_string(''.$_POST['sltFechaP'].'').'"';
...
//modificar ne la base de datos
  $insertSQL = "UPDATE gr_pago_predial SET fechapago=$fechaP, responsable=$responsable, banco=$banco WHERE id_unico = $id";
...
<script type="text/javascript">
  ...
  $("#ver1").click(function(){
    $("#myModal1").modal('hide');
    window.location='../listar_GR_PAGO_PREDIAL.php';
  });
</script>
<?php }else{ ?>
<script type="text/javascript">
