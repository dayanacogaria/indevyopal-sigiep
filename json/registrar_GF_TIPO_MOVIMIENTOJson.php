<?php
    ...
    $queryU="SELECT * FROM gf_tipo_movimiento "
    ...
    if($num == 0) {
        $insert = "INSERT INTO gf_tipo_movimiento (nombre, costea, clase,tipoelemento, tipopersona, tipo_documento, compania, sigla) "
          . "VALUES($nombre, $costea, $clase, $elemento, $persona, $formato, $compania, $sigla)";
