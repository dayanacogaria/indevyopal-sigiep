...
$unidad       = '"'.$mysqli->real_escape_string(''.$_POST['sltUnidad'].'').'"';
...
#$fec = date_format($date,"Y/m/d");
  ...
  $insertSQL = "UPDATE gr_area SET valor=$valor,anio=$anio,tipoarea=$tipo,unidadarea=$unidad,motivocambioarea=$mot,predio=$predio where id_unico = $id";
...
<script type="text/javascript">
  ...
  $("#ver1").click(function(){
    $("#myModal1").modal('hide');
    window.location='../listar_GR_AREA.php';
  });
</script>
<?php }else{ ?>
<script type="text/javascript">
