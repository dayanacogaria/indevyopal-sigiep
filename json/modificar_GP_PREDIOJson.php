...
session_start();
  ...
  $update = "UPDATE gp_predio1 SET codigo_catastral=$codigoC, nombre =$nombre,"
          . "aniocreacion=$annio, matricula_inmobiliaria =$matricula, "
         . " codigo_sig=$codigo, codigoigac=$codigoIG, participacion=$participacion, principal=$principal, "
         . "direccion=$direccion,ciudad=$ciudad, estrato=$estrato,barrio=$barrio, "
         . "estado=$estado, ruta=$ruta, tipo_predio=$tipoP, predioaso=$predio WHERE id_unico = $id";
