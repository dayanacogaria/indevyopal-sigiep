...
//obtiene los datos que se van a modificar
      ...
      $tipo_dato  = '"'.$mysqli->real_escape_string(''.$_POST['tipo_dato'].'').'"';
      $id  = '"'.$mysqli->real_escape_string(''.$_POST['id'].'').'"';
   
//modificar ne la base de datos
  $insertSQL = "UPDATE gf_condicion SET Nombre=$nombre,TipoDato=$tipo_dato WHERE Id_Unico = $id";
...
<script type="text/javascript">
  ...
  $("#ver1").click(function(){
    $("#myModal1").modal('hide');
    window.location='../listar_GF_CONDICION.php';
  });
</script>
<?php }else{ ?>
<script type="text/javascript">
