...
require './head.php';
?>
<title>Generar Contabilidad recuados por bloque</title>
...
<div class="container-fluid text-center">
    <div class="row content">
        ...
        <div class="col-sm-10 col-md-10 col-lg-10 text-left">
            <h2 align="center" class="tituloform" style="margin-top: 0;">Generar Contabilidad Recaudo Por Bloque</h2>
            <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">
                <form name="form" id="form" action="access.php?controller=Pago&action=generarContabilidadRecaudosBloque" class="form-horizontal" method="POST"  enctype="multipart/form-data">
