...
$row = $con->Listar("SELECT id_unico, nombre, valor, vigencias_anteriores
      FROM gf_vigencias_interfaz_comercio WHERE parametrizacionanno = $anno"); 
?>
<html>
    <head>
    <title>Vigencias Interfaz Comercio</title>
    </head>
<body>
    <div class="container-fluid text-center">
        <div class="row content">
            ...
            <div class="col-sm-10 text-left">
                <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;margin-top: 0px">Vigencias Interfaz Predial</h2>    
                <div class="table-responsive" style="margin-left: 5px; margin-right: 5px;">
                    <div class="table-responsive" style="margin-left: 5px; margin-right: 5px;">
                        <table id="tabla" class="table table-striped table-condensed" class="display" cellspacing="0" width="100%">
                            ...
                            <?php
                                for ($i = 0; $i < count($row); $i++) {
                                    ...
                                    echo '<a href="GF_VIGENCIAS_COMERCIO.php?id='.md5($row[$i][0]).'"><i title="Modificar" class="glyphicon glyphicon-edit" ></i></a>';
                                    echo '</td>';
                                    echo '<td>'.$row[$i][1].'</td>';
                                    echo '<td>'.$row[$i][2].'</td>';
                                    if($row[$i][3]==1){
                        ...
                        <div align="right"><a href="GF_VIGENCIAS_COMERCIO.php" class="btn btn-primary" style="box-shadow: 0px 2px 5px 1px gray;color: #fff;border-color: #1075C1; margin-top: 20px;margin-bottom: 20px; margin-left:-20px; margin-right:4px">Registrar Nuevo</a> 
                    </div>           
                </div>            
            </div>      
        </div>
