...
#03/03/2017 --- Nestor B --- se modificó el ancho del formulario de listar accidente para que coincida con los margenes de registrar y se insertó la funcion fechaInicial y fechaFinal para que al momento de selecionar una fecha en el calendario de la primera fecha no me deje selecionar una fecha menor  
#06/03/2017 --- Nestor B --- se modificó el menú de información adicional para que muestre el estado y el tipo de incapacidad
#10/03/2017 --- Nestor B --- se modificó la altura y la ruta del botón atrás y la altura del título información adicional
#13/03/2017 --- Nestor B --- se modificó la llamada de la funcion fecha inicial
#16/06/2017 --- Nestor B --- se agregó la validacion cuando el empleado o el concepto estan vacios
        ...
        <div class="container-fluid text-center">
            <div class="row content">
                ...
                <div class="col-sm-8 col-md-8 col-lg-8 text-left" style="margin-top: 0px">
                    <h2 id="forma-titulo3" align="center" style="margin-top:0px; margin-right: 4px; margin-left: -10px;">Registrar Licencia</h2>
                    ...
                    <div class="client-form contenedorForma" style="margin-top: -7px;font-size: 13px;  width: 100%; float: right;">
                        <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="json/registrarLicenciaJson.php">
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group form-inline" style="margin-top:-25px">
                                    ...
                                    <select required="required" name="sltEmpleado" id="sltEmpleado" title="Seleccione Empleado" style="width: 15%;height: 30px" class="form-control col-sm-2 col-md-col-lg-2">
                                    ...
                                    <select name="sltConcepto" id="sltConcepto" title="Seleccione Concepto" style="width: 14%;height: 32px" class="form-control col-sm-1" required="required">
                                ...
                                <div class="form-group form-inline" >
                                    ...
                                    <label for="txtNumeroI" class="col-sm-2 col-md-2 col-lg-2 control-label"><strong class="obligado"></strong>No. Solicitud:</label>
                                    ...
                                    <input  name="txtNumeroA" id="txtNumeroA" title="Ingrese Número Aprobación" type="text" style="width: 14%;height: 30px" class="form-control col-sm-2 col-md-2 col-lg-2" placeholder="Número Aprobación">  
                            
                                    <label for="txtNumeroI" class="col-sm-2 col-md-2 col-lg-2 control-label"><strong class="obligado"></strong>No. Días:</label>
                                    <input  name="txtNumeroD" id="txtNumeroD" title="Ingrese Número Días" type="number" style="width: 14%;height: 32px" class="form-control col-sm-1">  
                                </div>      
                                <!--------------------------------------------------------------------------------------------------- -->                              
                                <div class="form-group form-inline">
                            
                                    <label for="txtDiagnostico" class="col-sm-2 col-md-2 col-lg-2 control-label"><strong class="obligado"></strong>Motivo:</label>
                                    <input  name="txtDiagnostico" id="txtDiagnostico" title="Ingrese Diagnóstico" type="text" style="width: 15%;height: 30px" class="form-control col-sm-2 col-md-2 col-lg-2" onkeypress="return txtValida(event,'car')" placeholder="Número Incapacidad">
                                ...
                                <div class="form-group form-inline" >
                                    <?php
                                       /* $estin = "SELECT id_unico, nombre FROM gn_estado_incapacidad";
                                  ...
                                  <!--  <label for="sltEstado" class="col-sm-2 col-md-2 col-lg-2 control-label"><strong class="obligado"></strong>Estado:</label>
                                    <select name="sltEstado" id="sltEstado" title="Seleccione Estado" style="width: 15%;height: 30px" class="form-control col-sm-2 col-md-2 col-lg-2">
                                    ...
                                    <button type="submit" class="btn btn-primary sombra col-sm-1" style="margin-top:-15px; width:40px; margin-bottom: -10px;margin-left: -45px ;"><li class="glyphicon glyphicon-floppy-disk"></li></button>  
                                </div> 
                            </div>
                        </form>    
                    </div>
                ...
                <div class="col-sm-2 col-md-2 col-lg-2" style="margin-top:-23px">
                    <table class="tablaC table-condensed text-center" align="center">
                        ...
                        <tbody>
                            ...
                            <tr>                                    
                                <td>
                                    <a class="btn btn-primary btnInfo" href="registrar_GN_TIPO_NOVEDAD.php">TIPO</a>
                                </td>
                            </tr>
                        </tbody>       
                    </table>
                                ...
                                <table id="tabla" class="table table-striped table-condensed" class="display" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <td class="cabeza"><strong>No. Solicitud</strong></td>
