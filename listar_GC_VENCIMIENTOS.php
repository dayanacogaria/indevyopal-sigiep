...
#25/5/2017 --- Nestor B --- se agegó la validacion si la fecha viene vacia no genere error
    ...
    $vig = $_SESSION['anno'];
    $sql = "SELECT   v.id_unico, v.anno, m.mes, v.fecha, td.nombre
            FROM gr_vencimiento v
            LEFT JOIN gf_mes m ON v.mes = m.id_unico
            LEFT JOIN gr_tipo_di td ON v.tipo = td.id_unico
            WHERE v.tipo = 5 ";
    $resultado = $mysqli->query($sql);
    
?>
    <title>Listar Interes</title>
    </head>
     <body>
        <div class="container-fluid text-center">
            <div class="row content">
                ...
                <div class="col-sm-10 text-left">
                    <h2 id="forma-titulo3" align="center" style="margin-top: 0px; margin-bottom: 20px; margin-right: 4px; margin-left: 4px;">Vencimientos de Interés</h2>
                            ...
                            <table id="tabla" class="table table-striped table-condensed" class="display" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="campos"><?php echo $mes?></td>                
