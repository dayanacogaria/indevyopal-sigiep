...
<div class="col-sm-7 text-left" style="margin-top:-10px">
                <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;margin-bottom: 10px;">Registrar Ciudad</h2>
     ...
     <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="json/registrar_GF_CiudadJson.php" >
                ...
                <input type="text" name="nombre" id="nombre" class="form-control" maxlength="100" title="Ingrese el Nombre" onkeypress="return txtValida(event, 'car')" placeholder="Nombre" required>
                    ...
                    <div class="form-group">
                       ...
                       <div class="form-group" style="margin-top: -10px;">
                        ...
                        <?php
                        $cuentaI = "SELECT id_unico,nombre from gf_departamento ORDER BY nombre ASC";
