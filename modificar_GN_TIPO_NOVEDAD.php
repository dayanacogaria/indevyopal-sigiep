...
# session_start();
 ...
 $queryCond = "SELECT id_unico, nombre,equivalente_NE FROM gn_tipo_novedad  
        ...
        <div class="container-fluid text-center">
              <div class="row content">
                  ...
                  <div class="col-sm-10 text-left">
                      ...
                      <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;">Modificar  Tipo Novedad</h2>
                      
                      <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">
                          
                          <form name="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="json/modificarTipoNovedadJson.php">
                            ...
                            <div class="form-group" style="margin-top: -10px;">
                                 ...
                                 <input type="text" name="nominaE" value="<?php echo ($row[2]) ?>" id="nominaE" class="form-control" maxlength="100" title="Ingrese el codigo nónima electrónica" onkeypress="return txtValida(event,'car')" placeholder="Codigo Nómina Electrónica">
                            </div>                                       
                            <div class="form-group" style="margin-top: 10px;">
