...
if(empty($_GET['id'])) {
    ...
    $titulo = "Modificar ";
    $id     = $_GET['id'];
    $row    = $con->Listar("SELECT a.id_unico,
													IF(CONCAT_WS(' ',
             t.nombreuno,
             t.nombredos,
             t.apellidouno,
...
<style>
    label #comite-error, #tercero-error {
    display: block;
    color: #bd081c;
    font-weight: bold;
    font-style: italic;
    ...
    <div class="container-fluid text-center">
        <div class="row content">
            ...
            <div class="col-sm-10 text-left">
                <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;"><?php echo $titulo.' Comite'?></h2>
                <a href="listar_GY_COMITE.php" class="glyphicon glyphicon-circle-arrow-left" style="display:inline-block;margin-left:10px; font-size:150%; vertical-align:middle;text-decoration:none" title="Volver"></a>
                ...
                <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">
                    ...
                    <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="javascript:registrar()">
                        ...
                        <div class="form-group" style="margin-top: 0px; ">
                            ...
                            <select required id="tercero" name="tercero"  class="select2_single form-control" style="height: 35px;"  title="Seleccione un tercero">
                        ...
                        <div class="form-group" style="margin-top: 0px; ">
                            <label for="comite" class="col-sm-5 control-label"><strong style="color:#03C1FB;">*</strong>Tipo Comite:</label>
                            <select required id="comite" name="comite" class="select2_single form-control"  style="height: 35px;"  title="Seleccione un Tipo de Comite">
                                <option value="">Tipo Comite</option>
                               <?php
                               $row = $con->Listar("SELECT  id_unico, nombre
                                FROM gy_tipo_comite WHERE compania = '$compania'
                                ORDER BY nombre ASC ");
                               for ($i = 0; $i < count($row); $i++) {
                    ...
                    <script>
                        function registrar(){
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "jsonProyecto/gy_comiteJson.php?action=2",
                                data:formData,
                                contentType: false,
                                processData: false,
                                success: function(response)
                                {
                                    ...
                                    if(response==1){
                                        ...
                                        $("#Aceptar").click(function(){
                                            document.location='listar_GY_COMITE.php';
                                        })
                                    } else {
                    ...
                    <script>
                        function modificar(){
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "jsonProyecto/gy_comiteJson.php?action=3",
                                data:formData,
                                contentType: false,
                                processData: false,
                                success: function(response)
