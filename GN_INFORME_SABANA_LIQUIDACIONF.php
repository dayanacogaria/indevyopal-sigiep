...
?>
    ...
    <title>Sábana de Liquidación Final</title>
    ...
    <div class="container-fluid text-center">
        <div class="row content">
            ...
            <div class="col-sm-8 text-left">
                <h2 id="forma-titulo3" align="center" style="margin-top:0px; margin-right: 4px; margin-left: -10px;">Sábana de Liquidación Final/ Cesantías Retroactivas</h2>
    ...
    <script>
        ...
        $("#enviar").click(function(){
            if($("#optPdf").is(':checked')){
                $("#form").attr("action", "informes_nomina/generar_INF_SABANA_LIQUIDACIONF.php?t=1");
            } else {
                if($("#optExcel").is(":checked")){
                    $("#form").attr("action", "informes_nomina/generar_INF_SABANA_LIQUIDACIONF.php?t=2");
                }
            }
        });
    </script>
