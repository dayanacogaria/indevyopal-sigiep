...
?>
    ...
    <title>Sábana Retroactivo</title>
...
<body>
    <div class="container-fluid text-center">
        <div class="row content">
            ...
            <div class="col-sm-8 text-left">
                <h2 id="forma-titulo3" align="center" style="margin-top:0px; margin-right: 4px; margin-left: -10px;">Sábana Retroactivo</h2>
                ...
                <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">
                    <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="" target="_blank">
                        ...
                        <!--
                       <div class="form-group" style="margin-top: -5px">
							<label for="sltTipoS" class="control-label col-sm-5" style="margin-top: 0px; ">
                                Tipo Sabana:
                            </label>
                            <div class="col-sm-5 col-md-5 col-lg-5">
                                <select  name="sltTipoS" id="sltTipoS" title="Seleccione Tipo de Sabana" style="height: 30px;" class="select2_single form-control" >
                                    <option value="1">Totalizada</option>
                                </select>
                            </div>
                        </div>-->
                        <div class="form-group" style="margin-top: -5px;">
    ...
    <script>
        ...
        $("#sltGrupoG").select2();
        $("#sltUnidadE").select2();
        $("#sltConcepto, #sltTipoA").select2();


        $("#enviar").click(function(){
            if($("#optPdf").is(':checked')){
                $("#form").attr("action", "informes/generar_INF_SABANA_NOMINA_RT.php?t=1");
            } else {
                if($("#optExcel").is(":checked")){
                    $("#form").attr("action", "informes/generar_INF_SABANA_NOMINA_RT.php?t=2");
                }
            }
        });
