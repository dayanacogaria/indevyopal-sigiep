...
#                       MODIFICACIONES 
################################################################################
#05/12/2017 | Erica G. | Funciones Botones Modales 
#31/01/2017 | 12:30 | ERICA GONZALEZ
#10-02-2017 | 09:33 | Jhon Numpaque
#Inclusión de archivo de impresión a formato cheque
################################################################################
?>
<style>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="client-form contenedorForma" style="margin-top:-10px;margin-right:-3px">
                            <form id="form" name="form" action="json/registrarDetalleComprobanteMovimientoJson.php" class="form-horizontal" style="margin-left:25px">
                                ...
                                <div class="form-group form-inline" >                                    
                                    ...
                                    <select required="required" class="col-sm-2 input-sm" name="sltTipoDocumento" id="sltTipoDocumento" class="form-control" style="width:100px;" title="Seleccione tipo documento" required>
                                    ...
                                    <input class="col-sm-2 input-sm" value="<?php echo date('d/m/Y'); ?>" type="text" name="fechaM" id="fechaM" class="form-control" style="width:100px;height:26px" title="Ingrese la fecha" placeholder="Fecha" required>                                                                                                
                                </div>                                  
                                <div class="form-group form-inline" style="margin-top:-15px">
                                    <label class="col-sm-2 control-label">
                                        <strong class="obligado">*</strong>Valor:                                        
                                    </label>
                                    <input class="col-sm-2 input-sm" type="text" name="txtValorMov" id="txtValorMov" class="form-control" onkeypress="return justNumbers(event);" value="<?php echo $valorD; ?>" style="width:100px;height:26px;margin-bottom: -10px;" title="Ingrese valor de documento" placeholder="Valor" required>                                    
                                        <label for="txtlabel" class="col-sm-2 control-label">
                                        <strong class="obligado"></strong>Subir Documento:                                        
                                    </label>
                                        <input type="hidden" required="required" title="Seleccione Documento" id="archivos" name="archivos" >
                                       ...
                                       <script type="text/javascript" >
                                            function abrirDoc(id){                                                                                                   
                                                ...
                                                $.ajax({
                                                    type: 'POST',
                                                    url: "verDetalleDoc.php#mdlDetalleMovimiento1",
                                                    data:form_data,
                                                    success: function (data) { 
                            ...
                            <table id="tabla1" class="table table-striped table-condensed" class="display" cellspacing="0" width="100%" style="">
                                <thead style="position: relative;overflow: auto;width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <th class="cabeza" width="3%">Impresión cheque</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php                                                                           
                                        ...
                                        LEFT JOIN   gf_detalle_comprobante dtc  ON dtc.id_unico = dtm.comprobantecnt
                                        LEFT JOIN   gf_cuenta_bancaria ctab     ON dtc.cuenta = ctab.cuenta
                                         WHERE dtm.comprobantecnt=$idcomprobantedetalle";
                                    ...
                                    <script> 
                                        ...
                                        <td class="campos text-center">
                                            ...
                                            switch ($esC[0]) {
                                                case 1:
                                                    echo "<a  onclick=\"esCheque(".$row11[8].")\" style=\"cursor:pointer\" class=\"glyphicon glyphicon-print\"></a>";
                                                    break;
                                            ...
                                            <script type="text/javascript">
                                                function esCheque(tipo){
                                                    window.open('formatoCheque.php?idDP=<?php echo md5($idcomprobantedetalle)?>&cuenta='+tipo);
                                                }
                                            </script>
                                        </td>
                                    </tr>
...
<div class="modal fade" id="mdlPEliminiado" role="dialog" align="center" >
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" style="margin-top: 8px">
                <p>¿Desea eliminar el registro seleccionado de Comprobante detalle movimiento?</p>
            </div>
            <div id="forma-modal" class="modal-footer">
                <button type="button" id="btnEliminar" class="btn" style="color: #000; margin-top: 2px" data-dismiss="modal" >Aceptar</button>
...
<script type="text/javascript" >
    function guardarDetalleMovimiento(){
        ...
        if(doc=='' || doc.length<0 ) { 
            ...
            $.ajax({
                type: 'POST',
                url: "json/registrarDetalleComprobanteMovimientoJson.php",
                data:form_data,
                contentType: false,
                 processData: false,
                success: function (data) {
...
<?php require_once './verDetalleDoc.php'; ?> 