...
<script src="js/jquery-ui.js"></script>
<title>Actualización Plan Inventario</title>
</head>
...
<div class="container-fluid text-center">
  <div class="row content">
    ...
    <!--Titulo del formulario-->
      <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;">Actualización Plan Inventario</h2>
 ...
 <div class="modal fade" id="modalListo" role="dialog" align="center" >
  ...
  function mantenimiento(){
        jsShowWindowLoad('Actualizando Plan Inventario. <br>Espere por favor');
        var form_data = {                     
                        id:1
                    };
        $.ajax({
            type:"POST",
            url:"consultasBasicas/mantenimiento_planI.php",
            data:form_data,
