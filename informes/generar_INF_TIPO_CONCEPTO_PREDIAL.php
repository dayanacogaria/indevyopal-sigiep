...
{ 
    ...
    $this->SetX(23);
    $this->Cell(190,5,utf8_decode('LISTADO TIPO CONCEPTO PREDIAL'),0,0,'C');
    $this->Ln(10);
...
$resultado=$mysqli->query($sql);
 ...
 while($row=mysqli_fetch_array($resultado)){
            ...
            $pdf->Cell(170,4,utf8_decode($row['nombre']),0,0,'L');
...
//ob_end_clean();
$pdf->Output(0,'Listado Tipo Concepto Predial('.date('d/m/Y').').pdf',0);
