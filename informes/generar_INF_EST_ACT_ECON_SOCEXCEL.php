...
session_start();
header("Content-Disposition: attachment; filename=Informe_Actividad_Economica.xls");
...
<title>INFORME ACTIVIDAD ECONÓMICA, SOCIAL Y FINANCIERA</title>
</head>
<body>
<table width="100%" border="1" cellspacing="0" cellpadding="0">
  ...
  <th colspan="3" align="center"><strong>
            ...
            <br/>&nbsp;
            <br/>INFORME ACTIVIDAD ECONÓMICA, SOCIAL Y FINANCIERA
