...
header("Content-Disposition: attachment; filename=Informe_Auxiliar_Contable_Tercero.xls");
require_once("../Conexion/conexion.php");
ini_set('max_execution_time', 0);
session_start();
#Consulta Secundaria
$paranno=$_SESSION['anno'];
$anno="SELECT anno FROM gf_parametrizacion_anno WHERE id_unico = $paranno";
...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
    <tr>
        <th colspan="9" align="center"><strong>
           ...
           <br/>&nbsp;
            <br/>AUXILIARES CONTABLES TERCERO<br/>Cuentas de <?php echo $cuentaMin.' a '.$cuentaMax?>
            <br/>Comprobantes de <?php echo $compini.' a '.$compfin?><br/>Fecha <?php echo $fechaini.' a '.$fechafin?>
            <br/>Tercero <?php echo $centroIn.' - '.$terceroI.' a '.$centroFi.' - '.$terceroF?><br/>&nbsp;</strong></td>
  </tr>
  <tr>
    ...
    <td><strong>N° DE DOCUMENTO</strong></td>
...
$sql2  = "SELECT DISTINCT
    ...
    ?>    
    <tr>    
        <td colspan="5"><strong><?php echo 'Código cuenta: '.$codicuenta;?></strong></td>
    ...
    <tr>
        ...
        <td><?php echo $fila['NOMBRE'].' - '.$fila['trnum'];?></td>
        <td><?php echo $fila['cndesc'];?></td>
        <td><?php echo $fila['cnnumcont'];?></td>
