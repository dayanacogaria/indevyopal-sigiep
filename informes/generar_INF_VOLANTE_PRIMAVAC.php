...
{ 
   ...
   $this->Ln(5);
    ...
    $this->Ln(5);
    $this->Cell(190,5,utf8_decode('VOLANTE VACACIONES'),0,0,'C');
    // Salto de línea
    $this->Ln(3);
...
echo $consulta3 = "SELECT id_unico, codigointerno, fechainicio, fechafin FROM gn_periodo WHERE (id_unico) = '$periodo'";
...
while($fila1 = mysqli_fetch_row($empl)){
    ...
    $pdf->cellfitscale(130,5,utf8_decode('TOTAL VACACIONES: '),0,0,'R');
...
ob_end_clean();$pdf->Output(0,'Volante_Vacaciones('.date('d/m/Y').').pdf',0);  
?>