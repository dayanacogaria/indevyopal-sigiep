...
header("Content-Disposition: attachment; filename=Informe_Auxiliar_Contable_Centro_Costo.xls");
...
<title>Auxiliares Contables Centro De Costo</title>
</head>
<body>
<table width="100%" border="1" cellspacing="0" cellpadding="0">
    <tr>
        <th colspan="9" align="center"><strong>
           ...
           <br/>&nbsp;
           <br/>AUXILIARES CONTABLES CENTRO DE COSTO
           <br/>Cuentas de <?php echo $cuentaMin.' a '.$cuentaMax?>
            <br/>Comprobantes de <?php echo $compini.' a '.$compfin?>
            <br/>Fecha <?php echo $fechaini.' a '.$fechafin?>
            <br/>Centro de Costo <?php echo $centroIn.' a '.$centroFi?>
            <br/>&nbsp;
            </strong>
        </th>
  </tr>
