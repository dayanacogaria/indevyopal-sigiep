...
<?php
                ...
                // Cabecera de página
                    function Header()
                    {
                        ...
                        $this->SetFont('Arial','',8);
                        $this->SetX(25);
                        $this->Cell(315,5,utf8_decode('INFORME DE CONCEPTO PREDIAL'),0,0,'C');
                        $this->SetFont('Arial','B',8);
                        $this->SetX(25);
                        ...
                        $this->Cell(68,9,utf8_decode('Urbano'),1,0,'C');
                        $this->Cell(68,9,utf8_decode('Rural'),1,0,'C');
                        $this->Cell(68,9,utf8_decode('Tipo'),1,0,'C');


                        $this->SetX(10);
                        $this->Cell(68,9,utf8_decode('Nombre'),0,0,'C');
                        $this->Cell(68,9,utf8_decode('Fórmula'),0,0,'C');
                ...
                $pdf = new PDF('L','mm','Legal');
                    ...
                    //CONSULTA
                    $sql="SELECT cp.nombre AS nombreConceptoPredial,cp.formula,cp.urbano,cp.rural,tcp.nombre AS nombreTipoConceptoPredial
                        FROM `gr_concepto_predial` cp 
                        INNER JOIN gr_tipo_concepto_predial tcp ON tcp.id_unico=cp.tipo";
                    ...
                    while($row=mysqli_fetch_array($resultado)){
                        ...
                        $pdf->SetX(10);
                        $pdf->SetFont('Arial','',8);
                        $pdf->Cell(68,4,utf8_decode( $row['nombreConceptoPredial']),0,0,'C');
                        $pdf->Cell(68,4,utf8_decode( $row['formula']),0,0,'C');
                        ...
                        $pdf->Cell(68,4,utf8_decode($urbano),0,0,'C');
                        ...
                        $pdf->Cell(68,4,utf8_decode($rural),0,0,'C');
                        $pdf->Cell(68,4,utf8_decode(mb_strtolower($row['nombreTipoConceptoPredial'])),0,0,'C');
        ...
        $pdf->Output(0,'Informe_Concepto_Predial('.date('d/m/Y').').pdf',0);
