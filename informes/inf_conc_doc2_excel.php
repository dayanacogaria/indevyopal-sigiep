...
echo '<tr>
        ...
        <td colspan="3" align="left">'.$fechaC.'</td>
    </tr>
    <tr>
        <td colspan="3"><strong>Conciliación del mes de </td>
        <td colspan="3">'.$nomMes.PHP_EOL.'de'.PHP_EOL.$annoMes.'</td>
    </tr>
    <tr>
        <td colspan="3"><strong>CONCILACIÓN BANCARIA CUENTA</strong></td>
        <td colspan="3">'.$banco[1].'</td>
    </tr>';
...
##########################################################################################################################################
echo '<tr>
        <td colspan="3"><strong>Saldo En Contabilidad</strong></td>
...
echo '<tr>
        <td colspan="6"><strong><br/>MAS(+) GIROS SIN COBRAR<br/></strong><br/></td>
     </tr>';
##########################################################################################################################################
...
##########################################################################################################################################
echo '<tr>
        <td colspan="6"><strong><br/>MENOS(-) CONSIGNACIONES EN TRÁNSITO<br/></strong><br/></td>
     </tr>';
##########################################################################################################################################
# Variable de suma
#
...
##########################################################################################################################################
echo '<tr>
        <td colspan="6"><strong><br/>MAS(+) TRANSACCIONES CONCILIADAS Y REGISTRADAS CON FECHA POSTERIOR<br/></strong><br/></td>
     </tr>';
##########################################################################################################################################
# Cabeza de tabla
##########################################################################################################################################
...
##########################################################################################################################################
echo '<tr>
        <td colspan="6"><br/><strong>MAS O MENOS (+/- )PARTIDAS CONCILIATORIAS SALDOS INICIALES<br/></strong><br/></td>
     </tr>';
##########################################################################################################################################
# Variable de movimientos
#
...
##########################################################################################################################################
echo '<tr>
        <td colspan="6"><br/><strong>MAS O MENOS(+/-) PARTIDAS CONCILIATORIAS PERIODOS ANTERIORES</strong><br/><br/></td>
     </tr>';
##########################################################################################################################################
# Variable de movimientos
#
...
##########################################################################################################################################
echo '<tr>
        <td colspan="6"><br/><strong>MAS O MENOS(+/-) PARTIDAS CONCILIATORIAS DEL PERIODO</strong><br/>.</td>
     </tr>';
...
echo '<tr><td colspan="6"><center><strong>SALDO EXTRACTO: </strong>'.number_format($saldoE[0],2,',','.').'</center></td></tr>';
echo '<tr><td colspan="6"><center><strong>SALDO CONCILIADO: </strong>'.number_format($saldoConciliado,2,',','.').'</center></td></tr>';
...
echo '<tr><td colspan="6"><center><strong>'.$rta.'</strong></center></td></tr>';
