...
<?php
                ...
                // Cabecera de página
                    function Header()
                    {
                        ...
                        $this->SetFont('Arial','',8);
                        $this->SetX(25);
                        $this->Cell(315,5,utf8_decode('INFORME DE RESOLUCIÓN'),0,0,'C');
                        $this->SetFont('Arial','B',8);
                        $this->SetX(25);
                        ...
                        $this->Cell(56,9,utf8_decode('Fecha'),1,0,'C');
                        $this->Cell(56,9,utf8_decode('Ruta'),1,0,'C');
                        $this->Cell(56,9,utf8_decode('Observaciones'),1,0,'C');
                        $this->Cell(56,9,utf8_decode('Estado'),1,0,'C');


                        $this->SetX(10);
                        $this->Cell(56,9,utf8_decode('Nombre'),0,0,'C');
                        $this->Cell(56,9,utf8_decode('Número'),0,0,'C');
                ...
                $pdf = new PDF('L','mm','Legal');
                    ...
                    $sql = "SELECT          r.id_unico,
                                            r.nombre AS nombreResolucion,
                                            r.numero,
                                            DATE_FORMAT(r.fecha,'%d-%m-%Y') AS fechaFacConvertida,
                                            r.ruta,
                                            r.observaciones,
                                            r.estado,
                                            e.id_unico,
                    ...
                    while($row=mysqli_fetch_array($resultado)){
                        ...
                        $pdf->SetX(10);
                        $pdf->SetFont('Arial','',8);
                        $pdf->Cell(56,4,utf8_decode($row['nombreResolucion']),0,0,'C');
                        $pdf->Cell(56,4,utf8_decode($row['numero']),0,0,'C');
                        $pdf->Cell(56,4,utf8_decode($row['fechaFacConvertida']),0,0,'C');
                        $pdf->Cell(56,4,utf8_decode($row['ruta']),0,0,'C');
                        

                        //multicelda
                        $y2 = $pdf->GetY();
                        $x2 = $pdf->GetX();
                        $pdf->MultiCell(56,4,utf8_decode(ucwords(mb_strtolower($row['observaciones'] ))),0,'L');
                        $y22 = $pdf->GetY();
                        $h1 = $y22-$y2;
                        $px2 = $x2+56;
                        ...
                        $pdf->Cell(56,4,utf8_decode($row['nombreEstado']),0,0,'C');
        ...
        $pdf->Output(0,'Informe_Resolucion('.date('d/m/Y').').pdf',0);
