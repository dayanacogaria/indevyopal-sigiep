...
<?php
                ...
                // Cabecera de página
                    function Header()
                    {
                        ...
                        $this->SetFont('Arial','',8);
                        $this->SetX(25);
                        $this->Cell(315,5,utf8_decode('INFORME DE ÁREA'),0,0,'C');
                        $this->SetFont('Arial','B',8);
                        $this->SetX(25);
                        ...
                        $this->Cell(56,9,utf8_decode('Tipo Area'),1,0,'C');
                        $this->Cell(56,9,utf8_decode('Unidad Area'),1,0,'C');
                        $this->Cell(56,9,utf8_decode('Motivo Cambio Area'),1,0,'C');
                        $this->Cell(56,9,utf8_decode('Predio'),1,0,'C');
                ...
                $pdf = new PDF('L','mm','Legal');
                    ...
                    $sql="SELECT a.valor,a.anio,ta.nombre AS nombreTipoArea,ua.nombre AS nombreUnidadArea,mca.nombre AS nombreMotivoCArea,p.nombre AS nombrePredio FROM gr_area a
                        INNER JOIN gr_tipo_area ta ON ta.id_unico=a.tipoarea  
                        INNER JOIN gr_unidad_area ua ON ua.id_unico=a.unidadarea
                        INNER JOIN gr_motivo_cambio_area mca ON mca.id_unico=a.motivocambioarea
                    ...
                    while($row=mysqli_fetch_array($resultado)){
                        ...
                        $pdf->Cell(56,4,utf8_decode($row['nombreTipoArea']),0,0,'C');
                        $pdf->Cell(56,4,utf8_decode($row['nombreUnidadArea']),0,0,'C');
                        $pdf->Cell(56,4,utf8_decode($row['nombreMotivoCArea']),0,0,'C');
                        $pdf->Cell(56,4,utf8_decode($row['nombrePredio']),0,0,'C');
