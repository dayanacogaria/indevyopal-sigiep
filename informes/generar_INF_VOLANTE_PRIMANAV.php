<?php
#29/08/2017 --- Nestor B --- se modificó la consulta de los empleados 
...
{ 
   ...
   $this->Ln(5);
    ...
    $this->Ln(5);
    $this->Cell(190,5,utf8_decode('COMPROBANTE DE PAGO DE PRIMA DE NAVIDAD'),0,0,'C');
    // Salto de línea
    $this->Ln(3);
...
while($fila1 = mysqli_fetch_row($empl)){
    ...
    $pdf->SetFont('Arial','B',8);
    $pdf->Cell(27,18,utf8_decode($fila1[5]),0,0,'C');
    $pdf->Ln(4);
    $pdf->SetX(13);
    ...
    $pdf->SetFont('Arial','B',8);
    $pdf->Cell(30,18,utf8_decode($fila1[7]),0,0,'C');
    ...
    $pdf->Ln(15);
        ...
        $pdf->SetFont('Arial','B',8);
            ...
            $pdf->Ln(2);
            $pdf->SetX(0);
            $pdf->cellfitscale(50,5,utf8_decode('ORDENADOR'),0,0,'R');
            $pdf->cellfitscale(30,5,utf8_decode(''),0,0,'R');
            $pdf->cellfitscale(50,5,utf8_decode('SECRETARIA DE HACIENDA'),0,0,'R'); 
