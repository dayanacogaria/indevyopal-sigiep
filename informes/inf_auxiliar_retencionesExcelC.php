...
header("Content-Disposition: attachment; filename=Informe_Auxiliar_Retenciones_Consolidado.xls");
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Relación de Retenciones</title>
    </head>
    <body>
        <table width="100%" border="1" cellspacing="0" cellpadding="0">
            <th colspan="2" align="center"><strong>
                    ...
                    <br/>&nbsp;
                    <br/> RELACIÓN DE RETENCIONES
                    <br/>PERIODO DEL <?php echo $fecha1 . ' AL ' . $fecha2 ?>
                    <br/>&nbsp;</strong>
            </th>
            <tr>
                <td align="center"><strong>Cuenta Retención</strong></td>
                            ...
                            while ($rowr = mysqli_fetch_row($dtR)) {
                                ...
                                if ($dcr > 0) {
                                    ...
                                    <?php echo "Cuenta Retencion: " . $rowr[1] . " - " . $rowr[2]; ?>
                                        ...
                                        <td align="right"><?php echo '$' . number_format($subValor, 2, '.', ',') ?></td>
                                    </tr>
                                    <?php
