...
{ 
    ...
    $this->SetFont('Arial','',8);
    $this->Cell(330,5,utf8_decode('MOVIMIENTO PRESUPUESTAL-INGRESOS'),0,0,'C');
    $this->SetFont('Arial','B',8);
    ...
    $this->Cell(330,5,utf8_decode('CODIGO:  '.utf8_decode (ucwords(mb_strtoupper($codNombre)))),0,0,'C');
...
function Footer()
    ...
    $this->Cell(60);
    $this->Cell(30,10,utf8_decode('Usuario:'.mb_strtoupper($usuario)),0); //.get_current_user()
    $this->Cell(70);
...
######### ESTRUCTURA FIRMAS #########
 ...
 $res = "SELECT rd.tercero, tr.nombre FROM gf_responsable_documento rd 
        ...
        WHERE td.nombre ='PP33' AND td.compania = $compania ";
