...
<!-- Llamado al menu del formulario -->    
  <?php require_once 'menu.php'; ?>
    <div class="col-sm-10 text-left" style="margin-top: -20px"> 
        <h2 align="center" class="tituloform">Estado De Tesorería</h2>
...
function reporteExcel(){
   $('form').attr('action', 'informes/INF_ESTADO_TESORERIA.php?t=2');
}

</script>
<script>
function reportePdf(){
    $('form').attr('action', 'informes/INF_ESTADO_TESORERIA.php?t=1');
}
</script>
</body>
</html>