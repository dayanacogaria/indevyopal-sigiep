                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="Modificar_GF_CHEQUERA.php?id=<?php echo md5($row[0]);?>"><i title="Modificar" class="glyphicon glyphicon-edit" ></i></a>
                                    </td>
                                    <td><?php echo $row[1];?></td>
                                    <td><?php echo $row[2];?></td>
                                    <td><?php echo $row[3];?></td>
                                    <td><?php echo ucwords(strtolower(($row[5])));?></td>
                                    <td><?php echo ucwords(strtolower(($row[7].' - '.$row[8])));?></td>
                                </tr>
                                <?php } ?>
                            </tbody>
                        </table>
                        <div align="right"><a href="Registrar_GF_CHEQUERA.php" class="btn btn-primary" style="box-shadow: 0px 2px 5px 1px gray;color: #fff; border-color: #1075C1; margin-top: 20px; margin-bottom: 20px; margin-left:-20px; margin-right:4px">Registrar Nuevo</a> </div>       
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        function eliminarItem(id)
        {
         ...
         $("#ver").click(function(){
              ...
              $.ajax({
                  type:"GET",
                  url:"json/eliminar_GF_CHEQUERAJson.php?id="+id,
