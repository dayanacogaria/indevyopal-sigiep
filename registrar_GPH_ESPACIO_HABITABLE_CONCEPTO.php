            ...
            for (i2 = 0; i2 < elemtabla2.length; i2++) {
                if (elemtabla2[i2].type == 'checkbox')
                        if (elemtabla2[i2].checked == true) {
                            selected_con += elemtabla2[i2].value+',';
                            
                        }                        
            }
        
        if(selected_con === '' || selected_ap === ''){
             $("#myModalcomp").modal('show');
        }else{
           
            window.location='json/registrarEspacioHabitableConceptoJSON.php?id_ap='+selected_ap+'&id_conc='+selected_con;
...
function estado(value){
   ...
   <title>Registrar Espacio Habitable Concepto</title>
        ...
        <div class="container-fluid text-center">
              <div class="row content">
                  ...
                  <div class="col-sm-8 col-md-8 col-lg-8 text-left" style="margin-top: 0px">
                      <h2 id="forma-titulo3" align="center" style="margin-top:0px; margin-right: 4px; margin-left: -10px;">Registrar Espacio Habitable Concepto</h2>
                    ...
                    <!-- <div class="col-sm-12 text-left" style="display:<?php echo $a?>">-->
                          <strong style=" font-size: 12px; margin-left: 52px; margin-right: 5px;margin-top:10px; margin-bottom: 10px;">ESPACIOS HABITABLES</strong><input style="margin-left: 460px; margin-right: 5px;margin-top:10px; margin-bottom: 10px;" type="checkbox" 
                              ...
                              <script type="text/javascript">
                                ...
                                <strong style=" font-size: 12px; margin-left: 52px; margin-right: 5px;margin-top:10px; margin-bottom: 10px;">CONCEPTOS</strong><input style="margin-left: 470px; margin-right: 5px;margin-top:10px; margin-bottom: 10px;" type="checkbox" 
                                        ...
                                        <table id="tableO2" class="table table-striped table-condensed display" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                <?php 
                                                 ...
                                                 $sql1="SELECT * FROM gp_concepto  order by id_unico asc";
                                                ...
                                                while ($rowC = mysqli_fetch_row($re)) {  
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td class="campos text-center">
                                                        <input name="cod2" id="sel" type="checkbox" value="<?php echo $id_con ?>">
                                                    </td> 
