...
$rowCo = $con->Listar("SELECT id_unico,nombre FROM gf_tarifas_iva");
...
#* DETALLES
$rowd = $con->Listar("SELECT dde.id_unico, dde.descripcion, dde.cantidad, dde.valor_unitario, dde.valor_iva, dde.valor_total, uf.nombre,dde.codigo,
                      ti.nombre,dde.descripcion_concepto
...
<html>
            ...
            <div class="row content">
                ...
                <div class="client-form" style="margin-left:60px;" class="col-sm-12 col-md-12 col-lg-12">
                    <form name="form-detalle" id="form-detalle" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="javaScript:guardarDetalles()"  style="margin-top:-5px;">
                        <input type="hidden" name="id" id="id" value="<?= $id_documento; ?>" />
                        <div class="col-sm-1" style="margin-right:11px; margin-left:-30px;width:140px;">
                            <div class="form-group"  align="left">
                                <label class="control-label"><strong class="obligado">*</strong>Concepto:</label>
                                <input type="text" name="concepto" id="concepto" class="form-control"  title="Ingrese Concepto"  placeholder="Concepto" required style="display: inline; width: 150px" autocomplete="off">
                            </div>
                        </div>
                        <div class="col-sm-1" style="margin-right:11px;">
                            <div class="form-group"  align="left">
                                <label class="control-label"><strong class="obligado">*</strong>Codigo:</label>
                                <input type="text" name="codigo" id="codigo" class="form-control"  title="Ingrese codigo"  placeholder="Codigo" required style="width: 100%;" autocomplete="off" onkeyup="upperCase()">
                            </div>
                        </div>
                        <div class="col-sm-1" style="margin-right:11px;">
                            <div class="form-group" align="left">
                            <label class="control-label"><strong class="obligado">*</strong>Codigo Imp:</label>
                                <select name="sltCodigo" id="sltCodigo" class="select2 form-control" placeholder="Codigo Impuesto" style="width: 100%;" required="required">
                                  
                                    <?php
                                      $html="";
                                        for ($c = 0; $c <   count($rowCo); $c++) {
                                            $html .='<option value="'.$rowCo[$c][0].'">'.ucwords(utf8_encode(strtolower($rowCo[$c][1]))).'</option>';
                                        }
                                        echo $html;
                                     ?>
                                </select>
                        ...
                        <div class="col-sm-2" style="margin-right:11px; ">
                            <div class="form-group" align="left">
                                ...
                                <input type="text" name="txtValorX" id="txtValorX" class="form-control" placeholder="Valor  Unitario" value="" id="txtValorB" maxlength="50" style="padding:2px;width:70%;" required="" onkeypress="return txtValida(event, 'dec','txtValorX','2' )" onkeyup="formatC('txtValorX');" autocomplete="off">
                            </div>
                        </div>
                    
                        <div class="col-sm-1" style="margin-right:11px; width700px;margin-left:-52px; ">
                            <div class="form-group" align="left">
                                <label class="control-label"><strong class="obligado"></strong>Valor Iva Unitario:</label>
                                <input type="text" name="txtIva" class="form-control" placeholder="Iva"  value="" id="txtIva" maxlength="50"  style="width:100%; padding:2px;" onkeypress="return txtValida(event, 'dec','txtIva','2' )" onkeyup="formatC('txtIva');" autocomplete="off"/>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-1" style="margin-right:11px;">
                            <div class="form-group" align="left">
                                ...
                                <input type="text" name="txtValorA" class="form-control" placeholder="Valor Total"  id="txtValorA" maxlength="50" style="padding:2px; width:115%;" required="" onkeypress="return txtValida(event, 'dec','txtValorA','2' )" onkeyup="formatC('txtValorA');" autocomplete="off"/>
                            </div>
                        </div>
                        <div class="col-sm-1" style="margin-right:3px;width: 60px; margin-left:16px;">
                            <div class="form-group" align="left">
                        ...
                        <div class="col-sm-1" align="left" style="margin-top: 20px; width: 60px;">
                    ...
                    <table id="tabla" class="table table-striped table-condensed" class="display" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <td class="cabeza"><strong>Código Impuesto</strong></td>
                            ...
                            <tr>
                                ...
                                <th class="cabeza">Código Impuesto</th>
                        ...
                        <tbody>
                           <?php 
                            ...
                            for ($i = 0; $i < count($rowd); $i++) {
                                ...
                                $htmld  .= '<td class="campos text-left">'.$rowd[$i][7].'</td>';
                                $htmld  .= '<td class="campos text-left">'.$rowd[$i][8].'</td>';
                                ...
                                $htmld  .= '<td class="campos text-left">'.ucwords(utf8_encode(strtolower($rowd[$i][9]))).'</td>';
                                $htmld  .= '</tr>';
    ...
    <script>
          function upperCase() {
             ...
             document.getElementById("codigo").value=x.toUpperCase()
          }
        $(function(){
        ...
        //SELECT2
        $(" #sltTercero,#sltBuscar,#sltTipo,#sltTipoBuscar,#sltMetodo,#sltUnidad,#sltCodigo").select2({placeholder:"Tercero",allowClear: true});
