<?php 
    ...
    if (isset($_GET["id_sistema"])){
        ...
        $querySistema = "SELECT Id_Unico, Nombre FROM gs_sistema  WHERE md5(Id_Unico) ='$id_sistema'";
    }
    /*Variable y proceso en el que se llama de manera embebida con la conexión el cual pérmite realizar el proceso de consulta*/
    $resultado = $mysqli->query($querySistema);
    /*Variable que convertimos en array ya que en esta carga los resultados ordenados*/  
        ...
        <div class="container-fluid text-center">
            <div class="row content">
                ...
                <div class="col-sm-10 text-left">
                    <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;margin-top: 0px">Modificar Sistema</h2>
                    <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;,margin-top: -5px" class="client-form">
                        ...
                        <form name="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="json/modificarSistemaJson.php">
