...
require './head.php';
?>
<title>Registrar Tipo Cambio</title>
    ...
    <div class="container-fluid text-center">
        <div class="row content">
            ...
            <div class="col-sm-10 text-left" style="margin-top:-20px;">
                <h2 id="forma-titulo3" align="center" style="margin-right: 4px; margin-left: 4px;">Registrar Tipo Cambio</h2>
                ...
                <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">
                    <form id="form" name="form" class="form-horizontal" method="POST" enctype="" action="jsonPptal/registrar_GF_Tipo_CambioJson.php">
                        ...
                        <div class="form-group">
                            <label for="txtSigla" class="control-label col-sm-4 col-md-4 col-lg-4"><strong class='obligado'>*</strong>Sigla:</label>
                            <div class="col-sm-5 col-md-5 col-lg-5">
                                <input type="text" name="txtSigla" id="txtSigla" class="form-control" title="Ingrese el nombre"  placeholder="Nombre" required style='width:100%;' autocomplete="off">
                            </div>
                        </div> 
                        <div class="form-group">
                            <label for="txtNombre" class="control-label col-sm-4 col-md-4 col-lg-4"><strong class='obligado'>*</strong>Nombre:</label>
                            <div class="col-sm-5 col-md-5 col-lg-5">
                                <input type="text" name="txtNombre" id="txtNombre" class="form-control" title="Ingrese el nombre"  placeholder="Nombre" required style='width:100%;' autocomplete="off">
                            </div>
                        </div>                                                
                        <br>                        
                        <div class="form-group">
