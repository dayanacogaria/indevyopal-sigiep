...
?>
<title>Estado Tesorería Caja Y Bancos</title>
</head>
<body>
...
<!-- Llamado al menu del formulario -->    
  <?php require_once 'menu.php'; ?>
    <div class="col-sm-10 text-left" style="margin-top: -20px"> 
        <h2 align="center" class="tituloform">Estado Tesorería, Caja y Bancos</h2>
...
<script>    
    $("#sltAnnio").change(function(){
       ...
       var form_data={action: 7, annio :$("#sltAnnio").val()};
       ...
       var form_data={action: 8, annio :$("#sltAnnio").val()};
...
function reporteExcel(){
   $('form').attr('action', 'informes/generar_INF_BALANCE_PRUEBA_TES_EXCEL.php');
}

</script>
<script>
function reportePdf(){
    $('form').attr('action', 'informes/generar_INF_BALANCE_PRUEBA_TES.php');
}
</script>
</body>
</html>