	...
	switch ($archivo) {
		case 1: //archivo .csv			
			...
			for($a = 0;$a < $num_cols;$a++){ 		//Desplegamos el array para obtener el nombre de los campos
				...
				$nom_cols .= $cols_nom[$a]."$separador";		
                                                                ...
                                                                $csv .='S'."$separador";
                                                                $csv .=$codigodane."$separador";
                                                                $csv .=$fechaEncabezado."$separador";
                                                                $csv .=$anno."$separador";
                                                                $csv .=$nI;
                                                                $csv .= "\n";		
		...
		case 2: //archivo .xls			
			...
			/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                /*******Encabezado*********/
                                                                $shtml .= "<th>S</th>";
                                                                $shtml .= "<th>".$codigodane."</th>";
                                                                $shtml .= "<th>".$fechaEncabezado."</th>";
                                                                $shtml .= "<th>".$anno."</th>";
                                                                $shtml .= "<th>".$nI."</th>";
			$shtml .= "</tr>";
			...
			for($c = 0; $c < $num_cols; $c++) {
				$shtml .= "<th>".((utf8_decode($cols_nom[$c])))."</th>";
			}
			$shtml .= "</tr>";	
			$shtml .= "</thead>";
		...
		case 3: //archivo .txt
			...
			/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                /*******Encabezado*********/
                                                                $lineas .='S'."$separador";
                                                                $lineas .=$codigodane."$separador";
                                                                $lineas .=$fechaEncabezado."$separador";
                                                                $lineas .=$anno."$separador";
                                                                $lineas .=$nI;
