...
//Query o sql de consulta     
    $queryTipot = "SELECT Id_Unico, Nombre FROM gf_tipo_tercero  WHERE md5(Id_Unico) ='$id_tipot'";
  }
...
<!-- Inicio del formulario -->
          <form name="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="json/modificarTipoTerceroJson.php">
