...
#                           Modificaciones
#######################################################################################################
#30/09/2017 |Erica G. | ARCHIVO CREADO
#######################################################################################################
...
?>
<title>Libro Inventarios y Balances</title>
</head>
<body> 
    ...
    <style>
        ...
        label#anno-error, #mes-error, #informe-error{
            display: block;
            color: #155180;
            font-weight: normal;
            font-style: italic;
    ...
    <div class="container-fluid text-center">
        <div class="row content">
            ...
            <div class="col-sm-10 text-left">
                <h2 align="center" class="tituloform" style="margin-top:-3px">Libro Inventarios y Balances</h2>
    ...
    <script>
    function reportePdf(){
        $('form').attr('action', 'informes_libros/INF_LIBRO_INVENTARIOS.php');
    }
    </script>
    <script>    
