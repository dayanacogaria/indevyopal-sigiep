...
?>
<title>Modificar Resolución Predio</title>
    </head>
    <body>
        ...
        <div class="container-fluid text-center">
              <div class="row content">
                  ...
                  <div class="col-sm-10 text-left">
                      <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;">Modificar Resolución Predio</h2>
                      <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">
                          <form name="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="json/modificarResolucionPredioPJson.php">
                            ...
                            <div class="form-group" style="margin-top: -10px;">
                                ...
                                <input required="required" style="width:auto" class="col-sm-2 input-sm" type="text" name="sltFecha" id="sltFecha" value="<?php echo $rpfec;?>" title="Ingrese Fecha">
                            </div>
                            <!----------Fin Captura de Fecha Inicio-->                            
                            <!------------------------- Consulta para llenar campo Resolución-->
                            <?php 
                                $rs = "SELECT id_unico, CONCAT(numero,' - ',nombre) FROM gr_resolucion WHERE id_unico != $rpres";
                                $res = $mysqli->query($rs);
                            ?>
                            <div class="form-group" style="margin-top: -5px">
                                ...
                                <option value="<?php echo $rid?>"><?php echo $rnom?></option>                
                                <?php 
