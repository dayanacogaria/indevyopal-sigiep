...
require_once 'head_listar.php';
	...
	$sql = "SELECT Id_Unico, Nombre FROM gf_estado_chequera ORDER BY Nombre ASC";
                					...
                					while($row = mysqli_fetch_row($rs)){?>
               							<tr>
                							...
                							<td>
                								...
                								<a href="EDITAR_GF_ESTADO_CHEQUERA.php?id_estC=<?php echo md5($row[0]);?>">
  ...
  <script type="text/javascript">
        function eliminarEstadoChequera(id)
        {
            ...
            $("#ver").click(function(){
              ...
              $.ajax({
                  type:"GET",
                  url:"json/eliminarEstadoChequeraJson.php?id="+id,
