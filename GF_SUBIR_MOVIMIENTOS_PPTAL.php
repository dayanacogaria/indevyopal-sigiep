...
?>
    ...
    <title>Subir Configuración Pptal</title>
</head>
<body>
    <div class="container-fluid text-center">
        <div class="row content">
            ...
            <div class="col-sm-10 text-left">
                <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;">Subir Configuración Pptal</h2>
                <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">
                    <form name="form" id="form" accept-charset=""class="form-horizontal" method="POST"  enctype="multipart/form-data" action="JavaScript:guardar()">
                        <p align="center" style="margin-bottom: 25px; margin-top: 25px; margin-left: 30px; font-size: 80%">Archivo .xsl - .xlsx <a href="documentos/formatos/Formato_Configuracion_Pptal.xlsx" target="_blank"><i class="fa fa-file-excel-o"></i></a></p>
                    ...
                    if(rta>0){
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                jsRemoveWindowLoad();
                                if(data==2){
                                    $("#mensaje").html('No se Puede Realizar Cargue de Archivo. <br/>Ya Existe Configuración, Apropiación Y Movimientos.');
                                    $("#mdlMensajes").modal("show");
                                    $("#btnAceptar").click(function(){
                                        $("#mdlMensajes").modal("hide");
                                    });
                                    ...
                                    if(data==1){
                                        $("#mensaje").html('Ya existe Configuración. \n\
                                        <br/>Recuerde Que Si Sube de Nuevo La Configuración Se Mantendra La Anterior\n\
                                        <br/><strong>¿Desea Subir de Nuevo La Configuración?</strong>');
                                        $("#mdlMensajes").modal("show");
                                        $("#btnAceptar").click(function(){
                                            subira();
                                        });
                                        ...
                                        if(data==3){
                                            $("#mensaje").html('No se Puede Realizar Cargue de Archivo. <br/>No existe tipo de comprobante presupuestal para realizar saldos iniciales.');
                                            $("#mdlMensajes").modal("show");
                                            $("#btnAceptar").click(function(){
                                                $("#mdlMensajes").modal("hide");
                                            });
        ...
        function subira(){
            ...
            $.ajax({
                ...
                success: function (data) { 
                    ...
                    if(cfg>0 || apg>0){
                        $("#mensaje").html('Información Guardada Correctamente.<br/>'+cfg+ ' datos de configuración guardados.<br/>'+apg+' Apropiaciones Registradas');
                        $("#mdlMensajes").modal("show");
                        $("#btnAceptar").click(function(){
