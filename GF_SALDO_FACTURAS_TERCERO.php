...
<div class="container-fluid text-center">
    <div class="row content">
        ...
        <div class="col-sm-10 text-left" style="margin-left: -16px;margin-top: -20px"> 
            <h2 align="center" class="tituloform">Facturas Con Saldo Por Tercero</h2>
                ...
                <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="" target=”_blank”>  
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group" style="margin-top: -5px;">
                             <label for="fecha" type = "date"  class="col-sm-5 control-label"><strong class="obligado">*</strong>Fecha Corte Factura:</label>
                             <input class="form-control" autocomplete="off" title="Seleccione Fecha de Corte" type="text" name="fecha" id="fecha" placeholder="Fecha Corte Factura" required="required">
                        </div>
                        ...
                        <div class="form-group" style="margin-top: -5px;" id="nf">
    ...
    <script>
        function reporteExcel(){
            if( $('#acumulado').prop('checked') ) {
                $('form').attr('action', 'informes/INF_SALDO_FACTURAS_TERCERO.php?t=2&a=2');
            } else {
                if( $('#acumulado').prop('checked') ) {
                    $('form').attr('action', 'informes/INF_SALDO_FACTURAS_TERCERO.php?t=2&a=1');
                } else {
                    $('form').attr('action', 'informes/INF_SALDO_FACTURAS_TERCERO.php?t=2&a=1');
                }
            }
    ...
    <script>
    function reportePdf(){
        $('form').attr('action', 'informes/INF_SALDO_FACTURAS_TERCERO.php?t=1');
    }
    </script>
</div>
</body>
