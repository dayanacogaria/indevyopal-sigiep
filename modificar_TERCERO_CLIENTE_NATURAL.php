...
if (isset($_GET["id_ter_clie_nat"])){ 
    $id_asoNat = (($_GET["id_ter_clie_nat"]));
        ...
        <div class="row content">
            ...
            <div class="col-sm-7 text-left" style="margin-left: -16px;margin-top:-20px">
                ...
                <div class="client-form contenedorForma" style="margin-top:-5px">
                    <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="json/modificar_TERCERO_CLIENTE_NATURALJson.php">
                        ...
                        <div class="form-group" style="margin-top: -5px;">
                            ...
                            <input type="text" value="<?php echo $row[11]?>" name="nombreC" id="nombreC" class="form-control" onkeyup="javascript:this.value=this.value.toUpperCase();"  maxlength="150" title="Ingrese Nombre Comercial" onkeypress="return txtValida(event,'num_car')" placeholder="Nombre Comercial">
                        </div>
                        <div class="form-group" style="margin-top: -15px;">
                        ...
                        <div class="form-group" style="margin-top: -10px;">
                            ...
                            <?php
                                if(!empty($row[12])){
                                    echo '<option value="'.$row[12].'">'.ucwords(mb_strtolower($row[12])).'</option>';
