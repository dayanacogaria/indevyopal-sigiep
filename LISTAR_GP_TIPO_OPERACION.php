  ...
  <div class="row content">
    ...
    <div class="col-sm-10 text-left">
      ...
      <div class="table-responsive" style="margin-left: 5px; margin-right: 5px;margin-top: -15px">
            ...
            <tbody>
              ...
              <?php
               ...
               <tr>
                ...
                <td class="campos">
                  <a class="campos"  href="#" onclick="javascript:eliminarTipo(<?php echo $row[0];?>);"><i title="Eliminar" class="glyphicon glyphicon-trash"></i></a>
                  <a class="campos" href="Modificar_GP_TIPO_OPERACION.php?id=<?php echo md5($row[0]);?>"><i title="Modificar" class="glyphicon glyphicon-edit" ></i></a>
                </td>
          ...
          <div align="right"><a href="Registrar_GP_TIPO_OPERACION.php" class="btn btn-primary" style="box-shadow: 0px 2px 5px 1px gray;color: #fff; 
...
<script type="text/javascript">
      function eliminarTipo(id)
      {
         ...
         $("#ver").click(function(){
              ...
              $.ajax({
                  type:"GET",
                  url:"json/eliminar_GP_TIPO_OPERACIONJson.php?id="+id,
