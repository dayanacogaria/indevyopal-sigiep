...
<body>
    <div class="container-fluid text-center">
        <div class="row content">  
            ...
            <div class="col-sm-7 text-left" style="margin-top:-20px">
                <h2 id="forma-titulo3" align="center" style="margin-bottom: 5px; margin-right: 4px; margin-left: 4px;">Registrar Asociado Natural</h2>
                ...
                <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">
                    <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="json/registrarAsociadoNaturalJson.php" target="_parent">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="GF_CUENTA_BANCARIA_TERCERO.php" ><button class="btn btn-primary btnInfo" <?php if (!isset($_SESSION['id_tercero'])) {
                                    echo ' disabled title="Debe primero ingresar un  asociado natural."';
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="GF_TELEFONO.php">
                                    <button class="btn btn-primary btnInfo"  <?php if (!isset($_SESSION['id_tercero'])) {
                                        echo ' disabled title="Debe primero ingresar un asociado natural."';
                                    } ?> disabled="true"> 
                                        TELEFONO
                                    </button>
        ...
        function existente(){
            ...
            if(tipoD == null || tipoD == '' || tipoD == "Tipo Identificación" || numI == null || numI == ""){
              $("#myModal2").modal('show');
                ...
                $.ajax({
                data: {"numI": numI,perfil:7, action:2},
                type: "POST",
    ...
    <script type="text/javascript">
        $('#ver1').click(function () {
            ...
            document.location = 'modificar_GF_ASOCIADO_NATURAL.php?id_asoNat=' + id;
        });
    </script>
</body>
