...
?>
<title>Registrar Tipo Documento Adjunto</title>
</head>
<body>
...
<div class="container-fluid text-center">
    <div class="row content">
        ...
        <div class="col-sm-7 text-left" style="margin-top:-10px">
            <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;margin-bottom: 10px;">Registrar Tipo Documento Adjunto</h2>
            ...
            <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">
                <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="jsonComercio/registrarTipoDocumentoAdjuntoJson.php" >    
                    ...
                    <div class="form-group">
                        ...
                        <?php
                            $cuentaI = "SELECT * from gc_clase_documento ORDER BY nombre ASC" ;
                            $rsctai = $mysqli->query($cuentaI);
                        ?>
                            
                        <div class="form-group" >
                            <label for="observaciones" class="col-sm-5 control-label" ><strong style="color:#03C1FB;">*</strong> Descripción:</label>
                            <textarea title="Ingrese Descripción" required name="descripcion" placeholder="Descripción" id="observaciones"  class="form-control col-sm-1" rows="3" style="margin-top: 0px;  height: 50px;"></textarea> 
                        </div>
                        ...
                        <div class="form-group" style="margin-top: -10px">
                            ...
                            <select name="claseDocumento" id="sltctai" required="true" style="height: auto" class="select2_single form-control"  title="Seleccione Clase Documento">
                                <option value="">Clase Documento</option>
                                <?php 
                                    while($row=mysqli_fetch_row($rsctai)){ ?> 
