...
$con        = new ConexionPDO();
 ?>
<title>Auxiliares Almacén Por Proyecto</title>
</head>
<body>
...
<div class="container-fluid text-center">
                    ...
                    <div class="form-group">
                        <div class="form-group" style="margin-top: -5px">
                            ...
                            <select  name="sltTci" id="sltTci" class="select2_single form-control" title= "Seleccione Tipo Movimiento inicial" style="height: 30px" required>
                                ...
                                WHERE t.compania = $compania AND clase IN (2,3) ORDER BY t.id_unico ASC";
                        ...
                        <div class="form-group" style="margin-top: -5px">
                            ...
                            <select name="sltTcf" class="select2_single form-control" id="sltTcf" title="Seleccione Tipo Movimiento final" style="height: 30px"  required >
                                ...
                                FROM gf_movimiento m 
                                LEFT JOIN gf_tipo_movimiento t ON m.tipomovimiento = t.id_unico 
                                WHERE t.compania = $compania AND clase IN (2,3) ORDER BY t.id_unico DESC";
                        ...
                        <div class="form-group" style="margin-top: -15px">
                            <label for="sltctai" class="col-sm-5 control-label"><strong style="color:#03C1FB;">*</strong>Proyecto Inicial:</label>
                            <select name="sltctai" id="sltctai" required style="height: auto" class="select2_single form-control" title="Seleccione Proyecto inicial">
                                <option value="">Proyecto Inicial</option>
                                <?php  $cuentaI = "SELECT DISTINCT p.id_unico, p.nombre 
                                    FROM gf_proyecto p 
                                    WHERE p.compania = $compania ORDER BY p.id_unico ASC";
                        ...
                        <div class="form-group" style="margin-top: 0px">
                            <label for="sltctaf" class="col-sm-5 control-label"><strong style="color:#03C1FB;">*</strong>Proyecto Final:</label>
                            <select name="sltctaf" id="sltctaf" style="height: auto" class=" select2_single form-control" title= "Seleccione Proyecto Final" required>
                               <option value="">Proyecto Final</option>
                           <?php 
                            $cuentaF = "SELECT DISTINCT p.id_unico, p.nombre 
                                    FROM gf_proyecto p 
                                    WHERE p.compania = $compania ORDER BY p.id_unico DESC";
    ...
    function reporteExcel(){
       $('form').attr('action', 'informes_almacen/INF_AUXILIAR_PROYECTO.php');
    }
    </script>
</div>
