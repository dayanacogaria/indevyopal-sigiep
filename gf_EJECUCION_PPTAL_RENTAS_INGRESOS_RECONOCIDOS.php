...
$annio = $_SESSION['anno'];
?>
<title>Ejecución Presupuestal Ingresos Reconocidos</title>
</head>
...
<body>
    ...
    <div class="row content">    
        ...
        <div class="col-sm-10 text-left" style="margin-top: -20px"> 
            <h2 align="center" class="tituloform">Ejecución Presupuestal Ingresos Reconocidos</h2>
...
function reporteExcel(){
   $('form').attr('action', 'informes/INFORMES_PPTAL/generar_INF_EJEC_PPTAL_INGRESOS_RECONOCIDOSEXCEL.php');
}

</script>
<script>
function reportePdf(){
    $('form').attr('action', 'informes/INFORMES_PPTAL/generar_INF_EJEC_PPTAL_INGRESOS_RECONOCIDOS.php');
}
</script>
</body>
</html>
