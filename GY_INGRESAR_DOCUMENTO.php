    ...
    <body >   
        ...
        <div class="container-fluid text-left">
                ...
                <div class="col-sm-10" style="margin-top: 0px">
                    ...
                    <a href="<?php echo 'registrar_GY_SEGUIMIENTO.php?idA='.md5($SE[3]).'&proyec='.$id_pro;?>" class="glyphicon glyphicon-circle-arrow-left" style="display:<?php echo $a?>;margin-top:-13px; margin-left:10px; font-size:150%; vertical-align:middle;text-decoration:none" title="Volver"></a>
                    <h5 id="forma-titulo3a" align="center" style="margin-top:-20px; width:85%; display:<?php echo $a?>; margin-bottom: 10px; margin-right: 10px; margin-left: 6%;  background-color: #0e315a; color: white; border-radius: 5px"><?php echo "Actividad: ".ucwords((mb_strtolower($SE[4])));?></h5> 
                        ...
                        <form name="formD" id="formD" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="javascript:registrar()">
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12">  
                                ...
                                <div class="form-group" style="margin-top: 1%">
                                    <input type="hidden" id="txtSeguimiento" name="txtSeguimiento" value="<?php echo $SE[0] ?>">
                                    <label for="txtActividad" class="col-sm-2 col-md-2 col-lg-2 control-label text-right" style="margin-left: -1%" >Actividad:</label>
                                    <div class="col-sm-2 col-md-2 col-lg-2">
                                        <input name="txtActividad" id="txtActividad" style="width: 150%" type="text"  class="form-control " value="<?php echo $SE[2] ?>" readonly>
                                    </div> 

                                    <label for="txtFecha" class="col-sm-2 col-md-2 col-lg-2 control-label text-right" >Fecha:</label>
                                    <div class="col-sm-2 col-md-2 col-lg-2">
                ...
                <div class="form-group form-inline" style="margin-top:5px;">
                    <?php require_once './menu.php'; 
                        $documento = "SELECT dp.nombre,"
                                ...
                                . " LEFT JOIN gy_seguimiento s ON dp.id_seguimiento = s.id_unico"
                                . " LEFT JOIN gy_actividad_proyecto ap ON s.id_actividad_proyecto = ap.id_unico"
                                . " LEFT JOIN gy_proyecto p ON ap.id_proyecto = p.id_unico"
                                . " WHERE  dp.id_seguimiento = '$SE[0]'";
