...
$con = new ConexionPDO();
$anno = $_SESSION['anno'];?>
<title>Informe Facturación Efecty</title> 
</head>
<body>
...
<style>
    label #periodo-error, #sector1-error, #sector2-error {
    display: block;
    color: #bd081c;
    font-weight: bold;
    font-style: italic;
...
<div class="container-fluid text-center">
    ...
    <?php require_once 'menu.php'; ?>
        <div class="col-sm-10 text-left" style="margin-left: -16px;margin-top: -20px"> 
            <h2 align="center" class="tituloform">Informe Efecty</h2>
            <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">
                <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="informes_servicios/INF_FACTURAS_EFECTY.php" target=”_blank”>  
                    ...
                    <div class="form-group">
                        <div class="form-group" style="margin-top: -5px">
                            <label for="periodo" class="col-sm-5 control-label"><strong style="color:#03C1FB;"></strong><strong class="obligado">*</strong>Periodo:</label>
                        ...
                        <div class="form-group" style="margin-top: -5px">
                            <label for="sector1" class="col-sm-5 control-label"><strong style="color:#03C1FB;"></strong><strong class="obligado">*</strong>Sector Inicial:</label>
                        ...
                        <div class="form-group" style="margin-top: -5px">
                            <label for="sector2" class="col-sm-5 control-label"><strong style="color:#03C1FB;"></strong><strong class="obligado">*</strong>Sector Final:</label>
