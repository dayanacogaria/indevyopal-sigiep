   ...
   <title>Generación Volante de Pago</title>
    ...
    <body>
        ...
        <div class="col-sm-8 text-left">
                <h2 id="forma-titulo3" align="center" style="margin-top:0px; margin-right: 4px; margin-left: -10px;">Resumen por Concepto</h2>
                ...
                <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">        
                    <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="informes/generar_INF_RESUMEN_CONCEPTO.php" target="_blank">
...
<!--------------------------------------------------------------------------------------------------------------------- -->
                          ...
                          <!--------------------------------------------------------------------- -->
                                <?php
                                    $clase = "SELECT  id_unico, nombre FROM gn_clase_concepto ";
                                    $claseC = $mysqli->query($clase);
                                ?>
                                <div class="form-group" style="margin-top: -5px">
                                    <div class="classCon" style="margin-top: -5px">   
                                        <label for="sltClase" class="control-label col-sm-5" style="margin-top: 0px; ">
                                            Clase Concepto:
                                        </label>
                                        <select  name="sltClase" id="sltClase" title="Seleccione Clase de Concepto" style="height: 30px;" class="select2_single form-control" >
                                            <option value="">Clase Concepto</option>
                                                <script type="text/javascript">
                                                    $(document).ready(function(){
                                                        $.ajax({
                                                            type: "POST",
                                                            url: "Clase_Con_Nom.php",
                                                            success: function(response){
                                                                $('.classCon select').html(response).fadeIn();
                                ...
                                <?php
                                    $concepto = "SELECT id_unico, CONCAT(codigo,' - ',descripcion) FROM gn_concepto WHERE unidadmedida = 1";
                                    ...
                                    <div class="Con" style="margin-top: 5px">
                                        ...
                                        <script type="text/javascript">
                                                ...
                                                $("#sltClase").change(function(){
                                                    console.log("hola");
                                                    var opcion = '<option value="" >Concepto</option>';
                                                    console.log(opcion);
                                                    var form_data = {
                                                        is_ajax: 1,
                                ...
                                <?php
                                    $per = "SELECT  p.id_unico, CONCAT(p.codigointerno,' - ',tp.nombre) FROM gn_periodo p
                                    LEFT JOIN gn_tipo_proceso_nomina tp ON p.tipoprocesonomina = tp.id_unico WHERE p.id_unico !=1  AND p.parametrizacionanno = '$vig'";
