...
if(empty($_GET['id'])) {
    ...
    $titulo = "Modificar ";
    $id     = $_GET['id'];
    $row    = $con->Listar("SELECT * FROM gpqr_afavor
    ...
    <div class="container-fluid text-center">
        <div class="row content">
            ...
            <div class="col-sm-10 text-left">
                <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;"><?php echo $titulo.' A Favor'?></h2>
                <a href="listar_GPQR_AFAVOR.php" class="glyphicon glyphicon-circle-arrow-left" style="display:inline-block;margin-left:10px; font-size:150%; vertical-align:middle;text-decoration:none" title="Volver"></a>
                ...
                <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">
                    ...
                    <script>
                        function registrar(){
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "jsonPQR/gpqr_afavorJson.php?action=2",
                                data:formData,
                                contentType: false,
                                processData: false,
                                    ...
                                    if(response==1){
                                        ...
                                        $("#Aceptar").click(function(){
                                            if(PQR == 1){
                                                ...
                                                document.location='listar_GPQR_AFAVOR.php';
                                            }
                                        })
                                    } else {
                    ...
                    <script>
                        function modificar(){
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "jsonPQR/gpqr_afavorJson.php?action=3",
                                data:formData,
                                contentType: false,
                                processData: false,
                                success: function(response)
