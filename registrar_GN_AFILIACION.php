...
#15/09/2017 --- Nestor B --- se agregó la validación dle tipo de afiliación, la entidad y la fecha de afiliación
#04/10/2017 --- Nestor B --- se modificó la información adicional 
...
<style >
   ...
   label #sltTipo-error, #sltTercero-error, #sltFechaA-error {
        display: block;
        color: #155180;
        font-weight: normal;
        font-style: italic;
            ...
            <div class="row content">
                ...
                <div class="col-sm-8 col-md-8 col-lg-8 text-left" style="margin-top: 0px">
                        ...
                        <div class="client-form contenedorForma" style="margin-top: -7px;font-size: 13px;  width: 100%; float: right;">
                            <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="json/registrarAfiliacionJson.php">
                                ...
                                <div class="col-sm-12 col-md-12 col-lg-12">  
                                    <div class="form-group form-inline" style="margin-top:-25px;">
                                        ...
                                        <label for="sltTipo" class="col-sm-2 col-md-2 col-lg-2 control-label"><strong class="obligado">*</strong>Tipo:</label>
                                            ...
                                            ?>
                                        <select name="sltTipo" id="sltTipo" title="Seleccione Tipo" style="width: 13%;height: 30px" class=" form-control col-sm-2 col-md-2 col-lg-2" required>
                                        ...
                                        <select name="sltTercero" id="sltTercero" title="Seleccione Entidad" style="width: 13%;height: 30px" class=" form-control col-sm-2 col-md-2 col-lg-2" required >
                            	           <?php                             	
                                                $ter = "SELECT          
                                                                t.id_unico,
                                                                t.razonsocial
                                    ...
                                    <div class="form-group form-inline">
                                        ...
                                        <input style="width:13%;" class="col-sm-2 col-md-2 col-lg-2 input-sm" type="text" name="sltFechaA" id="sltFechaA" onchange="javascript:fechaInicial();" placeholder="Ingrese la fecha" title="Ingrese la fecha de afiliación" required>                            
