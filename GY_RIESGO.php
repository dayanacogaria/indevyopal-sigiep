...
<style>
    label  #nombre-error, #tipo_riesgo-error {
    display: block;
    color: #bd081c;
    font-weight: bold;
    font-style: italic;
    ...
    <div class="container-fluid text-center">
        <div class="row content">
            ...
            <div class="col-sm-10 text-left">
                <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;"><?php echo $titulo.' Riesgo'?></h2>
                <a href="listar_GY_RIESGO.php" class="glyphicon glyphicon-circle-arrow-left" style="display:inline-block;margin-left:10px; font-size:150%; vertical-align:middle;text-decoration:none" title="Volver"></a>
                ...
                <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">
                    ...
                    <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="javascript:registrar()">
                        ...
                        <div class="form-group" style="margin-top: 0px; ">
                            <label for="tipo_riesgo" class="col-sm-5 control-label"><strong style="color:#03C1FB;">*</strong>Tipo de Riesgo:</label>
                            <select required id="tipo_riesgo" name="tipo_riesgo" class="select2_single form-control"  style="height: 35px;"  title="Seleccione un tipo de Riesgo">
                    ...
                    <script>
                        function registrar(){
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "jsonProyecto/gy_riesgoJson.php?action=2",
                                data:formData,
                                contentType: false,
                                processData: false,
                                    ...
                                    if(response==1){
                                        ...
                                        $("#Aceptar").click(function(){
                                            if(MR == 1){
                                                ...
                                                document.location='listar_GY_RIESGO.php';
                                            }
                                        })
                                    } else {
                    ...
                    <script>
                        function modificar(){
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "jsonProyecto/gy_riesgoJson.php?action=3",
                                data:formData,
                                contentType: false,
                                processData: false,
                                success: function(response)
