...
<html>
    ...
    <body> 
        <div class="container-fluid text-center">
            <div class="row content">
                ...
                <div class="col-sm-10 text-left">
                    <h2 align="center" class="tituloform" style="margin-top:-3px">Cierre de Periodo</h2>
        ...
        <script>
            function guardar(){
                jsShowWindowLoad('Guardado Cierre');
                var formData = new FormData($("#form")[0]);
                $.ajax({
                    type: 'POST',
                    url: "jsonSistema/gs_cierre_periodoJson.php?action=20",
                    data:formData,
                    contentType: false,
                    processData: false,
