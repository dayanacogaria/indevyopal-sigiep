    ...
    <div class="container-fluid text-center">
        <div class="row content">
            ...
            <div class="col-sm-8 text-left">
                <h2 id="forma-titulo3" align="center" style="margin-top:0px; margin-right: 4px; margin-left: -10px;">Sábana de Nómina Total</h2>
                <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">
                    <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="" target="_blank">
                       ...
                       <div class="form-group" style="margin-top: -5px;display: none;"  id="acumuladogg">
                            <label for="chkGG" class="control-label col-sm-5 col-md-5 col-lg-5">Acumulado Por Grupo de Gestión:</label>
                            <div class="col-sm-5 col-md-5 col-lg-5">
                                <label for="" class="label-inradio"><input name="chkGG" type="radio" id="chkGG" value="1">Si</label>
                                <label for="" class="label-inradio"><input name="chkGG" type="radio" id="chkGG" checked="checked" value="2">No</label>
                            </div>
                        </div>
                        <div class="form-group" style="margin-top: -5px;">
    ...
    <script>
        ...
        $("#enviar").click(function(){
            if($("#optPdf").is(':checked')){
                $("#form").attr("action", "informes_nomina/generar_INF_SABANA_NOMINAT.php?t=1");
            } else {
                if($("#optExcel").is(":checked")){
                    $("#form").attr("action", "informes_nomina/generar_INF_SABANA_NOMINAT.php?t=2");
                }
            }
        });
        $("#sltUnidadE").change(function(){
            if($("#sltUnidadE").val()==''){
                $("#acumuladogg").css("display", "none");
            } else {
                $("#acumuladogg").css("display", "block");
            }
        })
