    ...
    <?php require_once ('menu.php'); ?>
        <div class="col-sm-10 text-left">
            ...
            <div class="table-responsive" style="margin-left: 5px; margin-right: 5px;margin-top: -15px">
                ...
                <table id="tabla" class="table table-striped table-condensed" class="display" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                              <a   class="campos" href="#" onclick="javascript:eliminar(<?php echo $row[0];?>);"><i title="Eliminar" class="glyphicon glyphicon-trash"></i></a>
                              <a  class="campos" href="Modificar_GP_TARIFA.php?id=<?php echo md5($row[0]);?>"><i title="Modificar" class="glyphicon glyphicon-edit" ></i></a>
                            </td>
                            <td class="campos" ><?php echo ucwords(strtolower(($row[2])));?></td>
                            <td class="campos" ><?php if(empty($row[4])) {
                                echo '';
                            } else {
                                echo $row[4].' - '.ucwords(strtolower($row[5])).' - '.date("d/m/Y", strtotime($row[6])).' - '.date("d/m/Y", strtotime($row[7]));
                            } ?></td>
                ...
                <div align="right"><a href="Registrar_GP_TARIFA.php" class="btn btn-primary" style="box-shadow: 0px 2px 5px 1px gray;color: #fff; border-color: #1075C1; margin-top: 20px;margin-bottom: 20px; margin-left:-20px; margin-right:4px">Registrar Nuevo</a> </div>       
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
      function eliminar(id)
      {
         ...
         $("#ver").click(function(){
              ...
              $.ajax({
                  type:"GET",
                  url:"json/eliminar_GP_TARIFAJson.php?id="+id,
