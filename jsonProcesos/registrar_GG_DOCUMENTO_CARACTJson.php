<?php
  ...
  $num=mysqli_num_rows($car);
   ...
   if($num == 0)
  {
    $insertSQL = "INSERT INTO gg_confi_caracteristica (documento,caracteristica) "
            . "VALUES($documento,$caracteristica)";
...
<?php
  ...
  $("#ver1").click(function(){
    $("#myModal1").modal('hide');
   window.location='../GG_DOCUMENTO_CARACTERISTICA.php?id1=<?php echo md5($documento);?>';
  });
</script>
  <?php } else {?>
<script type="text/javascript">
