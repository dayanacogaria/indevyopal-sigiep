...
$id = "SELECT MAX(id_unico) FROM gg_documento_detalle_proceso";
$id = $mysqli->query($id);
...
$queryU="SELECT * FROM gg_documento_detalle_proceso "
          . "WHERE detalle_proceso='$proceso' "
 ...
 $num=mysqli_num_rows($car);
  ...
  if($num == 0)
  {
    $insert = "INSERT INTO gg_documento_detalle_proceso ( id_unico, detalle_proceso, documento, numero_documento, ruta) "
...
<?php if($resultado==true){ ?>
    <script type="text/javascript">
      ...
      $("#ver1").click(function(){
        $("#myModal1").modal('hide');
        window.location='../GG_DOCUMENTO_DETALLE.php?id=<?php echo md5($proceso)?>';
      });
    </script>
<?php }else{ ?>
    <script type="text/javascript">
