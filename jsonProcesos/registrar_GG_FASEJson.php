<?php
  ...
  if($num == 0)
  {
   $insert = "INSERT INTO gg_fase (nombre, observaciones, elemento_flujo) "
          . "VALUES($nombre, $descripcion, $elemento)";
