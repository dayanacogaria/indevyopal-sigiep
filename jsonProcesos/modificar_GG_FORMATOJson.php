<?php
  ...
  $cadena3 = strtolower($descripcion);
  ...
  $queryUA="SELECT nombre, descripcion FROM gg_formato "
          . "WHERE id_unico = '$id'";
  ...
  $queryU="SELECT * FROM gg_formato "
          . "WHERE LOWER(nombre) = '$nombre' "
          . "AND LOWER(descripcion) = '$descripcion'";
 ...
 $desC1= preg_replace($exp_regular, $cadena_nueva, $cadena3);
 $desC2= preg_replace($exp_regular, $cadena_nueva, $cadena4);
  
 //comparación para que guarde
   if($nombreC2==$nombreC1 && $desC1==$desC2){
        
         $update = "UPDATE gg_formato "
                . "SET nombre ='$nombre', "
...
<html>
    ...
    <?php if($resultado =='3') { ?>
        <script type="text/javascript">
          ...
          $("#ver3").click(function(){
            $("#myModal3").modal('hide');
            window.location='../LISTAR_GG_FORMATO.php';
          });
        </script>
    <?php } else { ?>
