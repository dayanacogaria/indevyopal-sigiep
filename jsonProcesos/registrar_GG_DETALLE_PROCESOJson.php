<?php
  ...
  $estado= $mysqli->real_escape_string(''.$_POST['estadog'].'');
  ...
  $estadoAnterior= $mysqli->real_escape_string(''.$_POST['estadoAnterior'].'');
 ...
 $queryU="SELECT * FROM gg_detalle_proceso "
  ...
  if($num == 0)
  {
    $esta= "UPDATE gg_proceso SET estado ='$estado' WHERE id_unico ='$proceso'";
    $esta= $mysqli->query($esta);
    $insert = "INSERT INTO gg_detalle_proceso ( proceso, flujo_procesal, fecha_programada, fecha_ejecutada, tercero, forma_notificacion, observaciones, condicion, estadoA) "
          . "VALUES('$proceso', '$flujop', '$fechaP', '$fechaE', '$tercero', '$formaN', '$observaciones', '$condicion', '$estadoAnterior')";
