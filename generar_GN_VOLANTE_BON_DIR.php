...
#12/07/2017 |Nestor B| se modifico para que solo llene el combo con los empleados a los que se les ha liquidado esta bonificacion
####################################################################################################
    ...
    <div class="container-fluid text-center">
        <div class="row content">
            ...
            <div class="col-sm-8 text-left">
                <h2 id="forma-titulo3" align="center" style="margin-top:0px; margin-right: 4px; margin-left: -10px;">Generación de Volante de Bonificación de Dirección</h2>
                ...
                <div class="client-form contenedorForma" style="margin-top: -7px;font-size: 13px">        
                    <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="informes/generar_INF_VOLANTE_BON_DIR.php" target="_blank">
                        ...
                        <div class="form-group form-inline" style="margin-left: 40px">
                            <div class="form-group form-inline " style="margin-top: -25px;"> 
                                ...
                                <!--------------------------------------------------------------------- -->
                                <?php
                                    $per = "SELECT  id_unico, codigointerno FROM gn_periodo WHERE tipoprocesonomina = 6 AND parametrizacionanno = '$vig'";
...
<script>
function reportePdf(){
    $('form').attr('action', 'informes/generar_INF_VOLANTE_BON_DIR.php');
}
</script>
