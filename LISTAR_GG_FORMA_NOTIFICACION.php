...
//Consulta Listar
$query = "SELECT id_unico, nombre FROM gg_forma_notificacion"; 
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="Modificar_GG_FORMA_NOTIFICACION.php?id=<?php echo md5($row[0]);?>"><i title="Modificar" class="glyphicon glyphicon-edit" ></i></a>
                                    </td>
