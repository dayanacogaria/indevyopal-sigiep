...
#                                                                                                                           Modificaciones
##################################################################################################################################################################
#24/08/2017 |Erica G. | Niveles, modificaciones meses por año y cuentas por compañia
...
<!-- Llamado al menu del formulario -->    
  <?php require_once 'menu.php'; ?>
    <div class="col-sm-10 text-left" style="margin-top: -20px"> 
            <h2 align="center" class="tituloform">Balance General</h2>
    <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">
<!-- inicio del formulario --> 
<form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="informes/generar_INF_BALANCE_GENERAL.php"  target=”_blank”>  
                 ...
                 <option value="">Código Final</option>                            
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group" id="digitos" style="display:none" >
                            <label for="ndigitos" class="control-label col-sm-5"><strong class="obligado">*</strong>Nivel:</label>
                            <input type="text" name="ndigitos" id="ndigitos" class="form-control" title="Ingrese el nivel" onkeypress="return txtValida(event,'num');">
                        </div>
...
<script>
  ...
  var opcion = parseInt($("#sltInforme").val());
    ...
    if(opcion ==3){  
        ...
        $("#ndigitos").attr('required', true);
    } else{
        $("#btnTxt").attr('disabled',true);
        $("#digitos").css('display','none');
        $("#ndigitos").attr('required', false);
    }
});
</script>
</div>
...
function reporteExcel(){
  ...
  switch(opcion){
    case('0'):
      $('form').attr('action', 'informes/generar_INF_BALANCE_GENERALEXCEL.php');
    break;
    case('3'):
      var dig = $("#ndigitos").val();  
      $('form').attr('action', 'informes/generar_INF_BALANCE_GENERALEXCEL.php?digitos='+dig);
    break;
  }   
...
function reportePdf(){
  ...
  switch(opcion){
    case('0'):
      $('form').attr('action', 'informes/generar_INF_BALANCE_GENERAL.php');
    break;
    case('3'):
      var dig = $("#ndigitos").val();  
      $('form').attr('action', 'informes/generar_INF_BALANCE_GENERAL.php?digitos='+dig);
    break;
  }  
