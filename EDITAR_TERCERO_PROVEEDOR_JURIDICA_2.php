...
if (isset($_GET["id"])){ 
    ...
    $queryTerceroComp = "SELECT t.Id_Unico, t.RazonSocial, t.NumeroIdentificacion, 
        ...
        DP.Id_Unico,DP.Nombre , t.email,t.procedencia,md5(t.id_unico)
      FROM gf_tercero t  
        ...
        <div class="row content">
            ...
            <div class="col-sm-7 text-left" style="margin-left: -16px;margin-top: -20px; margin-bottom: -15px">
                ...
                <div  class="client-form contenedorForma">
                    <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="json/modificarTerceroProveedorJuridica2Json.php">
                ...
                <table class="tablaC table-condensed" style="margin-left: -10px">
					...
					RETENCIONES EFECTUADAS
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <a href="GF_RESPONSABILIDAD_TERCERO.php?id=<?php echo $row[25];?>"><button style="margin-top:15px" class="btn btnInfo btn-primary">RESPONSABILIDADES</button></a><br/>
                            </td>
                        </tr>
                        <tr>
                            <td></td>
