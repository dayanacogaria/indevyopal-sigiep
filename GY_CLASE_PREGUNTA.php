...
if(empty($_GET['id'])) {
    ...
    $titulo = "Modificar ";
    $id     = $_GET['id'];
    $row    = $con->Listar("SELECT * FROM gy_clase_pregunta
            WHERE md5(id_unico)='$id'");
    $titulo2= $row[0][1];
}
?>
<title>Clase Pregunta</title>
    ...
    <div class="container-fluid text-center">
        <div class="row content">
            ...
            <div class="col-sm-10 text-left">
                <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;"><?php echo $titulo.' Clase Pregunta'?></h2>
                <a href="listar_GY_CLASE_PREGUNTA.php" class="glyphicon glyphicon-circle-arrow-left" style="display:inline-block;margin-left:10px; font-size:150%; vertical-align:middle;text-decoration:none" title="Volver"></a>
                ...
                <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">
                    ...
                    <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="javascript:registrar()">
                        ...
                        <input type="hidden" name="txtse" id="txtse" value="<?php echo $segui; ?>" >
                    </form>
                    <script>
                        function registrar(){
                            var SA = $("#txtse").val();
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "jsonProyecto/gy_clase_preguntaJson.php?action=2",
                                data:formData,
                                contentType: false,
                                processData: false,
                                    ...
                                    if(response==1){
                                        ...
                                        $("#Aceptar").click(function(){
                                            if(SA == 1){
                                                ...
                                                document.location='listar_GY_CLASE_PREGUNTA.php';
                                            }    
                                        })
                                    } else {
                    ...
                    <script>
                        function modificar(){
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "jsonProyecto/gy_clase_preguntaJson.php?action=3",
                                data:formData,
                                contentType: false,
                                processData: false,
                                success: function(response)
    ...
    <div class="modal fade" id="modalEliminar" role="dialog" align="center" >
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body" style="margin-top: 8px">
                    <p>¿Desea Eliminar El Registro Seleccionado de Estado?</p>
                </div>
                <div id="forma-modal" class="modal-footer">
