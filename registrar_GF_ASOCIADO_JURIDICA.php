...
<script type="text/javascript">
    ...
    <title>Registrar Asociado Jurídica</title>
...
<body>
        ...
        <div class="content row">
            ...
            <div class="col-sm-7 text-left" style="margin-left: -16px;margin-top: -20px"> 
                ...
                <div class="client-form contenedorForma">
                    <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="json/registrarAsociadoJurJson.php">
                        ...
                        <div class="form-group" style="margin-top: -15px; ">
                            ...
                            <select name="contacto" id="contacto" class="select2_single form-control" title="Ingrese el contacto">
                                ...
                                <option value="<?php echo $rowCon[0] ?>"><?php echo ucwords((mb_strtolower($rowCon[1] . " " . $rowCon[2] . " " . $rowCon[3] . " " . $rowCon[4] . " (" . $rowCon[6] . ", " . $rowCon[5] . ")"))); ?></option>
                                <?php } ?>
                            </select> 
                        </div>
                        <div class="form-group" style="margin-top: -10px; ">
            ...
            <div class="col-sm-7 col-sm-3">
                <table class="tablaC table-condensed" style="margin-left: -30px;margin-top:-22px">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <div class="btnConsultas" style="margin-top:-5px">
                                    <a href="#">
                                        MOVIMIENTO CONTABLE
                                    </a>
                                </div>
                            ...
                            <td>
                                <button class="btn btn-primary btnInfo" disabled="true" style="margin-top:-5px">DIRECCIÓN</button>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <a href="GF_CUENTA_BANCARIA_TERCERO.php" ><button class="btn btn-primary btnInfo" <?php if (!isset($_SESSION['id_tercero'])) {
                                echo ' disabled title="Debe primero ingresar un  asociado jurídica."';
                              } ?> disabled="true" >CUENTA BANCARIA</button></a><br/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                               <a href="GF_TIPO_ACTIVIDAD_TERCERO.php" ><button class="btn btn-primary btnInfo" <?php if (!isset($_SESSION['id_tercero'])) {
                                    echo ' disabled title="Debe primero ingresar un  asociado jurídica."';
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="GF_TELEFONO.php" ><button class="btn btn-primary btnInfo" <?php if (!isset($_SESSION['id_tercero'])) {
                                    echo ' disabled title="Debe primero ingresar un  asociado jurídica."';
                                } ?> disabled="true" >TELEFONO</button></a><br/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <a href="GF_CONDICION_TERCERO.php" ><button class="btn btn-primary btnInfo" <?php if (!isset($_SESSION['id_tercero'])) {
                                    echo ' disabled title="Debe primero ingresar un  asociado jurídica."';
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                } ?> disabled="true" class="btn btnInfo btn-primary">CONTACTO</a>
                            </td>
                        </tr>
                        <tr>
                            <td></td>
    ...
    <script type="text/javascript">
      $('#ver1').click(function () {
          ...
          document.location = 'modificar_GF_ASOCIADO_JURIDICA.php?id_asociadoJur=' + id;
      });
