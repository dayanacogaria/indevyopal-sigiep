...
<script type="text/javascript">
    $(document).ready(function ()
    {
        ...
        $("#numero").datepicker({changeMonth: true}).val();
    });
</script>
<body>
    <div class="container-fluid text-center">
        <div class="row content">    
            ...
            <div class="col-sm-10 text-left" style="margin-top:-20px">
                <h2 id="forma-titulo3" align="center" style=" margin-right: 4px; margin-left: 4px;"><?php echo $titulo.' CUIPO Fecha Norma'?></h2>
                ...
                <div class="table-responsive" style="margin-left: 5px; margin-right: 5px;">
                    <div class="table-responsive" style="margin-left: 5px; margin-right: 5px;">
                        <table id="tabla" class="table table-striped table-condensed" class="display" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <td width="30px"></td>
                                    <td><strong>Fecha Norma</strong></td>
                                </tr>
                                <tr>
                                ...
                                <?php for ($i = 0; $i < count($row); $i++) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="CUIPO_FECHAS.php?id=2&id_r=<?php echo md5($row[$i][0]); ?>"><i title="Modificar" class="glyphicon glyphicon-edit" ></i></a>
                                        </td>
                        ...
                        <div align="right"><a href="CUIPO_FECHAS.php?id=1" class="btn btn-primary" style="box-shadow: 0px 2px 5px 1px gray;color: #fff; border-color: #1075C1; margin-top: 20px; margin-bottom: 20px; margin-left:-20px; margin-right:4px">Registrar Nuevo</a> </div>       
                    </div>
                </div>
                <?php }  elseif(($_GET['id'])==1){ ?>
                    <a href="CUIPO_FECHAS.php" class="glyphicon glyphicon-circle-arrow-left" style="display:inline-block;margin-left:10px; font-size:150%; vertical-align:middle;text-decoration:none" title="Volver"></a>
                        ...
                        <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="javascript:registrar()">
                            ...
                            <div class="form-group" style="margin-top: 0px;">
                                <div class="form-group form-inline  col-md-5 col-lg-5" text-aling="left" >
                                    <label for="numero" class="col-sm-12 control-label"><strong style="color:#03C1FB;">*</strong>Fecha Norma:</label>
                                </div>
                                <div class="form-group form-inline  col-md-3 col-lg-3" style="margin-left:10px">
                                    <input type="text" name="numero" id="numero" class="form-control " style=" width: 100%" required="required" placeholder="Fecha Norma" title="Ingrese Fecha Norma" autocomplete="off">
                                </div>
                            </div>
                    ...
                    <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">
                        <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="javascript:modificar()">
                            ...
                            <div class="form-group" style="margin-top:0px;">
                                ...
                                <div class="form-group form-inline  col-md-3 col-lg-3" style="margin-left:10px">
                                    <input type="text" name="numero" id="numero" class="form-control " style=" width: 100%" required="required" placeholder="Fecha Norma" title="Ingrese Fecha Norma" value="<?php echo $row[0][0]?>" autocomplete="off">
                                </div>
                            </div>
    ...
    <script>
        function registrar(){
            ...
            $.ajax({
                type: 'POST',
                url: "jsonPptal/cuipo.php?action=4",
                data:formData,
                contentType: false,
                processData: false,
                success: function(response)
                {
                    ...
                    if(response==1){
                        ...
                        $("#Aceptar").click(function(){
                            document.location='CUIPO_FECHAS.php';
                        })
                    } else {
    ...
    <script>
        function modificar(){
            ...
            $.ajax({
                type: 'POST',
                url: "jsonPptal/cuipo.php?action=5",
                data:formData,
                contentType: false,
                processData: false,
                success: function(response)
