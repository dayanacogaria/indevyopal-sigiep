...
<title>Subir Movimientos Cartera </title>
</head>
<body>
...
<div class="container-fluid text-center">
  <div class="row content">
    ...
    <!--Titulo del formulario-->
      <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;">Subir Archivo Cartera</h2>
...
<script>
    function guardar(){
        ...
        $.ajax({
            type: 'POST',
            url: "jsonPptal/gf_subirMovCarteraJson.php?action=1",
            data:formData,
            contentType: false,
            processData: false,
            success: function (data) {  
                ...
                if(rta==0) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "jsonPptal/gf_subirMovCarteraJson.php?action=2",
                        data:formData,
                        contentType: false,
                        processData: false,
                        success: function (data) {
                            ...
                            if(rta==0){
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: "jsonPptal/gf_subirMovCarteraJson.php?action=3",
                                    data:formData,
                                    contentType: false,
                                    processData: false,
                                    success: function (data) {
                                        ...
                                        var txt = resultado["msj"];
                                        var g   = resultado["g"];
                                        $("#mensaje").html(g+' Recaudos Guardados Correctamente');
