...
<script src="js/jquery-ui.js"></script>
   ...
   <title>Sábana de Prima de Navidad</title>
    ...
    <body>
        ...
        <div class="col-sm-8 text-left">
                <h2 id="forma-titulo3" align="center" style="margin-top:0px; margin-right: 4px; margin-left: -10px;">Sábana de Prima de Navidad</h2>
...
<!--------------------------------------------------------------------------------------------------------------------- -->
                          ...
                          <!--------------------------------------------------------------------- -->
                                ...
                                <?php
                                    $per = "SELECT  id_unico, codigointerno FROM gn_periodo WHERE id_unico !=1 AND tipoprocesonomina = 8 AND parametrizacionanno = '$anno'";
                                    $periodo = $mysqli->query($per);
                                ?>

                                <div class="form-group" style="margin-top: -5px">   
                                    <label for="sltPeriodo" class="control-label col-sm-5" style="margin-top: 0px; "><strong class="obligado">*</strong>
                                        Periodo:
                                    </label>
