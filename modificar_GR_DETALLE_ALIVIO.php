...
################ MODIFICACIONES ####################
#05/06/2017  | Anderson Alarcon | modifique querys selects alivio y tipo predio 
############################################
                                ...
                                <thead>
                                    <tr>
                                        <td>
                                            ...
                                            FROM gr_alivio where id_unico !=$row[16] ORDER BY id_unico ASC";
                                            $ali = $mysqli->query($al);
                                        ?>
                                        <!----------Inicio Alivio-->
                                        ...
                                        <td>
                                            <!-- Inicio Todo Capital -->
                                        <label style="margin-top:10px;margin-right:230px" >
                                        ...
                                        {
                                        ?>
                                        <input style="margin-left:-220px" type="radio" name="sltTodcap" id="sltTodcap"  value="1" checked>SI
                                        <input style="margin-left:0px" type="radio" name="sltTodcap" id="sltTodcap" value="2">NO
                                        <?php }
                                        else
                                        {
                                        ?>
                                        <input style="margin-left:-220px" type="radio" name="sltTodcap" id="sltTodcap"  value="1">SI
                                ...
                                <tr>
                                    <td>
                                        <?php 
                                            ...
                                            FROM gp_tipo_predio where id_unico != $row[19] ORDER BY id_unico ASC";
                                            $tip = $mysqli->query($ti);
                                        ?>
                                        <!----------Inicio Tipo Predio-->
                                    ...
                                    <td>
                                        <!----------Inicio Todo Interes-->
                                        <label style="margin-bottom:30px;margin-right:230px">
                                        ...
                                        {
                                        ?>
                                        <input style="margin-left:-220px" type="radio" name="sltTodint" id="sltTodint"  value="1" checked>SI
                                        <input style="margin-left:0px" type="radio" name="sltTodint" id="sltTodint" value="2">NO
                                        <?php }
                                        else
                                        {?>
                                        <input style="margin-left:-220px" type="radio" name="sltTodint" id="sltTodint"  value="1">SI
