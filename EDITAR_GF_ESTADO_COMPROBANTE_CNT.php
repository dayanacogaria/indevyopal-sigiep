...
#05/04/2017 --- Nestor B --- se agrego el atributo mb para que tome las tildes
	...
	if(isset($_GET["id"])){
		...
		$sql = "SELECT Id_Unico, Nombre FROM gf_estado_comprobante_cnt WHERE md5(Id_Unico) = '$id'";
	}
		...
		<div class="row content">
			...
			<div class="col-sm-10 text-left">
				...
				<div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">
					...
					<form name="form" class="form-horizontal" method="POST" enctype="multipart/form-data" action="json/modificarEstadoComprobanteCntJson.php">
