...
$queryDestino = "SELECT Id_Unico, Nombre FROM gf_destino  WHERE md5(Id_Unico) ='$id_destino'";
...
<!-- Inicio del formulario -->
          <form name="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="json/modificarDestinoJson.php">
