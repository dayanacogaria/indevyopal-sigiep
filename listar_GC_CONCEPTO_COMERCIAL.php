...
$sql = "SELECT  cc.id_unico,
        ...
        LEFT JOIN gf_tipo_operacion top ON cc.tipo_ope = top.id_unico
...
?>
        <title>Listar Concepto Comercial</title>
    </head>
    <body>
        <div class="container-fluid text-center">
            <div class="row content">
                ...
                <div class="col-sm-10 text-left">
                    <h2 id="forma-titulo3" align="center" style="margin-top: 0px; margin-bottom: 20px; margin-right: 4px; margin-left: 4px;">Concepto Comercial</h2>
                    <div class="table-responsive" style="margin-left: 5px; margin-right: 5px;margin-top:-10px;">
                        <div class="table-responsive" style="margin-left: 5px; margin-right: 5px;">
                            <table id="tabla" class="table table-striped table-condensed" class="display" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <td class="cabeza"><strong>Tipo Comercio</strong></td>    
                                        <td class="cabeza"><strong>Formula</strong></td>   
                                    ...
                                    <tr>
                                        ...
                                        <th class="cabeza">Tipo Comercio</th>
                                        <th class="cabeza">Formula</th>
                                    ...
                                    ?>
                                     <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="modificar_GC_CONCEPTO_COMERCIAL.php?id=<?php echo md5($row[0]);?>">
                            ...
                            <div align="right">
                                <a href="registrar_GC_CONCEPTO_COMERCIAL.php" class="btn btn-primary " style=" box-shadow: 0px 2px 5px 1px gray;color: #fff; border-color: #1075C1; margin-top: 20px; margin-bottom: 20px; margin-left:-20px; margin-right:4px">Registrar Nuevo</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body" style="margin-top: 8px">
          <p>¿Desea eliminar el registro seleccionado de Concepto Comercial?</p>
        </div>
...
<script type="text/javascript">
      function eliminar(id)
      {
         ...
         $("#ver").click(function(){
              ...
              $.ajax({
                  type:"GET",
                  url:"jsonComercio/eliminarConceptoComercialJson.php?id="+id,
  ...
  <script type="text/javascript">
      ...
      $('#ver1').click(function(){
        document.location = 'listar_GC_CONCEPTO_COMERCIAL.php';
      });
