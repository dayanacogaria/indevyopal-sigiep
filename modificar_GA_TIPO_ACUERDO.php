...
//validacion preguntando si la variable enviada del listar viene vacia  
  if (isset($_GET["id_tipoac"]))
  { 
    $id_tipoac = (($_GET["id_tipoac"]));
//Query o sql de consulta            
    $queryTipoc = "SELECT id_unico, nombre FROM ga_tipo_acuerdo  WHERE md5(id_unico) ='$id_tipoac'";
  }
...
?>
  <title>Modificar Tipo Acuerdo</title>
</head>
...
<!-- Llamado al menú del formulario -->     
    ...
    <div class="col-sm-10 text-left">
      <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;">Modificar Tipo Acuerdo</h2>
      <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">

<!-- Inicio del formulario -->
          <form name="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="json/modificarTipoAcuerdoJSON.php">
