...
?>
<title>Ejecución Presupuestal Regalías - Gastos</title>
...
<div class="container-fluid text-center">
    <div class="row content">
        ...
        <div class="col-sm-10 text-left" style="margin-top: -20px"> 
            <h2 align="center" class="tituloform">Ejecución Presupuestal Regalías - Gastos</h2>
...
<script>
function reportePdf(){
    $('form').attr('action', 'informes/INFORMES_PPTAL/INF_EJECUCION_REGALIAS.php?t=1');    
}    
function reporteExcel(){
    $('form').attr('action', 'informes/INFORMES_PPTAL/INF_EJECUCION_REGALIAS.php?t=2');
}
</script>
</body>
</html>