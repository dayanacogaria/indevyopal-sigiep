...
$query = "SELECT fac.id_unico, fac.numero_factura, 
  IF(CONCAT_WS(' ',
        ...
        SUM(det.valor*det.cantidad), SUM(det.iva*det.cantidad), SUM(det.impoconsumo*det.cantidad), SUM(det.valor_total_ajustado), 
...
WHERE gpt.facturacion_e = 1 AND fac.parametrizacionanno = ".$_SESSION['anno']."  AND fac.cufe IS NULL AND fac.tipo_cambio IS NULL
...
<div class="container-fluid text-center">
    ...
    <?php require_once ('menu.php'); ?>
        <div class="col-sm-10 text-left">
            <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;margin-top: -2px">Facturas</h2>
            <div class="table-responsive" style="margin-left: 5px; margin-right: 5px;margin-top: -15px">
                        ...
                        <?php while($row = mysqli_fetch_row($resultado)):?>
                          <tr>
                              ...
                              <td>
                                ...
                                <a class="campos btn btn-primary sendBill" href="consultasFacturacion/PruebaFactura.php?id=<?=$row[0]?>">
                ...
                <div align="right"><a href="facturasElectronicasEnviadas.php?t=1" class="btn btn-primary" style="box-shadow: 0px 2px 5px 1px gray;color: #fff; border-color: #1075C1; margin-top: 20px;margin-bottom: 20px; margin-left:-20px; margin-right:4px" target="_blank"><i class="glyphicon glyphicon-check"></i> Facturas Enviadas</a> </div>       
                </div>
            </div>
        </div>
    </div>
