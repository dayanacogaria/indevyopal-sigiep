                ...
                <div class="table-responsive contTabla col-sm-12" style="margin-top: 5px;">
                    <div class="table-responsive contTabla" >
                        ...
                        <div class="col-sm-12" align="right" style="margin-top: 10px;">
                            <button type="button" id="btnGenerarCom" class="btn btn-primary sombra" style="background: #00548F; color: #fff; border-color: #1075C1; margin-top: 0px;" title="Guardar Retención" >
                                <li class="glyphicon glyphicon-ok"></li>
                            </button>
                            <button type="button" id="btnNuevo" class="btn btn-primary sombra" style="background: #00548F; color: #fff; border-color: #1075C1; margin-top: 0px;" title="Agregar Retención" >
