...
$query = "SELECT id_unico, nombre, codigo FROM gp_sector"; 
            ...
            <div class="col-sm-10 text-left">
                ...
                <div class="table-responsive" style="margin-left: 5px; margin-right: 5px;">
                    <div class="table-responsive" style="margin-left: 5px; margin-right: 5px;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="Modificar_GP_SECTOR.php?id=<?php echo md5($row[0]);?>"><i title="Modificar" class="glyphicon glyphicon-edit" ></i></a>
                                    </td>
                        ...
                        <div align="right"><a href="Registrar_GP_SECTOR.php" class="btn btn-primary" style="box-shadow: 0px 2px 5px 1px gray;color: #fff; border-color: #1075C1; margin-top: 20px; margin-bottom: 20px; margin-left:-20px; margin-right:4px">Registrar Nuevo</a> </div>       
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        function eliminar(id) {
            ...
            $("#ver").click(function(){
                ...
                $.ajax({
                    type: "POST",
                    url: "jsonServicios/gp_SectorJson.php",
                    data: form_data,
