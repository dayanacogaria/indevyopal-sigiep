    ...
    <body>
        <div class="container-fluid text-center">
            <div class="row content">
                ...
                <div class="col-sm-8 text-left">
                    <h2 id="forma-titulo3" align="center" style="margin-top:0px; margin-right: 4px; margin-left: -10px;">Informe de Recaudo de Reteica</h2>
                    ...
                    <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">        
                        <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" target="_blank">
                            ...
                            <div class="form-group " style="margin-top: -5px">
                                ...
                                <?php
                                    $bancoI = "SELECT cb.id_unico, CONCAT(cb.numerocuenta,' - ',t.razonsocial)
                                                    ...
                                                    WHERE cbt.tercero = 1 ORDER BY cb.id_unico ASC";
                                ...
                                <select  name="sltBancoI" id="sltBancoI" required title="Seleccione Cuenta Inicial" style="height: 30px;" class="select2_single form-control col-sm-4" required="">
                            ...
                            <div class="form-group " style="margin-top: -5px">
                                ...
                                <input  class="col-sm-2 input-sm" type="text" name="sltFechaF" id="sltFechaF" readonly  disabled="true" placeholder="Ingrese la fecha"  style="width: 13%;height: 30px" class="form-control col-sm-2 col-md-2 col-lg-2"> 
                                 <?php
                                    $bancoF = "SELECT cb.id_unico, CONCAT(cb.numerocuenta,' - ',t.razonsocial)
                                                    FROM gf_cuenta_bancaria cb
                                                    lEFT JOIN  gf_cuenta_bancaria_tercero cbt ON cbt.cuentabancaria = cb.id_unico
                                                    lEFT JOIN  gf_tercero t ON cb.banco = t.id_unico
                                                    WHERE cbt.tercero = 1 ORDER BY cb.id_unico DESC";
        ...
        <script>
            function reporteExcel1(){
                $('form').attr('action', 'informesComercio/generar_INF_RESUMEN_RECAUDO_ICA_XLS.php');
            }   

            function reportePdf1(){
                $('form').attr('action', 'informesComercio/generar_INF_RESUMEN_RECAUDO_ICA.php');
            }
        </script>
