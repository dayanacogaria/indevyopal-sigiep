                        ...
                        <div class="client-form contenedorForma" style="margin-top:-10px;margin-right:-3px">
                            <form id="form" name="form" action="json/registrarDetalleComprobanteMovimientoJson.php" class="form-horizontal" style="margin-left:25px">
                                ...
                                <div class="form-group form-inline" style="margin-top:-15px">
                                    ...
                                    <input class="col-sm-2 input-sm" type="text" name="txtValorMov" id="txtValorMov" class="form-control" onkeypress="return justNumbers(event);" style="width:100px;height:26px;margin-bottom: -10px;" value="<?php echo $valorD; ?>" title="Ingrese valor de documento" placeholder="Valor" required>                                    
