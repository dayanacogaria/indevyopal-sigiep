...
<html>
    <head>
        ...
        <title>Subir Archivo Resoluciones </title>
    </head>
    <body>
        <div class="container-fluid text-center">
            <div class="row content">
                ...
                <div class="col-sm-10 text-left">
                    ...
                    <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;">Subir Archivo Resoluciones</h2>
                    <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">
                        <form name="form" id="form" accept-charset=""class="form-horizontal" method="POST"  enctype="multipart/form-data" action="javaScript:guardar()">
                            <p align="center" style="margin-bottom: 25px; margin-top: 25px; margin-left: 30px; font-size: 80%">Archivo .xsl - .xlsx <a href="documentos/formatos/Formato_Resoluciones.xlsx" target="_blank"><i class="fa fa-file-excel-o"></i></a></p>
                            <div class="form-group" style="margin-top: -10px; ">
                                ...
                                <select name="sucursal" id="sucursal" class="select2_single form-control" title="Seleccione Sucursal" style="height: auto " required>
                                    <?php 
                                    #Consulta Sucursal
                                    $row ="SELECT id_unico, LOWER(nombre) FROM gf_sucursal";
                                    $res = $mysqli->query($row);
        ...
        <script>
            function guardar() {
                ...
                $.ajax({
                    type: 'POST',
                    url: "jsonPptal/gu_ResolucionesJson.php?action=1",
                    data: formData,
                    contentType: false,
                    processData: false,
                    success: function (data) {
                        ...
                        var rta = resultado["registro"];
                        var html = resultado["archivo"];
                        
                        if(rta>0){
                                
                                $("#mensaje").html(rta+" Registros Guardados");
                                $("#mensaje1").html(html);
